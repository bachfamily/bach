...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 423.0, 217.0, 54.0 ],
					"presentation_linecount" : 4,
					"text" : "@out m is kept as it is: double-click the bach.reg objects and you'll see the difference."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.0, 434.0, 55.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.0, 310.5, 77.0, 22.0 ],
					"text" : "`2/4 `6/8 `4/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 298.0, 341.0, 111.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80008
					}
,
					"text" : "bach.perm @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 259.0, 101.0, 40.0 ],
					"text" : "Beware of too long lists!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 294.5, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80008
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 238.5, 39.0, 22.0 ],
					"text" : "[ 1 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 449.0, 268.0, 109.0, 22.0 ],
					"text" : "bach.repeat 10923"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.0, 418.0, 201.0, 54.0 ],
					"text" : "Cool: I can see what happens without @out m (also, try to enable debugging)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 434.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"versionnumber" : 80008
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 358.0, 178.0, 49.0 ],
					"text" : "[ `2/4 `6/8 `4/4 ] [ `4/4 `2/4 `6/8 ] [ `4/4 `6/8 `2/4 ] [ `6/8 `2/4 `4/4 ] [ `6/8 `4/4 `2/4 ] [ `2/4 `4/4 `6/8 ]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.5, 298.5, 135.0, 25.0 ],
					"text" : "... and clicking this!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 298.5, 77.0, 22.0 ],
					"text" : "`2/4 `6/8 `4/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 327.0, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80008
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.5, 247.0, 190.0, 25.0 ],
					"text" : "Try switching on the toggle..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 42.0, 546.0, 167.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 247.0, 100.0, 35.0 ],
					"text" : ";\rbach nonative $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: llll+outlet+native, llll+outlet+text, llll+outlet+max",
...
, 			{
				"box" : 				{
					...
					"text" : "Messages to bach: nonative",
					"varname" : "title"
				}
