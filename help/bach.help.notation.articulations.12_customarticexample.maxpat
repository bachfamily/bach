...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -289.0, 272.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 188.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 352.0, 165.0, 23.0 ],
					"style" : "",
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 30.0, 606.0, 123.0 ],
					"text" : "Here's a custom articulation example, where we define an \"irregulartremolo\" articulation, via a \"z\" symbol. This articulation is centered and placed upon the stem. It will be copied while duplicating notes into new chords (but NOT into the same chord), and when the note has to be split (e.g. during quantization: try to press \"quantize\"). The vertical position will adjust depending on the beams.\nWe also define another articulation, named \"respiro\" (breath), via a comma symbol, to be put right before the corresponding chord, outside the staff. This articulation will NOT be copied when split. Since articulation is put above the note, we don't ever use flipped character and we don't need to bother defining its graphical properties.",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "A custom articulation example",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: articulation, define, custom, specification, syntax, spec",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
