...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 398.899993999999992, 271.0, 198.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can input the note lllls in any order, yet bach will always output notes ordered by their pitch (midicents).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.400002000000001, 276.5, 238.0, 54.0 ],
					"text" : "When we dump the content, each chord also has a last numeric element (0), which is its flag"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 294.0, 75.0, 23.0 ],
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.400023999999974, 433.0, 108.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.399993999999992, 385.0, 221.100006000000008, 69.0 ],
					"text" : "We can explicitely as last numeric element a flag, for instance, saying that the chord is locked or muted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.399993999999992, 351.0, 269.0, 38.0 ],
					"text" : "addmeasures [[[[4 4] [60]] [1/2 [6000 100 0] 1] [1/2 [E4 100 0] [G4 100 0] 2]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 250.0, 440.0, 23.0 ],
					"text" : "addmeasures [[[[4 4] [60]] [1/2 [6000 100 0]] [1/2 [E4 100 0] [G4 100 0]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.899993999999992, 53.0, 330.0, 21.0 ],
					"text" : "[<duration> <NOTE1_LLLL> <NOTE2_LLLL>...]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Gathered syntax for chords in bach.score",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 253.399993999999992, 403.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 340.0, 280.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
