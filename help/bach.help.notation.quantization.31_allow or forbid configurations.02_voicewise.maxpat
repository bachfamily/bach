...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.5, 105.0, 119.0, 25.0 ],
					"style" : "",
					"text" : "Quantize to test"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 56.5, 260.0, 40.0 ],
					"style" : "",
					"text" : "Forbid (1/16 1/8 1/16) for first voice and (1/16 3/16) for second voice"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 186.0, 224.0, 83.0 ],
					"style" : "",
					"text" : "allow only (1/16 1/16 1/16 1/16) (1/16 1/16 1/8) (1/8 1/8) (1/4) for first voice, and (1/12 1/12 1/12) (1/6 1/12) (1/12 1/6) (1/4) for second voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 96.5, 43.0, 23.0 ],
					"style" : "",
					"text" : "forbid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 121.0, 185.0, 67.0 ],
					"style" : "",
					"text" : "allow [[1/16 1/16 1/16 1/16] [1/16 1/16 1/8] [1/8 1/8] [1/4]] [[1/12 1/12 1/12] [1/6 1/12] [1/12 1/6] [1/4]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 70.0, 215.0, 23.0 ],
					"style" : "",
					"text" : "forbid [[1/16 1/8 1/16]] [[1/16 3/16]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 203.0, 41.0, 23.0 ],
					"style" : "",
					"text" : "allow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 108.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 304.0, 88.0, 21.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 141.0, 331.0, 467.0, 143.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 273.333313, 65.0, 23.0 ],
					"style" : "",
					"text" : "[2 4] [40]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 141.0, 304.0, 239.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 632.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "If the allow/forbid information has one more level of parentheses, it is considered to be a list of allowed/ forbidden configurations for each voice.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 335.0, 23.0 ],
					"style" : "",
					"text" : "Allow or forbid configuration for a voice",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: quantize, quantization, allow, deny, configuration, voice, voicewise, forbid",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
