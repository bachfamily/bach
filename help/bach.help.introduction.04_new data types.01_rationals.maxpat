...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 403.0, 137.0, 25.0 ],
					"presentation_rect" : [ 308.0, 403.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 156.0, 437.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 341.0, 29.5, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 403.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 156.0, 374.0, 72.0, 23.0 ],
					"presentation_rect" : [ 192.0, 386.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "bach.+ 3/4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 455.0, 107.0, 121.0, 69.0 ],
					"presentation_rect" : [ 412.5, 194.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "All bach modules understand rational numbers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.0, 195.0, 124.0, 23.0 ],
					"style" : "",
					"text" : "[[1/4 1/2 1/4]], bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 310.0, 229.5, 259.0, 123.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.0, 82.0, 29.5, 23.0 ],
					"presentation_rect" : [ 380.0, 192.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "1/7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.5, 107.0, 135.5, 54.0 ],
					"presentation_rect" : [ 351.0, 294.5, 0.0, 0.0 ],
					"style" : "",
					"text" : "All bach modules understand rational numbers"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "n",
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 358.0, 144.0, 54.0, 23.0 ],
					"presentation_rect" : [ 365.0, 221.0, 0.0, 0.0 ],
					"text" : "25/28"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.0, 115.0, 72.0, 23.0 ],
					"style" : "",
					"text" : "bach.+ 3/4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 207.5, 206.0, 113.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 91.0, 32.5, 23.0 ],
					"style" : "",
					"text" : "5/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 91.0, 44.0, 23.0 ],
					"style" : "",
					"text" : "20/10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 91.0, 37.0, 23.0 ],
					"style" : "",
					"text" : "10/3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 148.0, 117.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 91.0, 124.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: introduction, bach, data, type, rational, ratio, arithmetic, unit",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 574.0, 21.0 ],
					"style" : "",
					"text" : "bach also provides Max with rational numbers, and with their arithmetics:",
