...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.5, 304.0, 24.0, 24.0 ]
				}
...
,
					"text" : "bach.eval $l2 ||| $l3 ||| $l4 ||| `nope @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: if+then, if+then+else",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 161.0, 23.0 ],
					"text" : "Conditional booleans",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 589.0, 137.0 ],
					"text" : "The &&& and ||| operators are called conditional booleans, and behave quite differently from their standard counterparts && and ||. \n\n&&& evaluates its first argument; if its value is null, it returns null; if it is non-null, it evaluates the second argument; if its value is null, it returns null, otherwise it returns the value itself. The value of the first argument is lost anyway.\n\n||| evaluates its first argument; if its value is non-null, it returns it; if it is null, it evaluates the second argument; if its value is non-null, it returns it, otherwise it returns null.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
