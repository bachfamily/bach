...
,
					"text" : "bach.eval reduce($l1\\, #/) @out m"
				}
...
,
					"text" : "bach.eval reduce($l1\\, pow) @out m"
				}
...
,
					"text" : "bach.eval reduce($l1\\, ($x\\, $y -> pow($x\\, $y))) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, built, in, function, operator, functional, form, hash",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
