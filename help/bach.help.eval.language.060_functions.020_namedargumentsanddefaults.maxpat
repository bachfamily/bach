...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.5, 347.0, 399.0, 127.0 ],
...
,
					"text" : "bach.eval rot($l1 @maxdepth -1) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 162.0, 315.0, 83.0 ],
...
,
					"text" : "bach.eval rot(@shift 2\\, @llll $l1) @out m"
				}
