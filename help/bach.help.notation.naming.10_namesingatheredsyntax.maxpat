...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 229.0, 349.0, 25.0 ],
					"text" : "...or dump the entire content of the bach.roll (+ markers)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 230.0, 125.0, 19.0 ],
					"text" : "dump body markers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 391.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.5, 415.0, 399.0, 40.0 ],
					"text" : "From the gathered syntax body dump, we can retrieve both names."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.5, 203.0, 370.0, 25.0 ],
					"text" : "Now we can select our chord and dump it (play it \"offline\")..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.571442, 374.0, 323.0, 54.0 ],
					"text" : "Since our playmode is Notewise, when we dump the chord we have introduced, we can retrieve the \"Paul\" note name (but NOT the John chord name)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.571442, 383.0, 115.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 206.0, 151.0, 19.0 ],
					"text" : "sel John, dumpselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.5, 51.0, 198.0, 40.0 ],
					"text" : "We add a chord named John with a note named Paul"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 512.0, 176.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 128.0, 240.0, 69.0 ],
					"text" : "...but if you want to give more than one name, you have to put them into an llll (since third optional argument for \"addmarker\" is the marker role)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 93.0, 325.0, 40.0 ],
					"text" : "Also the \"addmarker\" command support a direct marker naming as second argument..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 103.5, 144.0, 19.0 ],
					"text" : "addmarker 1000 Ringo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 455.0, 505.0, 21.0 ],
					"text" : "All of this also applies to bach.score.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 254.0, 526.0, 120.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: addmarker, playmode, dump, body",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: name, gathered, addchord, addmarker",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Inside the gathered syntax, the name of an item is an llll specification in the form (name <name(s)>).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
