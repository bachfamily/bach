...
, 			{
				"box" : 				{
					...
					"text" : "See Also: eval+llll, return+value",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, function, built, in, sqrt, atan2, space, whitespace, parens, listable, argument",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
