...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 219.0, 145.0, 20.0 ],
					"text" : "loadmess domain 0.1 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.5, 377.083344, 127.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.5, 447.0, 137.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 349.5, 401.5, 182.0, 36.0 ],
					"text" : "bach.keys length domain domainpixels @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 215.0, 457.0, 51.0 ],
					"text" : "The answer is in the form domainpixels <start_pixel> <end_pixel>.\nPixels counting starts at the leftmost uppermost corner of the object box.\nThis is useful to synchronize other U/I objects, possibly to be superposed.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 190.5, 357.0, 25.0 ],
					"text" : "Tells from which pixel and to which pixel the domain goes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 56.0, 278.0, 21.0 ],
					"text" : "The answer is in the form: length <length_ms>",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 84.5, 445.0, 25.0 ],
					"text" : "Obtain the domain, i.e. the portion of notation object shown in the screen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 193.5, 104.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 87.5, 71.0, 19.0 ],
					"text" : "getdomain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 13.380936, 401.5, 186.0, 36.0 ],
					"text" : "bach.keys length domain domainpixels @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 223.5, 269.0, 208.0, 125.083336 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 78.0, 55.0, 215.0, 25.0 ],
					"text" : "Obtain the length in milliseconds"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 7.0, 269.0, 204.0, 125.083336 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7300,
					"voicenames" : [ "<none>", "<none>" ],
					"voicespacing" : [ -8.4, 17.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 58.0, 64.0, 19.0 ],
					"text" : "getlength"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Querying length and domain",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: query, queries, length, domain, screen, pixels, getlength, getdomain, getdomainpixels",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "You can query the length (except for bach.slot) and the portion of notation object displayed.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 264.5, 233.0, 264.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 264.75, 450.5, 264.75 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 264.5, 233.0, 264.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 264.25, 450.5, 264.25 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 264.5, 233.0, 264.5 ],
					"source" : [ "obj-8", 0 ]
				}
