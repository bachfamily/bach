...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 396.0, 175.0, 55.0 ],
					"text" : "This note has no color assigned inside the first slot"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "We prepare a color slot named \"color\", and link the notecolor to the slot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 188.5, 284.0, 83.0 ],
					"text" : "bach immediately understands that the note color has to be matched to the one contained inside the slot. Open the first slot window and change the color to have the notecolor change"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 174.0, 295.0, 112.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The easiest way to assign a color to a note is to link a slot color to the notecolor.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Changing note color with a color slot",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: slot, link, linkage, appearance, change, changing, note, color, head, notehead, linknotecolortoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
