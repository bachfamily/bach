...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 448.0, 577.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The three different algorithms allow fine-tuning (see #respell+options).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 170.5, 385.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 299.0, 522.0, 141.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, select, pitch, respell, automatically, enharmonic, enharmonicity, reset, atonal, chew, chen, chewandchen, algorithm, selection, algorithm",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
