...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 433.0, 592.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Only the default algorithm supports microtonality (the other ones only work for standard accidentals).\nThe three different algorithms allow fine-tuning (see #respell+options).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 254.5, 236.0, 40.0 ],
					"style" : "",
					"text" : "Use the Chew and Chen respelling algorithm, designed for tonal music"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 263.0, 203.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm chewandchen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 212.5, 258.0, 40.0 ],
					"style" : "",
					"text" : "Of course, you can apply any algorithm to the selection only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 221.0, 237.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @selection 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 170.5, 385.0, 40.0 ],
					"style" : "",
					"text" : "Use the atonal algorithm, fine-tuned for allowing sequences of notes to be read with more musician-friendly enharmonicities"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 179.0, 158.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 83.0, 519.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The default algorithm simply respells each individual note automatically according to the current key signature and (possibly) the defined #enharmonic+table.\nNeighbors note do not influence the spelling of any given note.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 140.0, 253.0, 25.0 ],
					"style" : "",
					"text" : "The same, but for the selection only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 140.0, 128.0, 23.0 ],
					"style" : "",
					"text" : "respell @selection 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 58.0, 419.0, 25.0 ],
					"style" : "",
					"text" : "Automatically respell the whole score, according to default algorithm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 58.0, 49.0, 23.0 ],
					"style" : "",
					"text" : "respell"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The \"respell\" message respells the pitches according to a pitch respelling algorithm",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: key+signature, enharmonic+table, respell+options",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, select, pitch, respell, automatically, enharmonic, enharmonicity, reset, atonal, chew, chen, chewandchen, algorithm, selection, algorithm, spell",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
