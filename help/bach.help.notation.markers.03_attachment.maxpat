...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 227.0, 51.0, 21.0 ],
					"text" : "tempo:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 198.0, 85.0, 21.0 ],
					"text" : "loadmess 60"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 217.0, 253.0, 40.0 ],
					"text" : "Decrease the tempo and see what happens to the markers"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 187.0, 227.0, 52.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 187.0, 251.0, 35.0, 21.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 417.0, 364.0, 181.0, 98.0 ],
					"text" : "Autoclear must be turned off, since we want to be able to change just the measureinfo (tempo) without clearing the content."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.0, 337.0, 152.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.0, 157.0, 365.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When voices are independent (as far as tempi or time signatures are concerned), the precise voice assignment can be crucial. See #timepoint+syntax.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 103.0, 443.0, 54.0 ],
					"text" : "You can explicitely define the voice to which a \"red\" marker is attached by using the complete timepoint syntax (voice being the first element). Here we are assigning it explicitely to the second voice"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: marker, marker+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 144.0, 23.0 ],
					"text" : "Marker attachment",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: marker, attach, addmarker, measure, symbolic, position, absolute, relative, attachment",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 601.0, 65.0 ],
					"text" : "Markers attached to measures (by default: red) will stick with their symbolic position, even if measures are added before them, or if the tempo changes. On the other hand, markers attached to absolute temporal positions (by default: green) will move relatively to the measure barlines, as the tempo changes or as measures are added before them.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 309.0, 396.0, 165.0 ],
					"pitcheditrange" : "null",
