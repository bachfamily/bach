...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.0, 158.0, 199.0, 54.0 ],
					"style" : "",
					"text" : "By default, slot 21 is defined as lyrics slot, and pops up by hitting the L key"
				}
