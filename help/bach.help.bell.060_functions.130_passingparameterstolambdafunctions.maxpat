...
, 			{
				"box" : 				{
					"code" : "$closeEnough = ($x, $y, $e = $epsilon ||| 0 -> abs($x - $y) <= $e) ; $epsilon = $l2 ; finditems($l1, 1, $closeEnough) ",
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y\\, $e = $epsilon ||| 0 -> abs($x - $y) <= $e) \\; $epsilon = $l2 \\; finditems($l1\\, 1\\, $closeEnough) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 307.5, 98.0, 23.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 214.0, 160.0, 23.0 ],
					"text" : "1 2 3 1 4 5 0.99 1.08 3 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.0, 81.0, 29.5, 23.0 ],
					"text" : "0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 81.0, 34.0, 23.0 ],
					"text" : "0.05"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 81.0, 29.5, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 81.0, 160.0, 23.0 ],
					"text" : "1 2 3 1 4 5 0.99 1.08 3 2 1"
				}
...
, 			{
				"box" : 				{
					"code" : "$closeEnough = ($x, $y -> abs($x - $y) <= $epsilon) ; $epsilon = $l2 ||| 0 ; finditems($l1, 1, $closeEnough) ",
					"fontname" : "Menlo Regular",
					"fontsize" : 13.0,
					"id" : "obj-14",
					"linecount" : 3,
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y -> abs($x - $y) <= $epsilon) \\; $epsilon = $l2 ||| 0 \\; finditems($l1\\, 1\\, $closeEnough) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: scope, scoping, visibility, default",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 298.0, 23.0 ],
					"text" : "Passing parameters to lambda functions",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, function, user, defined, passing, finditems, lambda",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
