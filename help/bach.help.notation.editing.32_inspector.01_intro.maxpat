        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 411.0, -65.0, 142.0, 22.0 ],
                    "text": "loadmess sel chord 1 1 1"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 452.0, 182.0, 144.0, 54.0 ],
                    "text": "Alternatively, use the \"openinspector\" message"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 360.5, 197.5, 90.0, 23.0 ],
                    "text": "openinspector"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 311.0, 62.0, 305.5, 54.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 353.0, 118.0, 230.0, 79.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "text": "Tags: editing, edit, interface, inspector, external, dedicated, using, openinspector, open, popup",
                    "textcolor": [ 0.5, 0.5, 0.5, 1.0 ],
                    "varname": "tags"
                }
            },
