...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 448.0, 92.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 241.0, 193.0, 22.0 ],
					"style" : "",
					"text_width" : 165.0
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 273.0, 263.0, 131.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 238.0, 322.0, 108.0 ],
					"style" : "",
					"text" : "Below all attributes in the bach inspector, you find the commands to navigate the score hierarchy. For instance, if you're inspecting a chord, you'll need to press Enter to inspect the first note of the chord, and so on. Both selection on the object and the bach inspector will stay exactly in sync, so that you will always be inspecting the selected element.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.75, 129.0, 230.0, 79.0 ],
					"style" : "",
					"text" : "A dedicated bach inspector pops up, allowing you to directly change the value of the notation item's attributes, exactly as you do with the ordinary Max inspector.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 70.0, 341.0, 160.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: slotinfo, breakpointshavenoteheads",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, inspector, external, dedicated, using",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "All notation object come with a dedicated inspector, allowing you to monitor and change all the basic properties of each notation item.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
