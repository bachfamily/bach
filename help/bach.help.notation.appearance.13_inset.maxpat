...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 68.0, 72.0, 22.0 ],
					"text" : "loadmess 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 138.0, 162.0, 21.0 ],
					"text" : "WARNING:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 153.0, 176.0, 65.0 ],
					"text" : "This is not a currently fully supported features. In some cases, content may overflow from the rounded corners."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 98.0, 202.0, 40.0 ],
					"text" : "Change the roundness of the corners"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 323.0, 98.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 134.0, 74.0, 23.0 ],
					"text" : "rounded $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 98.0, 202.0, 54.0 ],
					"text" : "Change the horizontal inset of the staves with respect to the object box"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 98.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 128.0, 54.0, 23.0 ],
					"text" : "inset $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 37.0, 330.0, 362.0, 124.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 37.0, 194.0, 362.0, 124.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80900,
...
, 			{
				"box" : 				{
					...
					"text" : "Horizontal inset and rounded corners",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, corner, round, rounded, inset, horizontal, space, before, pad, border",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "You can customize the inset between the object border and the beginning of the staff. \nWith some precaution, you can also change the roundness of the objects' corners.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
