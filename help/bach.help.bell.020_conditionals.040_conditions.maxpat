...
, 			{
				"box" : 				{
					...
					"text" : "See Also: if+then, if+then+else, return+value",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 87.0, 23.0 ],
					"text" : "Conditions",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: condition, conditional, true, false, zero, null, boolean, logical",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 339.0, 21.0 ],
					"text" : "What does actually mean that a condition is true or false?",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
