...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 262.5, 240.0, 40.0 ],
					"style" : "",
					"text" : "Only check unnecessary dynamics, don't check inconsistent ones"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 150.0, 99.0, 40.0 ],
					"style" : "",
					"text" : "...fix verbosely"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 117.0, 155.0, 23.0 ],
					"style" : "",
					"text" : "checkdynamics selection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.0, 117.0, 158.0, 25.0 ],
					"style" : "",
					"text" : "...for the selection only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 117.0, 134.0, 23.0 ],
					"style" : "",
					"text" : "fixdynamics selection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 339.0, 300.5, 234.0, 40.0 ],
					"style" : "",
					"text" : "Only correct inconsistent dynamics, keep unnecessary ones"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 87.5, 188.0, 25.0 ],
					"style" : "",
					"text" : "Correct wrong dynamics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 311.0, 276.0, 23.0 ],
					"style" : "",
					"text" : "fixdynamics @inconsistent 1 @unnecessary 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.0, 89.0, 79.0, 23.0 ],
					"style" : "",
					"text" : "fixdynamics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 557.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you perform a selection, he \"checkdynamics\" message will post in the Max window warnings if inconsistents dynamic markings sequences or unnecessary dynamics are found throughout the selection. The \"fixdynamics\" message will additionally fix the found error or inconsistencies.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 273.0, 297.0, 23.0 ],
					"style" : "",
					"text" : "checkdynamics @inconsistent 0 @unnecessary 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 89.0, 100.0, 23.0 ],
					"style" : "",
					"text" : "checkdynamics"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 150.0, 440.0, 111.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 516.0, 602.0, 19.0 ],
					"style" : "",
					"text" : "See Also: selection+message, sel",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Checking and fixing dynamics",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: dynamic, hairpin, check, checkdynamics, post, warn, wraning, inconsistent, marking, unnecessary, fix, correct, selection, operate, message, upon, on",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
