...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 420.0, 387.0, 50.0 ],
					"text" : "There is actually another way to make a value persistent, through the keep keyword, but once again introducing it needs discussing functions first.",
...
,
					"text" : "bach.pack $count @prepend params @out m"
				}
...
,
					"text" : "bach.eval $x = $count + 1 @params [$count 0]"
				}
...
,
					"text" : "bach.eval print($x) \\; $x = 42 \\; print($x) @out m"
				}
