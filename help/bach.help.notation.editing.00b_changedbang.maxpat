...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 133.0, 275.0, 65.0 ],
					"presentation_rect" : [ 8.0, 109.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Otherwise the bang is only output at mouseup, or both on mousedown and mouseup (if mousedown already modifies the object status)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 438.0, 442.0, 24.0, 24.0 ],
					"presentation_rect" : [ 443.0, 447.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 496.0, 342.0, 24.0, 24.0 ],
					"presentation_rect" : [ 503.0, 339.0, 0.0, 0.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 249.0, 202.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 62.5, 234.0, 25.0 ],
					"presentation_rect" : [ 227.0, 152.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Also send the bang upon undo/redo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 62.5, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 91.0, 335.0, 40.0 ],
					"style" : "",
					"text" : "Output the bang notification continuously \n(whenever applicable, e.g. while dragging notes, etc.)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 348.0, 447.0, 88.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 68.0, 236.0, 447.0, 97.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7850,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: edit, notification",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, change, `bang, undo, undobang, continuousbang, continuously, output, changed, modify, notification, notify",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 566.0, 21.0 ],
					"style" : "",
					"text" : "A bang is always output from the last outlet whenever some change via interface has been done.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
