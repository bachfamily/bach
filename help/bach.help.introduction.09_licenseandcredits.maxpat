...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "The bach logo is designed by Davide Bordogna.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 413.0, 475.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 349.0, 131.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 349.0, 419.0, 21.0 ],
					"style" : "",
					"text" : "For any information, and to check for updates, visit the official website: ",
					"textcolor" : [ 0.25, 0.25, 0.25, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 580.0, 304.0, 259.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 6.0, 399.0, 92.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 597.0, 95.0, 87.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 401.0, 88.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.5, 456.0, 490.0, 38.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 399.0, 478.0, 21.0 ],
					"style" : "",
					"text" : "bach is currently licensed under a ",
					"textcolor" : [ 0.25, 0.25, 0.25, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 10.0, 190.0, 354.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 249.0, 607.0, 79.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 124.0, 600.0, 36.0 ],
					"style" : "",
					"text" : "We also wish to thank: Sara Adhitya, Davide Bordogna, DaFact, Phil Gaskill, Eric Grunin, Mika Kuuskankare, Andrew Pask, Andrea Rota, Andrea Sarto.",
					"textcolor" : [ 0.25, 0.25, 0.25, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 74.0, 600.0, 50.0 ],
					"style" : "",
					"text" : "The authors with to thank: Carlos Agon, Arshia Cont, Eric Daubresse, Emmanuel Jourdan, Serge Lemouton, Jean Lochard, Mikhail Malt and all the other people at IRCAM who have supported and encouraged the work, although not an internal IRCAM project.",
					"textcolor" : [ 0.25, 0.25, 0.25, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: introduction, bach, license, credit, acknowledgment, creative, common",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 38.0, 587.0, 21.0 ],
					"style" : "",
