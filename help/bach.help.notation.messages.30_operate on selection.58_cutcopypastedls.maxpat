...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 386.0, 254.0, 162.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 295.0, 282.0, 52.0 ],
					"style" : "",
					"text" : "sel note if measure == 1 && symonset == 3/4, copy durationline, unsel all, sel note if measure == 2, paste durationline"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.5, 181.5, 135.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 111.0, 400.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If more than one note is selected, only the first one is accounted for.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.875, 84.0, 343.0, 25.0 ],
					"style" : "",
					"text" : "The same, but erases the aforementioned duration line"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.875, 84.0, 99.0, 23.0 ],
					"style" : "",
					"text" : "cut durationline"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.5, 144.0, 295.0, 25.0 ],
					"style" : "",
					"text" : "Apply copied duration line to all selected notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.5, 144.0, 113.0, 23.0 ],
					"style" : "",
					"text" : "paste durationline"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 175.0, 303.0, 38.0 ],
					"style" : "",
					"text" : "sel note if voice == 1, copy durationline, unsel all, sel note if voice == 2, paste durationline"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 260.375, 356.666687, 311.0, 111.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 1,
					"showvelocity" : 4,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.875, 59.0, 270.0, 25.0 ],
					"style" : "",
					"text" : "Copy durationline of the first selected note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.875, 59.0, 109.0, 23.0 ],
					"style" : "",
					"text" : "copy durationline"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can cut, copy and paste duration line information (i.e. pitch breakpoints).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: edit+copy, edit+cut, edit+paste, message+copy, message+cut, message+paste, sel",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Cut, copy or paste duration lines",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, copy, cut, paste, duration, line, pitch, breakpoint, durationline, glissando, curve, point",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
