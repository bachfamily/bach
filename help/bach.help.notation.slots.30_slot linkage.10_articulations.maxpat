...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.5, 103.5, 372.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Another way of introducing articulations is to use the keyboard combinations (see #articulation+edit)",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 11.5, 273.0, 526.0, 102.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 386.0, 572.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Articulations slots are the simplest and standard way to use articulations, modify them, define custom noteheads and much more. Please refer to the dedicated section on #articulations to know more.\nUp to bach 0.7.9, there was an older articulation handling mechanism, which is now deprecated, in favour of the slot linkage technique.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 11.5, 81.0, 64.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.5, 110.0, 168.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 1, openslotwin 22"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 11.5, 147.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70907,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The simplest way to define articulations for a note is to use an \"articulations\" slot. By default, the 22th slot (key A) is already an articulations slot, linked with the articulations display.\nOne or more articulations can be selected in the slot.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, link, linkage, appearance, change, changing, note, articulation, define, add, linkarticulationstoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
