...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 324.885803, 128.0, 40.0 ],
					"style" : "",
					"text" : "Now these are distincs step"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 347.885803, 314.0, 23.0 ],
					"style" : "",
					"text" : "goto time 0, goto next @repeat 4 @graceshavedur 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 318.885803, 315.0, 23.0 ],
					"style" : "",
					"text" : "goto time 0, goto next @repeat 3 @graceshavedur 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 284.885803, 155.0, 25.0 ],
					"style" : "",
					"text" : "Here's the grace note!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 284.885803, 210.0, 23.0 ],
					"style" : "",
					"text" : "goto time 2999 @graceshavedur 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 108.885803, 339.0, 25.0 ],
					"style" : "",
					"text" : "Select all elements \"active\" at 2999ms. This is the rest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 108.885803, 97.0, 23.0 ],
					"style" : "",
					"text" : "goto time 2999"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 254.885803, 146.0, 25.0 ],
					"style" : "",
					"text" : "No more grace note!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 254.885803, 210.0, 23.0 ],
					"style" : "",
					"text" : "goto time 3000 @graceshavedur 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 64.385803, 266.0, 40.0 ],
					"style" : "",
					"text" : "Select all elements \"active\" at 3s. This include the grace note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 72.885803, 97.0, 23.0 ],
					"style" : "",
					"text" : "goto time 3000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 213.0, 501.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "By setting the \"graceshavedur\" message attribute to 1, one can interpret grace notes as having the duration set by the #gracedur playback parameter.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 152.885803, 200.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 137.385803, 308.0, 69.0 ],
					"style" : "",
					"text" : "Select chord at 0s, then go three steps right. This selects the grace note as well as the following chord: if grace notes have no duration, they start together"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 379.0, 461.0, 91.666664 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Grace notes in the go-to navigation",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, goto, go-to, go, to, navigate, navigation, grace, note, chord, duration, together",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default, grace notes have no actual duration, so that whenever you select one of them",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
