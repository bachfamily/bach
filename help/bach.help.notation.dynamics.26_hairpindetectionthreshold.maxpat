...
,
        ...
        "boxes" : [             {
                "box" :                 {
                    ...
                    "numoutlets" : 1,
                    "outlettype" : [ "" ],
                    "patching_rect" : [ 62.0, 91.0, 91.0, 22.0 ],
                    "text" : "loadmess set 1"
                }
...
,             {
                "box" :                 {
                    ...
                    "numinlets" : 1,
                    "numoutlets" : 0,
                    "patching_rect" : [ 109.75, 125.0, 437.0, 25.0 ],
                    "text" : "Have a look at what happens if this threshold ranges between 0 and 10"
                }
...
,             {
                "box" :                 {
                    ...
                    "numoutlets" : 1,
                    "outlettype" : [ "" ],
                    "patching_rect" : [ 447.5, 410.0, 111.0, 38.0 ],
...
,             {
                "box" :                 {
                    ...
                    "numinlets" : 1,
                    "numoutlets" : 0,
                    "patching_rect" : [ 139.0, 77.5, 173.0, 25.0 ],
                    "text" : "Use default threshold (1.)"
                }
...
,             {
                "box" :                 {
                    ...
                    "numoutlets" : 1,
                    "outlettype" : [ "" ],
                    "patching_rect" : [ 10.0, 77.5, 127.0, 23.0 ],
...
,             {
                "box" :                 {
                    ...
                    "numoutlets" : 1,
                    "outlettype" : [ "" ],
                    "patching_rect" : [ 6.0, 32.0, 534.0, 36.0 ],
                    "sendto" : "bach.help.filtertags",
                    "text" : "The \"thresh\" specification sets a threshold for hairpin detection. The higher the threshold, the more coarse the hairpins are allowed to be.",
...
,             {
                "box" :                 {
                    ...
                    "text" : "Hairpin detection threshold",
                    "varname" : "title"
                }
...
,             {
                "box" :                 {
                    ...
                    "text" : "Tags: message, convert, assign, dynamic, velocity, velocities, parameter, thresh, threshold, unnecessary, sieve, trim, approximate, hairpin, crescendo, decrescendo, detect, detection, velocities2dynamics",
                    "textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
                    "varname" : "tags"
                }
