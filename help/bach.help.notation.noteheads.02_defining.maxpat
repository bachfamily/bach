...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 208.0, 285.0, 40.0 ],
					"text" : "Set an accent notehead to all notes at the beginning of their measures"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sel note if chordindex == 1, setslot [23 acc], clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 159.0, 217.0, 40.0 ],
					"text" : "Set white squares as notehead for all 1/8 notes"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sel note if symduration == 1/8, setslot [23 whitesquare], clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 259.0, 153.0, 25.0 ],
					"text" : "reset all noteheads"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 260.0, 208.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 130.0, 181.0, 25.0 ],
					"text" : "All C's are given a 'x'"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "sel note if cents % 1200 == 0, setslot [23 cross], clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 84.0, 595.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Since notehead are 100% slot-based, you can on the other hand use all #slot+messages or #slot+syntax to introduce or retrieve noteheads. Here are a few examples",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 297.0, 595.0, 166.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 591.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you want to introduce noteheads via mouse and keyboard, open the notehead slot linked with the articulations display (by default it is the 23th slot, opened via the 'h' key), then simply click on the desired notehead. Differently from #articulations, only one notehead can be assigned for each note.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: articulations, slot+messages",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Introducing standard noteheads",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: notehead, define, assign, introduce, slot, addslot, delete, reset, clear, setslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
