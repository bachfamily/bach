...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.5, 215.0, 181.0, 40.0 ],
					"text" : "Add a marker after 90% of second measure, voice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 157.0, 222.0, 40.0 ],
					"text" : "Add a marker after 20% of first measure (voice 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 102.0, 222.0, 40.0 ],
					"text" : "Add a marker at the middle of third measure (voice 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 418.666687, 169.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 16.0, 275.000031, 573.0, 140.666656 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "Extended timepoint syntax",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, time, point, timepoint, symbolic, absolute, numeric, position, extended, float",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 31.0, 545.0, 50.0 ],
					"text" : "In the timepoint syntax, you can replace the symbolic onset with a floating point value from 0 to 1 to indicate the point inside the measure. Also, you can do the same with the simple (<measure_number>) syntax, simply by putting a floating point measure number.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
