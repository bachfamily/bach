...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 91.0, 209.0, 25.0 ],
					"style" : "",
					"text" : "Mark time signatures and tempi"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 60.0, 196.0, 25.0 ],
					"style" : "",
					"text" : "Mark measures and divisions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 92.0, 260.0, 23.0 ],
					"style" : "",
					"text" : "score2roll @marktimesigs 1 @marktempi 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.0, 341.0, 99.0, 23.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 60.0, 287.0, 23.0 ],
					"style" : "",
					"text" : "score2roll @markmeasures 1 @markdivisions 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 321.0, 447.0, 106.666667 ],
					"pitcheditrange" : [ "null" ],
					"showstems" : 0,
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 121.0, 440.0, 118.666667 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 289.0, 100.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: score2roll, quantize",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Options for score to roll conversion",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, score2roll, score, to, roll, convert, conversion, option, markmeasure, marktimesig, markbarline, markdivision, marktempo, marktempi, tempo, measure, time, signature, timesig, barline, division, mark",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "You can mark barlines, time signatures, tempi and/or division just by adding the proper specification:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
