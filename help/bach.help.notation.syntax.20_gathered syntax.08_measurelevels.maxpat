...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 222.0, 305.0, 40.0 ],
					"presentation_rect" : [ 85.5, 207.0, 0.0, 0.0 ],
					"text" : "A plain list is interpreted and beamed automatically"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.5, 298.0, 450.0, 55.0 ],
					"presentation_rect" : [ 162.0, 380.0, 0.0, 0.0 ],
					"text" : "We have added a level of parentheses, meaning that those two middle 1/16 chords must be isolated and beamed together"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.5, 337.0, 314.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.5, 358.0, 575.0, 19.0 ],
					"presentation_rect" : [ 44.0, 285.0, 0.0, 0.0 ],
					"text" : "((((4 4) (60)) (-1/2) (1/16 (E4 100 0)) ((1/16 (E4 100 0)) (1/16 (E4 100 0))) (1/16 (E4 100 0)) (-1/4)))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 186.0, 564.0, 36.0 ],
					"presentation_rect" : [ 6.0, 188.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Such information is not necessary at input (see #measure+syntax+plain), but it is often useful at output, for instance to reconstruct the score precisely as it was.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 121.0, 336.0, 65.0 ],
					"presentation_rect" : [ 6.0, 125.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Those additional levels of parenthesis represent an additional information specifying a hierarchical structure for the rhythmical elements. This information is called #rhythmic+tree.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 40.0, 336.0, 83.0 ],
					"presentation_rect" : [ 23.299988, 59.0, 0.0, 0.0 ],
					"text" : "When you dump information from a bach.score, each measure is not represented as a plain sequence of chords. On the contrary, often some more levels of parentheses show up, along with some weird \"leveltype\" specifications"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.399994, 35.0, 76.0, 19.0 ],
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.399994, 150.0, 199.0, 21.0 ],
					"presentation_rect" : [ 430.0, 6.0, 0.0, 0.0 ],
					"text" : "bach.print ScoreGatheredSyntax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.5, 398.0, 294.0, 51.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The general \nSee #rhythmic+tree to discover all the intricacies of rhythmic representation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -174.0, 323.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 261.0, 567.0, 19.0 ],
					"text" : "((((4 4) (60)) (-1/2) (1/16 (E4 100 0)) (1/16 (E4 100 0)) (1/16 (E4 100 0)) (1/16 (E4 100 0)) (-1/4)))"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 383.0, 231.0, 89.0 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 89.0 ],
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")" ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax, rhythmic+tree, measure+syntax+plain",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: gathered, syntax, measure, level, rhythmic, rhythm, tree, type, leveltype",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.399994, 223.0, 20.0, 20.0 ],
					"presentation_rect" : [ 316.5, 220.0, 0.0, 0.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.5, 298.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
