...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 280.0, 37.0, 23.0 ],
					"text" : "1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 373.0, 100.0, 23.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 129.0, 37.0, 23.0 ],
					"text" : "1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 38.0, 601.0, 79.0 ],
					"text" : "For small tasks, writing directly bell code in the object box or the text editor is probably the simplest thing to do. In more complex situations, on the other hand, it may prove useful to write some bell code in an external editor, write it to a text file and read it in Max.\nThere are two ways to do this: either by sending the \"read\" message to one of the objects capable to interpret bach code, or by using the \"include\" keyword.",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, source, code, file, read, include",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
