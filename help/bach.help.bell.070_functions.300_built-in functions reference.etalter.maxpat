...
, 			{
				"box" : 				{
					...
					"text" : "The etalter() function is equivalent to the alter() function.",
...
, 			{
				"box" : 				{
					...
					"text" : "etalter() function reference",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, built, in, function, pitch, etalter",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
