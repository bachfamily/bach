...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.5, 253.5, 94.5, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.5, 262.0, 404.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @voicewise 0 @flattest Gb @sharpest A#"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.5, 216.0, 317.0, 40.0 ],
					"style" : "",
					"text" : "Don't use any note \"flatter\" than Gb in the circle of fifths (i.e. don't use Cb, Fb, nor any double flat)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 216.0, 171.0, 38.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @voicewise 0 @flattest Gb"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 164.0, 284.0, 54.0 ],
					"style" : "",
					"text" : "Don't use any note \"sharper\" than A# in the circle of fifths (i.e. don't use E#, B#, nor any double sharp)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 179.5, 244.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @sharpest A#"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 124.0, 526.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you need to only respell some voices, you can use the #sel+note message to select the notes in those voices, and then use set @selection 1 in the respell message.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 82.0, 305.0, 40.0 ],
					"style" : "",
					"text" : "This tells bach to respell all the voices as if they were"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.0, 56.0, 283.0, 25.0 ],
					"style" : "",
					"text" : "By default respelling happens voice by voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 82.0, 242.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @voicewise 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.5, 296.5, 430.0, 23.0 ],
					"style" : "",
					"text_width" : 193.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 57.0, 242.0, 23.0 ],
					"style" : "",
					"text" : "respell @algorithm atonal @voicewise 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 326.0, 522.0, 141.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Some respell options are valid for all the algorithms",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: respell, sel+note",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
