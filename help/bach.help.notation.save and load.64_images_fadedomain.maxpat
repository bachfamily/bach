...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 289.5, 262.0, 40.0 ],
					"presentation_linecount" : 2,
					"text" : "Only paint notes whose onset lies in the domain (useful if you hide duration lines)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 298.0, 269.0, 23.0 ],
					"text" : "exportimage @view scroll @onsetindomain 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 242.0, 273.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.0, 250.0, 197.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 205.0, 276.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 213.5, 227.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 9.0, 325.5, 578.0, 143.0 ],
					"pitcheditrange" : [ "null" ],
					"playpartialnotes" : 0,
					"ruler" : 1,
					"rulerlabels" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: export+image, export+image+view, fadedomain, showduration",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: data, export, image, png, picture, save, exportimage, fade, domain, fadedomain,  appearance, exported, image, systemvshift, shift, system, separation, vertical, onsetindomain, onset, in",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
