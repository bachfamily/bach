...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 380.0, 237.0, 79.0 ],
					"presentation_linecount" : 2,
					"sendto" : "bach.help.filtertags",
					"text" : "N.B.: In bach, all curves with slope = 0 are shown as perfect lines, regardless of the slopemapping (because you may want to use them with [line~] instead of [curve~] anyway!)",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 11.0, 186.0, 221.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 539.0, 267.0, 36.0, 21.0 ],
					"text" : "(red)",
					"textcolor" : [ 0.694117647058824, 0.172549019607843, 0.172549019607843, 1.0 ]
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.36078431372549, 0.541176470588235, 0.737254901960784, 0.0 ],
					"fontsize" : 13.0,
					"id" : "obj-17",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 539.0, 294.0, 42.0, 21.0 ],
					"text" : "(blue)",
					"textcolor" : [ 0.282352941176471, 0.52156862745098, 0.690196078431373, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 229.0, 188.0, 23.0 ],
					"text" : "addslot [ 1 [ 0 0 0 ] [ 1 127 $1 ]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 293.0, 184.0, 23.0 ],
					"text_width" : 118.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 266.0, 184.0, 23.0 ],
					"text_width" : 119.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 569.0, 137.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Slopes in Max are values between -1 and 1 corresponding to different curvatures of a trajectory (0 representing a straight line). The equation bach uses to represent slopes in function slots and in every other aspect where slopes are involved differs from the one that Max employs. Max function was probably chosen to optimize integration over a lot of steps and DSP computing. However, not only is it less elegant (after all, who cares) but its lack of elegance displays several shortcomings: it is less smooth in the transitions on the slope, plus for slope=0 one doesn't even get a straight line (see it for yourself with [curve~]!). \nIf you want to use the Max curve function anyway, which may be practical in combination with the [curve~] object, just change the \"slopemapping\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: slot, slotinfo, range, slope, line, curve, mapping, slopemapping, bach, Max",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
