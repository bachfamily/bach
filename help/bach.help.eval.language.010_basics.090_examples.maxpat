...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 444.0, 252.0, 51.0, 22.0 ],
					"text" : "t 0 clear"
				}
...
, 			{
				"box" : 				{
					"code" : "`addchord 1 [$l2 * 1000 [$l1*100 500 127]] ",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 315.5, 384.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
					"text" : "bach.eval `addchord 1 [$l2 * 1000 [$l1*100 500 127]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 383.0, 286.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 18.0, 252.0, 384.0, 22.0 ],
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 71.5, 45.0, 22.0 ],
					"text" : "1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 149.5, 91.0, 22.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					"code" : "-[[$l1]*3 `funky [$l1 42]*2] length($l1) ",
					"fontname" : "Menlo Regular",
					"id" : "obj-55",
					"linecount" : 2,
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 100.5, 370.0, 36.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
					"text" : "bach.eval -[[$l1]*3 `funky [$l1 42]*2] length($l1) @out m"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-120", 0 ],
					"midpoints" : [ 485.5, 353.0, 27.5, 353.0 ],
					"source" : [ "obj-125", 1 ]
				}
