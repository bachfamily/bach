...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.0, 317.5, 336.0, 21.0 ],
					"showhand" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 225.0, 584.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 261.5, 244.0, 54.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 189.0, 559.0, 36.0 ],
					"showhand" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 277.0, 310.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"showhand" : 0,
					"text" : "– markmeasures (default: 1): if non-0, a special \"barline\" marker will be added for each measure\n    in the MIDI file, according to the current time signature (especially useful for quantization)\n– markdivisions (default: 0): same thing, for measure divisions (beats)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: data, read, midi, import, markmeasures, file, message, importbarlines, barline, measure, mark, import, barline, markdivisions, division",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
