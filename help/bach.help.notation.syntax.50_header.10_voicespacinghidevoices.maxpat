...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 199.0, 99.0, 22.0 ],
					"text" : "dump hidevoices"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 431.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 175.0, 111.0, 22.0 ],
					"text" : "dump voicespacing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 129.0, 564.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "whether the voice is hidden (1) or not (0); also see #hidevoices",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 111.5, 566.0, 21.0 ],
					"showhand" : 0,
					"text" : "– hidevoices: as for the hidevoices attribute, sets a list of 0's and 1's for each voice, determining",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 69.5, 564.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The length of the list is the number of voices + 1, since it also include both space before the first voice and the space after the last one (see #voicespacing)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"showhand" : 0,
					"text" : "– voicespacing: as for the voicespacing attribute, sets a list of distances between voices.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.450012000000015, 214.0, 268.0, 23.0 ],
					"text" : "[voicespacing 20 25 20 12] [hidevoices 0 1 0]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 174.5, 261.0, 23.0 ],
					"text" : "[voicespacing 10 5 20 12] [hidevoices 0 0 0]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 266.450012000000015, 268.0, 247.000000000000028, 149.333327999999995 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: voicespacing, hidevoices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Voice spacing, hide voices",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: header, syntax, voice, space, spacing, hide, hidevoices, voicespacing, offset",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The voice spacind and hide voices is also part of the header, so that it can be saved with the object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
