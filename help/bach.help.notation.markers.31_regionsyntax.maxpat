...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 377.0, 238.0, 23.0 ],
					"text" : "addmarker [region [1 1 0] 7/4] [A region]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 266.0, 350.0, 325.0, 93.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 188.0, 309.0, 23.0 ],
					"text" : "addmarker [region 0 tillnext] [Region till next marker]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 161.0, 241.0, 23.0 ],
					"text" : "addmarker [region 2000 1000] [A region]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 133.0, 207.0, 23.0 ],
					"text" : "addmarker 1500 [A simple marker]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 47.0, 321.0, 21.0 ],
					"text" : "[ region  <onset/timepoint> <duration> ]",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 6.0, 227.0, 518.0, 110.833333333333343 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80104,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 67.0, 556.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where the onset/timepoint is the usual marker starting point (see #marker+syntax, #timepoint) and the duration is either a floating point number (milliseconds, for marker attached to their absolute time position) or a rational number (in symbolic units, for bach.score's marker attached to measures).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: marker, region, syntax, tillnext",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 601.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In order to create a region marker instead of a point-like one, you should replace the onset, or the timepoint, with a llll of the type ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 20.5, 410.0, 254.0, 410.0, 254.0, 345.0, 275.5, 345.0 ],
					"source" : [ "obj-4", 0 ]
				}
