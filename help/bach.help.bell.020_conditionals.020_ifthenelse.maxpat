...
,
					"text" : "bach.eval (if $x1 == 10 then 3 else 6) + $x1 @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 192.5, 49.0, 23.0 ],
					"text" : "4 5 6 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 181.0, 192.5, 37.0, 23.0 ],
					"text" : "1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 192.5, 41.0, 23.0 ],
					"text" : "10 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 192.5, 29.5, 23.0 ],
					"text" : "20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 192.5, 29.5, 23.0 ],
					"text" : "10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 232.5, 237.0, 38.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80001
					}
,
					"text" : "bach.eval if $x1 == 10 then length($x2) else length($x1) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 109.0, 325.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80001
					}
,
					"text" : "bach.eval if $x1 == 10 then `bingo else `bongo @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, if, then, else, condition, conditional",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
