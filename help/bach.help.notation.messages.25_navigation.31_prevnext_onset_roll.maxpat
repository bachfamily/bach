...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 285.385803, 86.0, 25.0 ],
					"style" : "",
					"text" : "This won't"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 285.385803, 187.0, 23.0 ],
					"style" : "",
					"text" : "unsel all, sel chord -1, goto left"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 238.385803, 170.0, 40.0 ],
					"style" : "",
					"text" : "This will also select both synchronous chords"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 253.885803, 195.0, 23.0 ],
					"style" : "",
					"text" : "unsel all, sel chord -1, goto prev"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 128.885803, 396.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notice that this is not the case in a \"goto right\" chain of messages, where chords are visited one by one:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 169.885803, 201.0, 23.0 ],
					"style" : "",
					"text" : "goto time 0, goto right @repeat 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 214.885803, 248.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 405.385803, 157.0, 55.0 ],
					"style" : "",
					"text" : "These two chords have the same onset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 93.885803, 200.0, 23.0 ],
					"style" : "",
					"text" : "goto time 0, goto next @repeat 2"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 30.0, 316.885803, 308.0, 109.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: goto, goto+next, goto+right",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Go-to and onsets in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, goto, go-to, go, to, navigate, navigation, move, previous, next, prev, item, notation, select, previous, following, onset, synchronous, synchronicity, same, time, happen",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Whenever chords have the very same onset in bach.roll (and hence happen ”at the same time\"), they are selected together during a \"goto next\" chain of messages. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
