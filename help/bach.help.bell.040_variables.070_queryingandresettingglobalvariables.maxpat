...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.5, 116.0, 76.0, 25.0 ],
					"text" : "Indeed..."
				}
...
,
					"text" : "bach.eval John `vs. Paul @out m"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 116.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 434.0, 504.0, 40.0 ],
					"text" : "After clearglobals, even the variables with a setting defined in an object box automatically evaluated with @auto 1 lose their values. Bang here to restore them,"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.5, 442.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 381.0, 388.0, 54.0 ],
					"text" : "If you need a fresh start, you can send the clearglobals message to bach, which will reset them all to null. Notice that this will not destroy the variables, but only clear their contents."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 290.0, 23.0 ],
					"text" : "Querying and resetting global variables",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, variable, global, assignment, persistence, query, reset, printglobals, printglobalswithvalues, clearglobals, auto, attribute",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 559.0, 21.0 ],
					"text" : "You can send some specific messages to bach for viewing and resetting all the global variables.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 33.0, 471.0, 6.5, 471.0, 6.5, 60.5, 23.5, 60.5 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 33.0, 471.0, 6.5, 471.0, 6.5, 209.0, 23.5, 209.0 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
