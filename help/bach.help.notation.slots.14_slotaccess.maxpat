...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.5, 130.0, 242.0, 50.0 ],
					"presentation_rect" : [ 15.0, 159.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Click on the message, then try to open slot window 3, or try to modify content in slot 2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.5, 74.0, 230.0, 54.0 ],
					"style" : "",
					"text" : "Prevent access to slot 3, and set slot 2 as not modifiable via interface"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 114.0, 281.0, 395.0, 101.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default slot windows and slot contents are readable and writable. You can modify this behavior via the \"access\" specification of the slotinfo, either from the #slotinfo+inspector, or from message.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Restricting access to slots",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, slotinfo, restrict, restricting, access, prevent, modify, modification, slot, message, readonly, read, only, none, readandwrite, write, interface",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
