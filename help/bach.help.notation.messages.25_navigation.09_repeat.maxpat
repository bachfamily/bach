...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 58.0, 207.385803, 351.0, 23.0 ],
					"presentation_rect" : [ 60.0, 203.385803, 0.0, 0.0 ],
					"style" : "",
					"text" : "unsel all, sel chord 1 4, goto down @repeat 1 @skiprests 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.0, 136.385803, 162.0, 83.0 ],
					"presentation_rect" : [ 399.0, 164.385803, 0.0, 0.0 ],
					"style" : "",
					"text" : "Notice that the actions are actually repeated twice (see how the skiprests attribute moves the selection)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 159.385803, 351.0, 23.0 ],
					"presentation_rect" : [ 47.0, 145.885803, 0.0, 0.0 ],
					"style" : "",
					"text" : "unsel all, sel chord 1 4, goto down @repeat 2 @skiprests 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 98.885803, 200.0, 23.0 ],
					"style" : "",
					"text" : "goto time 0, goto next @repeat 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 90.385803, 308.0, 40.0 ],
					"style" : "",
					"text" : "Select chord at 0s, then go three steps right. This selects the fourth chord"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 252.0, 461.0, 205.0 ],
					"pitcheditrange" : [ "null" ],
					"presentation_rect" : [ 0.0, 0.0, 0.0, 205.0 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, goto, go-to, go, to, navigate, navigation, repeat, iterate",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 555.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can repeat a go-to action a certain number of times simply by using the \"repeat\" message attribute:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
