...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 391.0, 132.0, 214.0, 98.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "As the boxes width decrease, finding the approximation within each box becomes easier and easier. Thus, even though the number of approximations to compute is larger, the performing time should be sensibly faster for small boxes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 103.5, 183.0, 35.0, 23.0 ],
					"style" : "",
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 230.0, 85.0, 23.0 ],
					"style" : "",
					"text" : "((1/4 3/4) nil)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 230.0, 60.0, 23.0 ],
					"style" : "",
					"text" : "(1/8 2/4)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 247.116577, 261.0, 279.883423, 23.0 ],
					"style" : "",
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 42.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 223.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "(4 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 6.0, 261.0, 214.0, 23.0 ],
					"style" : "",
					"text" : "bach.quantize"
				}
