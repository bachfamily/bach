...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 176.0, 251.0, 54.0 ],
					"style" : "",
					"text" : "Group notes with onset < 1sec and (in a different group) notes with onset > 1.5sec"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 184.0, 278.0, 38.0 ],
					"style" : "",
					"text" : "sel note if onset < 1000, group, clearselection, sel note if onset > 1500, group, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 239.5, 94.0, 25.0 ],
					"style" : "",
					"text" : "Ungroup all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 86.0, 239.5, 99.0, 23.0 ],
					"style" : "",
					"text" : "sel all, ungroup"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 247.0, 132.5, 221.0, 25.0 ],
					"style" : "",
					"text" : "Ungroup the same group of notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 79.0, 194.0, 25.0 ],
					"style" : "",
					"text" : "Group all notes < 7100 cents"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 132.5, 199.0, 23.0 ],
					"style" : "",
					"text" : "sel note if cents < 7100, ungroup"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 81.0, 185.0, 23.0 ],
					"style" : "",
					"text" : "sel note if cents < 7100, group"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 279.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Use \"group\" and \"ungroup\" to create or break groups of chords in bach.roll",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Creating or breaking groups",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, create, modify, delete, break, group, ungroup",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
