...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 286.5, 200.5, 278.0, 25.0 ],
					"text" : "All voices span the diatonic keys in C major"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 169.0, 283.0, 21.0 ],
					"text" : "Note names instead of pitches are also allowed",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 265.0, 397.0, 25.0 ],
					"text" : "Revert to standard editing behavior (all pitches can be reached) "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 267.0, 117.0, 19.0 ],
					"text" : "pitcheditrange null"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 236.0, 213.0, 25.0 ],
					"text" : "You are allowed to mix syntaxes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 129.0, 378.0, 40.0 ],
					"text" : "Notes in the first voice can span from middle C to upper one; notes in the second voice do the same with E's"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Constrainting pitches to ranges or positions",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, pitcheditrange, constraint, force, pitch, range, position, grid",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The \"pitcheditrange\" attribute allows you to define ranges or grids from which the notes cannot escape while being edited.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
