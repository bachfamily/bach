...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 304.5, 89.0, 23.0 ],
					"style" : "",
					"text" : "dump slotinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 446.0, 69.0, 23.0 ],
					"style" : "",
					"text" : "bach.print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 547.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "These fields are never retrieved when the slotinfo is queried via a dump message, since they correspond to attribute values.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 67.0, 596.0, 137.0 ],
					"showhand" : 0,
					"text" : "– background:\n\n\n– popup:\n\n– rightclick:\n\n\n– linkto:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Lasts slotinfo parameters",
					"varname" : "title"
				}
