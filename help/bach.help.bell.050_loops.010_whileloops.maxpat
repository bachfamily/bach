...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 116.0, 588.0, 253.0 ],
					"text" : "where condition and body are two expressions of any complexity.\nThe condition is an expression returning true or false according to the same criteria as \"if...then\".\nThe \"while\" loop first evaluates the condition; if it is true, it evaluates the body and re-evaluates the condition; if it is still true, it evaluates the body again, and so on until the condition remains true. As soon as the condition is false, the iteration stops. \nThe return value of a while ... do loop is the value of the body at the end of the last iteration. \nThe return value of a while ... collect loop is the collection of the values taken by the body at each iteration.\nIf the condition is false at the beginning of the first iteration, the body doesn't get evaluated at all and the loop returns null.\nIn general, care must be taken for the condition to actually change its truth value at some point, otherwise the evaluation gets stuck in an infinite loop. Anyway, bach.eval has a maxtime attribute setting the maximum duration of an evaluation, so you won't be forced to quit Max anyway.\nBecause bach.eval is not interactive, that is, you can't feed data into it while its computation is running, there is no way to change the truth value of the condition from the outside, and in general you need at least one control variable involved, keeping track of some data to watch at every iteration of the loop.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 101.0, 282.0, 21.0 ],
					"text" : "while <condition> do|collect <body>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 366.0, 35.0, 23.0 ],
					"text" : "-273"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 361.5, 378.0, 112.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 447.0, 99.0, 23.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 366.0, 29.5, 23.0 ],
					"text" : "10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 366.0, 29.5, 23.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 398.5, 194.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: recursion, for+loop, map, reduce",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 107.0, 23.0 ],
					"text" : "\"While\" loops",
					"varname" : "title"
				}
