...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 247.0, 361.0, 83.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 164.0, 602.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where the command number can be from 1 to 30, followed by two symbols: one which will be used to route the output notes, and one which will be used to route the output chords. Finally, you can define a hot key which will trigger the command when pressed after a selection has been made.\nYou just have to define the commands you need, and the order is irrelevant. On the other hand, when retrieved upon dump, all five commands are output, in ascending order.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 257.0, 183.0, 52.0 ],
					"style" : "",
