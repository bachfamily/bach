...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 419.0, 597.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "See #dynamics+interface to know how to enter dynamics. See #dynamics+appearance to know more about some attributes handling the appearance.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.0, 152.0, 230.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.5, 143.5, 173.0, 40.0 ],
					"style" : "",
					"text" : "Tell bach that 1st slot contains dynamics"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 110.0, 252.0, 40.0 ],
					"style" : "",
					"text" : "Set up 1st slot to be of type dynamics, and to open when key D is pressed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 152.0, 127.0, 23.0 ],
					"style" : "",
					"text" : "linkdynamicstoslot 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -152.0, 257.5, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Both bach.roll and bach.score are dynamics-compatible. The dynamics assignment system is based on #slot+linkage. Indeed, to assign some dynamics, the way to go is to set up a dedicated dynamics slot, and link it to the dynamics via the \"linkdynamicstoslot\" attribute (or, equivalently, by setting the \"Link To\" field of the #slotinfo+inspector to \"Dynamics\"). \nWhen you create a new object, slot 20 is already linked to dynamics.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: slot+linkage, slotinfo+inspector, dynamics+interface, dynamics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, link, linkage, dynamics, linkdynamicstoslot, to",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
