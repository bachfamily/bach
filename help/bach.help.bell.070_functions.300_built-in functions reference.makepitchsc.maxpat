...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 96.0, 37.0, 23.0 ],
					"text" : "6100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 96.0, 29.5, 23.0 ],
					"text" : "36"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 96.0, 29.5, 23.0 ],
					"text" : "34"
				}
...
, 			{
				"box" : 				{
					"code" : "makepitchsc($x1, $x2) ",
					"id" : "obj-7",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 136.0, 247.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80900
					}
,
					"text" : "bach.eval makepitchsc($x1\\, $x2) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "makepitchsc() function reference",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, built, in, function, makepitchsc, pitch",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
