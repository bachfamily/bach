...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 450.5, 357.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 356.0, 112.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot 3dfunction: ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 310.0, 227.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 162.0, 77.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot spat: ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.5, 131.0, 320.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 70.0, 576.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where each path is either a complete path, or a simple filename, which will be searched through the Max search path. Last element is the index of the file which will be marked as \"active\" inside the filelist slot (1 meaning: first defined file, 2: second defined file, and so on).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 53.0, 85.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot filelist: ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Here's the second part of the complete list for slot content syntax:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
