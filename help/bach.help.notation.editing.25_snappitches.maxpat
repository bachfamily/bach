...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 133.0, 317.0, 123.0 ],
					"text" : "For instance, if the microtonal grid is semitonal, only multiple of 100 (semitone) can be allowed as cents values. If you grid is quartertonal (tonedivision being 4), then multiple of 50 cents are allowed, and so on.\n\nThis is also true for note creation: when you create a note, its pitch will be automatically snapped to the microtonal grid.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.5, 275.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 268.0, 278.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 305.0, 84.0, 19.0 ],
					"text" : "snappitch $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "When you drag a note up or down in a bach.roll or a bach.score, by default it can only assume discrete values snapped on the choosen microtonal grid (see #tonedivision). You can change this behaviour, and have the pitch span more finely the continuum of midicents by unsetting the attribute \"snappitch\":",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 204.0, 233.0, 120.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 363.0, 275.0, 178.0, 69.0 ],
					"text" : "You can unset the \"snappitch\" attribute to have the pitch span cents outside such grid."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: snap+time, snappitchtogrid",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Snap pitches to microtonal grid",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, snap, pitch, to, grid, microtone, microtonal, respell",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 131.0, 415.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 369.0, 379.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 99.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 545.0, 275.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
