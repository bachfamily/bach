...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: query, queries, convert, time, timepoint, position, millisecond, conversion, syntax, time, message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
