...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 141.0, 240.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "A few more barlines add repeat signs:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.0, 166.0, 194.0, 50.0 ],
					"presentation_linecount" : 3,
					"showhand" : 0,
					"text" : "rs = repeat start\nre = repeat end\nres = repeat end and start",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.5, 253.0, 543.0, 38.0 ],
					"text" : "[[[4 4] [60] [barline h]] [[4 4] [] [barline d]] [[4 4] [] [barline p]] [[4 4] [] [barline t]] [[4 4] [] [barline s]] [[4 4] [] [barline f]] [[4 4] [] [barline re]]], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 64.0, 376.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 429.0, 504.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also change the barline type via the popup menu: see #popup+barline, and via the #setmeasureparameters message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 64.0, 194.0, 152.0 ],
					"showhand" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 218.0, 305.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"loop" : [ "[", 1, 1, 0, "]", "[", 1, 1, 0, "]" ],
					"maxclass" : "bach.score",
					"minmeaswidthpersymunit" : 56.0,
					"numinlets" : 7,
					"numoutlets" : 9,
					"numvoices" : 1,
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 6.0, 323.0, 583.0, 103.571426000000002 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, measure, parameter, barline, type, automatic, dashed, normal, dotted, double, solid, final, hidden, tick, intervoice, repeat, sign, start, end",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 455.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The             parameter assigns a specific ending barline to a given measure. \nIt expects a specific letter, representing the barline type. The possibilities are:\n",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
