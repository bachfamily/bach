...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 433.0, 307.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "See #custom+notehead+families for a follow-up.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 450.0, 237.166672, 150.0, 23.0 ],
					"style" : "",
					"text_width" : 109.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 6.0, 82.0, 64.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 425.0, 97.0, 25.0 ],
					"style" : "",
					"text" : "Look inside!"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 217.5, 132.416656, 162.0, 50.0 ],
									"style" : "",
									"text" : "if user-defined enharmonicity is set, we use that"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 174.0, 160.0, 32.0, 23.0 ],
									"style" : "",
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 92.0, 188.416656, 32.0, 23.0 ],
									"style" : "",
									"text" : "t 0 l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 219.0, 37.0, 23.0 ],
									"style" : "",
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 92.0, 160.0, 77.0, 23.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 92.0, 132.416656, 101.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 331.0, 151.0, 23.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 103.0, 290.0, 83.0, 23.0 ],
									"style" : "",
									"text" : "regexp [A-Z]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 103.0, 254.0, 117.0, 23.0 ],
									"style" : "",
									"text" : "bach.mc2n @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 136.0, 413.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 399.428558, 425.0, 92.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 237.166672, 230.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 237.166672, 164.0, 23.0 ],
					"style" : "",
					"text_width" : 116.0
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 277.166687, 480.0, 135.833328 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 30.0, 594.0, 50.0 ],
					"text" : "Here's an application example for custom noteheads. We define a set of letters from A to G to be viable noteheads, and then we use the #automessage and #continuousbang attributes to allow smooth editing. Add notes, and the correct notehead will show up.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "A custom noteheads example",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: notehead, define, custom, specification, syntax, spec, example",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
