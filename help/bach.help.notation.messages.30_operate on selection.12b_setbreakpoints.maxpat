...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.714293999999995, 145.5, 468.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also copy and paste duration lines, either via interface or via message (see #copy+duration+line)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.530640000000005, 249.5, 90.0, 23.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.030609000000027, 249.5, 44.0, 23.0 ],
					"text" : "sel all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 226.0, 60.0, 25.0 ],
					"text" : "(Test)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.030609000000027, 226.0, 136.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 182.0, 157.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 98.5, 214.0, 40.0 ],
					"text" : "Sets a duration line from a sequence of breakpoints"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 107.0, 210.0, 23.0 ],
					"text" : "setdl [0 0 0] [0.5 200 0.4] [1 -200 0]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 303.714293999999995, 297.0, 298.0, 102.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 1,
					"showvelocity" : 1,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 297.0, 289.0, 103.0 ],
					"pitcheditrange" : [ "null" ],
					"showvelocity" : 1,
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: breakpoint, breakpointshavevelocity, copy+duration+line",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, operate, on, selection, breakpoints, addbreakpoint, erasebreakpoint, erase, add, duration, line, durationline, set, setdurationline, dl, setdl",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "If you want to completely assign a duration line via a sequence of breakpoints to all selected notes, you can use the \"setdurationline\" message:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 47.5, 286.5, 313.214293999999995, 286.5 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
