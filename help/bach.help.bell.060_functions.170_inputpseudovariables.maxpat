...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 208.0, 216.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "The $l1 ... $l<n> input pseudovariables can be used in any function, where they refer to the corresponding argument. We call them pseudovariables because you can read them as if they were variables, but you can't assign new values to them.",
...
, 			{
				"box" : 				{
					...
					"text" : "The input pseudovariables",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, function, dollar, pseudovariable, argument, position",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
