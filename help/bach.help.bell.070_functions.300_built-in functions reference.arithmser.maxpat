...
,
					"text" : "bach.eval arithmser(10\\, 100) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The arithmser() function return an arithmetic series, like the bach.arithmser object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "arithmser() function reference",
					"varname" : "title"
				}
