...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 95.192322, 293.0, 54.0 ],
					"presentation_rect" : [ 280.0, 109.0, 0.0, 0.0 ],
					"text" : "If this is 1, all existing synchronicities are forced to be kept (default is 0, since this might lead to more imprecise quantizations)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 175.0, 123.0, 25.0 ],
					"text" : "Click to quantize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.0, 210.0, 98.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 219.0, 102.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.0, 130.192322, 56.0, 19.0 ],
					"text" : "sync $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 178.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 300.0, 262.0, 292.0, 200.0 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 235.0 ],
					"showmeasurenumbers" : [ 1, 1, 1 ],
					"stafflines" : [ 5, 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")", "(", ")", "(", ")" ],
					"voicespacing" : [ 0.0, 26.0, 26.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 331.0, 65.0, 19.0 ],
					"text" : "(2 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 375.0, 171.0, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "You can use the \"sync\" attribute to force synchronicity between voices. In this case, the quantization of one voice will also depend on what happens on the other ones; if voices differ very much in density, this might result in a more imprecise quantization.",
...
, 			{
				"box" : 				{
					...
					"text" : "Preserving synchronicities",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, sync, synchronicity",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 13.5, 430.0, 289.5, 430.0, 289.5, 252.0, 309.5, 252.0 ],
					"source" : [ "obj-2", 0 ]
				}
