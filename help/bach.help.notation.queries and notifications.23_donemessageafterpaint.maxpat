...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 79.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 134.0, 423.0, 127.0 ],
					"presentation_rect" : [ 200.0, 145.0, 0.0, 0.0 ],
					"text" : "All the data concerning basic parameters (such as pitch, onset, duration...) is immediately recomputed when you build or recall a bach.roll or bach.score. Yet, some data, concerning display features, is only recomputed when the object is painted or re-painted (e.g. pixel positions). If you need to retrieve such information, you need the \"done\" message to be sent not only after the object has been rebuilt, but also after it has been repainted, so that you can be sure that all parameters are properly set. (Default is 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 75.0, 413.0, 54.0 ],
					"presentation_rect" : [ 190.0, 91.333313, 0.0, 0.0 ],
					"text" : "If this is set, if bach.roll and bach.score have saved content with the patcher, a \"done\" notification is sent when the patcher and all the bach.roll and bach.score content is loaded. (Default is 1)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 161.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.714279, 82.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 188.0, 141.0, 19.0 ],
					"presentation_rect" : [ 200.0, 108.0, 0.0, 0.0 ],
					"text" : "senddoneafterpaint $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.714279, 108.0, 137.0, 19.0 ],
					"text" : "senddoneatstartup $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "A \"done\" message is sent right when you open the patch, only if the \"senddoneatstartup\" attribute is set to 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: done+notification",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 308.0, 23.0 ],
					"text" : "Attributes for \"done\" notification",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: notify, notification, done, recall, startup, load, send, after, paint, senddoneatstartup, senddoneafterpaint",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The \"done\" notification (see #done+notification) is sent whenever an object is recalled or rebuilt. Two attributes handle two particular features of such notification.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 38.214279, 259.5, 304.5, 259.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 53.5, 249.5, 304.5, 249.5 ],
					"source" : [ "obj-19", 0 ]
				}
