...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: accidental, repeat, hide, repeating, hiding, show, preference, showaccidentalspreferences, alter, altered, repetition, natural, never, always, classical, show, preference, policy, display",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
