...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 321.5, 228.0, 21.0 ],
					"presentation_rect" : [ 309.0, 323.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #enharmonic+table to know more",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 252.5, 345.0, 69.0 ],
					"presentation_rect" : [ 148.0, 280.0, 0.0, 0.0 ],
					"text" : "If you set the \"accidentalspreferences\" attribute to \"Custom\", you can set a custom enharmonic table to determine how each chromatic step should be displayed"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 221.0, 57.0, 21.0 ],
					"presentation_rect" : [ 139.0, 227.5, 0.0, 0.0 ],
					"text" : "Custom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 95.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.5, 245.0, 382.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "E.g. in G major, it'll choose Bb and not A#, F natural and not E#",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 191.0, 373.0, 54.0 ],
					"text" : "Always choose flat accidentals (more precisely, in general: always choose a representation such that the displayed diatonic pitch is above the actual note)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 170.5, 382.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "E.g. in G major, it'll choose A# and not Bb, E# and  not F natural.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 116.5, 373.0, 54.0 ],
					"text" : "Always choose sharp accidentals (more precisely, in general: always choose a representation such that the displayed diatonic pitch is below the actual note)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 88.0, 333.0, 25.0 ],
					"text" : "Let bach choose the accidental to be displayed freely"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 328.5, 162.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 175.5, 57.0, 21.0 ],
					"text" : "Flats"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 133.0, 63.0, 21.0 ],
					"text" : "Sharps"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 89.0, 68.0, 21.0 ],
					"text" : "Automatic"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 89.0, 18.0, 178.0 ],
					"size" : 4,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 283.5, 95.0, 19.0 ],
					"text" : "tonedivision $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 316.0, 360.0, 275.0, 109.666672 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 360.0, 303.0, 109.666672 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tonedivision" : 8,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: tonedivision, key+signature",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: accidental, preference, sharp, flat, accidentalpreferences, above, below",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "When you insert a note, bach shows it with a default representation: i.e. it chooses a default diatonic note (say: F) and a default accidental (say: sharp), depending on the key signature (see #key+signature) and on some additional preferences, defined by the \"accidentalspreferences\" attribute:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
