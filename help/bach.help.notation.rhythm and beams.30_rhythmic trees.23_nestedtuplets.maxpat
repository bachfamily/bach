...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.0, 259.0, 212.0, 21.0 ],
					"presentation_rect" : [ 6.0, 248.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "...and here's the previous example:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 347.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 235.0, 494.0, 22.0 ],
					"presentation_rect" : [ 93.0, 277.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "[ [ [1/15 1/15 1/15 1/15 1/15] [1/15 1/15 1/15 1/15 1/15] [1/15 1/15 1/15 1/15 1/15] ] ], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 210.0, 510.0, 22.0 ],
					"presentation_rect" : [ 65.0, 263.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "[ [ [1/15 1/15 1/15] [1/15 1/15 1/15] [1/15 1/15 1/15] [1/15 1/15 1/15] [1/15 1/15 1/15] ] ], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 172.0, 602.0, 36.0 ],
					"presentation_rect" : [ 6.0, 188.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The same thing can be achieved via message: just put some additional levels of parenthesis to isolate the different tuplet levels. Mind the difference between these following two messages:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.0, 352.166656, 329.0, 21.0 ],
					"presentation_rect" : [ 4.0, 261.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Also see #maketreecompatiblewithts and #treehandling",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 311.166656, 335.0, 40.0 ],
					"presentation_rect" : [ 284.0, 281.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "You might probably need to turn this off in order for the rhythmic tree not to be reparsed."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 316.166656, 216.0, 22.0 ],
					"style" : "",
					"text_width" : 171.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 282.166656, 498.0, 22.0 ],
					"style" : "",
					"text" : "[ [ [ 1/3 [ 1/15 [ 1/105 1/105 1/105 1/105 1/105 1/105 1/105 ] -1/15 1/15 1/15 ] 1/3 ] ] ], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 68.0, 115.0, 40.0 ],
					"presentation_rect" : [ 408.0, 118.166656, 0.0, 0.0 ],
					"style" : "",
					"text" : "Try it on this note!"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 30.0, 375.166656, 406.0, 87.333336 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 118.333333 ],
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7850,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ -8.571429, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: interface+split, maketreecompatiblewithts, treehandling",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: rhythm, tree, rhythmic, tuplet, nested, nest, triplet, inside, within, layer, depth",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Nested tuplets can be produced via the interface thanks to iterative splitting (see #interface+split).\nSelect a note, split it into a tuplet, then select one of the split notes and split it again, and so on.\nHere's an example:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
