...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 116.0, 164.0, 50.0 ],
					"text" : "approx (pitch, tonedivision)\renharm\rmakepitchsc (steps, cents)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 116.0, 47.0, 36.0 ],
					"text" : "octave\rpitch",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 116.0, 49.0, 123.0 ],
					"text" : "alter\rcents\rcos\rcosh\rdegree\rden\rexp\rexp2",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The following pitch-related functions are implemented in bell.\nThe argument names are always x, y, z unless otherwise specified.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Pitch functions reference",
					"varname" : "title"
				}
