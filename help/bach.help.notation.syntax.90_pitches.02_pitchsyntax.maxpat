...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.333313, 247.333344, 204.0, 55.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: syntax, note, name, pitch, notename, pitches, tone, sharp, flat, quarter, eighth, microtone, accidental",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "In its simplest form, a pitch can be input as\n<degree><optional:alteration><octave>\nwhere degree is a letter (A to G), octave is an octave number (C5 being middle C), and the optional alteration is a combination of the following characters:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
