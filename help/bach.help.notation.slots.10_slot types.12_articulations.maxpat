...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 141.0, 296.0, 54.0 ],
					"style" : "",
					"text" : "All available articulations are shown in the slot window. By hovering with the mouse on them, their short name is shown in the slot legend."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -232.0, 236.0, 144.0, 22.0 ],
					"style" : "",
					"text" : "select all, openslotwin 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -232.0, 207.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 118.0, 427.0, 155.833328 ],
					"pitcheditrange" : [ "null" ],
					"slotwinzoom" : 150.0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 285.0, 585.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Articulations slot can be displayed into actual articulation via slot linkage techniques.\nSee #articulations, #articulation+edit and #articulations+slot+linkage.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 582.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Slots of type \"articulation\" contain information about one or more articulations associated with the note (or none, if the slot is empty). The articulation is stored as a sequence of symbols (tags) each related to a given standard or custom articulation (see #articulation+list for a list of standard articulations).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, slotinfo, type, articulation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
