...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 349.0, 453.0, 105.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 70.0, 590.0, 108.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The basic editing operations are usually underlined by specific cursors, helping you to understand the editing actions for each notation item. Whenever you move the mouse on a notehead, a note cursor will pop up to underline the editing capabilities. This is also true for note tails, breakpoints, markers, and much more. \nTo preserve these mousehovering capabilities, you need to keep the \"mousehover\" attribute set to 1. (In general, you should almost never need to turn this off, except for very particular cases, where the mousehovering might become too cpu consuming - see #custom+spacing for an example).",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 186.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 40.0, 219.0, 453.0, 114.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7850,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, intro, introduction, hover, mousehover, cursor",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "All bach interface objects come with a wide palette of mouse-and-keyboard editing possibilities, which are documented in this section, as well as in each object's reference page, under (mouse) or (keyboard).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
