...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 182.0, 95.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.5, 569.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"sel\" and \"unsel\" messages always force the selection and the deselection of some content. This is not what happens when you draw a selection rectangle with the mouse (see #selection+rectangle): once you select some content, you can keep the shift key pressed and draw another selection rectangle touching part on the same content, which will result in being deselected. To mimic this behaviour, bach has the \"select\" message, which is an involutive selection: if you select twice the same element, it will result in being deselected.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 254.0, 221.0, 36.0 ],
					"text" : "Be careful: although tricky, the \"select all\" message is not involutive:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.5, 294.5, 82.0, 25.0 ],
					"text" : "involutive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.0, 297.5, 122.0, 19.0 ],
					"text" : "select nil nil nil nil 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 294.5, 106.0, 25.0 ],
					"text" : "not involutive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 297.5, 61.0, 19.0 ],
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 223.5, 215.0, 40.0 ],
					"text" : "...and the score timepoint syntax"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.0, 193.5, 214.0, 25.0 ],
					"text" : "\"select\" supports the nil syntax..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 196.5, 130.0, 19.0 ],
					"text" : "select nil 500 nil nil 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 146.0, 186.0, 19.0 ],
					"text" : "select 1300 2000 5900 8000 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 128.0, 315.0, 54.0 ],
					"text" : "The \"select\" syntax is exactly as the \"sel\" syntax. Send this message once, and then another time too see the involution at work!"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: sel, unsel, timepoint+syntax, select+voices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, selection, involutive, select",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 523.0, 146.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 549.0, 146.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 330.5, 297.5, 330.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 329.75, 297.5, 329.75 ],
					"source" : [ "obj-5", 0 ]
				}
