...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.0, 346.0, 40.0, 19.0 ],
					"text" : "undo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 328.5, 160.0, 40.0 ],
					"text" : "All message operation can be also undone."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 176.5, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 269.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.5, 190.0, 149.0, 25.0 ],
					"text" : "Turn off undo system"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 193.0, 106.0, 19.0 ],
					"text" : "maxundosteps 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 132.5, 396.0, 40.0 ],
					"text" : "No maximum number of output steps: this is an unlimited undo! (yet beware: this can take memory!)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 143.0, 113.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.5, 90.5, 281.0, 40.0 ],
					"text" : "Define a maximum number of output steps (50 is the default)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 289.0, 218.0, 40.0 ],
					"text" : "Also post undo/redo steps in the Max window"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 103.0, 289.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 101.0, 114.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 313.0, 102.0, 19.0 ],
					"text" : "verboseundo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 222.0, 180.0, 54.0 ],
					"text" : "You can also access undo and redo by sending the corresponding message"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 239.5, 38.0, 19.0 ],
					"text" : "redo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.5, 239.5, 40.0, 19.0 ],
					"text" : "undo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 360.0, 99.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 373.0, 526.0, 96.833336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					...
					"versionnumber" : 7400,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ -8.571428, 7.571429 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 195.0, 240.0, 79.0 ],
					"text" : "The undo system is by default allowed. Nevertheless, you have to consider that this requires heavy operations, and you should turn off the system if you need good performance in real-time."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Objects: bach.score, bach.roll, bach.slot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "objects"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, undo, redo, real-time",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "All bach notation editors are equipped with an undo/redo system. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 129.5, 345.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.0, 345.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
