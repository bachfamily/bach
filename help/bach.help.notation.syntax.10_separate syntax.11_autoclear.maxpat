...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 416.0, 602.0, 50.0 ],
					"presentation_rect" : [ 6.0, 414.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The autoclear mechanism works exactly in the same way for bach.roll and bach.score. Remember, for instance, to turn it off if you need to assign or re-assign parameters \"a posteriori\" (such as velocities, extras, slots...).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 331.5, 249.0, 69.0 ],
					"presentation_rect" : [ 55.0, 377.0, 0.0, 0.0 ],
					"text" : "You can always \"explicitly\" to clear the bach.roll or bach.score before rebuilding it (but it is not strictly necessary if \"autoclear\" is set to 1)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 356.5, 39.0, 19.0 ],
					"presentation_rect" : [ 221.0, 340.0, 0.0, 0.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.0, 135.0, 275.0, 98.0 ],
					"presentation_rect" : [ 403.0, 124.0, 0.0, 0.0 ],
					"text" : "With autoclear off, the existing content is kept, and bach.score assigns new cents to the first two notes of the first chord, and leaves untouched the rest of the chord (similarly for the second chord)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 203.0, 98.0, 21.0 ],
					"text" : "loadmess set 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 304.0, 201.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.0, 226.0, 83.0, 19.0 ],
					"presentation_rect" : [ 319.0, 164.0, 0.0, 0.0 ],
					"text" : "autoclear $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 239.0, 191.0, 19.0 ],
					"presentation_rect" : [ 421.0, 192.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 348.0, 268.0, 193.0, 106.0 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 363.0, 221.0, 0.0, 0.0 ],
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 130.0, 209.0, 55.0 ],
					"presentation_rect" : [ 51.0, 335.0, 0.0, 0.0 ],
					"text" : "With autoclear on, the bach.roll representation is built from scratch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 141.0, 99.0, 21.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 164.0, 83.0, 19.0 ],
					"text" : "autoclear $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 192.0, 174.0, 19.0 ],
					"text" : "[ [6000 6400] [6000] ], bang"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Separate parameters and autoclear",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: separate, syntax, parameter, build, rebuild, construct, from, scratch, change, modify, autoclear, auto, clear",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "When you assign separate parameters and then bang, bach.roll and bach.score rebuild their representation from scratch. This is because the \"autoclear\" attribute is, by default, set to 1. If you need to force the already existing chords and notes to fit with the parameters you gave him, set the \"autoclear attribute\" to 0. In this way, the notation objects change their content, instead of building new content from scratch.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
