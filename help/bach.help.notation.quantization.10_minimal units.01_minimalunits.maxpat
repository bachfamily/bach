...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 153.0, 267.333313, 114.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 68.0, 342.0, 40.0 ],
					"text" : "Changing the minimalunits attribute will change thus the accuracy of the quantization"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 320.625, 116.0, 94.0 ],
					"text" : "The more units you have, the more possibilities you get - but also the slower the algorithm is!",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 320.625, 99.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 227.333328, 182.0, 40.0 ],
					"text" : "You can introduce complex measureinfo as well"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 121.0, 113.0, 19.0 ],
					"text" : "minimalunits 1/32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 68.0, 170.0, 19.0 ],
					"text" : "minimalunits 1/16 1/24 1/20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.0, 121.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 283.0, 148.0, 300.0, 136.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 62.0, 320.625, 378.0, 146.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.0, 189.0, 145.0, 34.0 ],
					"text" : "[[[3 4] [1/4 60 0 1]] [[2 4] [90]]] [[[4 4] [95]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.0, 293.625, 461.0, 21.0 ],
					"text" : "bach.quantize @minimalunits 1/16 1/24 1/20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 94.0, 142.0, 19.0 ],
					"text" : "minimalunits 1/20 1/24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 148.0, 163.0, 19.0 ],
					"text" : "minimalunits 1/12 1/10 1/8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 514.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, minimal, units, minimalunits",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The minimal units are the rational elements whose multiples are the only allowed durations in the quantized rhythm. These are set via the \"minimalunits\" attribute",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
