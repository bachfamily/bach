...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 441.0, 216.0, 21.0 ],
					"style" : "",
					"text" : "bach.tree displays the form of the llll",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 355.0, 216.0, 21.0 ],
					"style" : "",
					"text" : "This reverses the first level of the llll",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 388.0, 230.0, 69.0 ],
					"style" : "",
					"text" : "However when bach will display something in the Max window, the parenthesis will be always detached from the content"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 96.0, 153.0, 23.0 ],
					"style" : "",
					"text" : "John Paul George Ringo"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: llll, parenthesis, message, bracket, symbol",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "A Lisp-like linked list, or an llll for short, is a data structure capable to deal with nested lists, i.e. a list able to contain a similar list as one of its element. Lisp-like linked lists extend the standard Max concept of list (as the one used in the zl family), with the possibility to add level of parenthesis.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
