...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.100006, 227.0, 432.0, 40.0 ],
					"style" : "",
					"text" : "Each one of such lllls are note-assigned in the hierarchical global content"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 168.0, 384.0, 54.0 ],
					"style" : "",
					"text" : "This is for instance a pitch breakpoint specification for a note: the separate syntax for breakpoints has such lllls in the hierarchy, instead of simple numbers, associated to each note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.100006, 185.5, 204.0, 23.0 ],
					"style" : "",
					"text" : "[[ 0. 0. 0. ] [0.5 500 0.5] [1. 0. 0.]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -198.0, 217.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 228.0, 102.0, 25.0 ],
					"style" : "",
					"text" : "bang to build"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 6.0, 230.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.600006, 299.5, 146.0, 23.0 ],
					"style" : "",
					"text" : "[[C4 D6] Bb4] [C3 Ab2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.100006, 268.5, 411.0, 67.0 ],
					"style" : "",
					"text" : "[breakpoints [[[[ 0. 0. 0. ] [0.5 500 0.5] [1. 0. 0.]] [[ 0. 0. 0. ] [0.5 -500 0.5] [1. 0. 0.]]] [[[ 0. 0. 0. ] [0.5 -200 0.1] [1. 0. 0.]]]] [[[[ 0. 0. 0. ] [0.5 500 0.5] [1. 0. 0.]]] [[[ 0. 0. 0. ] [0.5 -200 0.1] [1. 0. 0.]]]]] [slots [ [[[3 10 20 30] [4 0.4]] [[3 10 20 30] [4 0.1]]] [[]]] []]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 73.0, 615.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where each sublist is thus composed by a name (a symbol identifying the extra, such as \"breakpoints\" or \"slots\") and a global content, which is just an llll structured exactly according to the object's #hierarchy. This llll is no different than any other separate parameter llll (say: Cents), only instead of having a single element (number) for each note, an llll is given, specifying the content of the extra associated to each note (a level of parentheses is needed for each note). See #syntax+breakpoint, #syntax+slot, #syntax+graphic, #syntax+name to know how to define such content.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 52.0, 602.0, 21.0 ],
					"style" : "",
					"text" : "[<name> <GLOBAL_CONTENT>] [<name> <GLOBAL_CONTENT>]...",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: syntax+extra, syntax+breakpoint, syntax+slot, syntax+graphic, syntax+name, syntax+articulation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: separate, syntax, extra",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Extras are defined in the separate syntax via lllls sent through the Extras inlet, in the form",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
