...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.0, 141.5, 157.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, autorhythm, autobeam, rebeam, rhythm, transcribe, rhythm, retranscribe, auto, parse, reparse",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "You can rebeam or reparse the rhythm of the selection.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
