...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.5, 259.0, 252.0, 25.0 ],
					"style" : "",
					"text" : "Denominator can also be nonstandard!",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 262.0, 81.0, 23.0 ],
					"style" : "",
					"text" : "[5 12], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 289.0, 162.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 291.0, 237.0, 23.0 ],
					"style" : "",
					"text" : "[[[[3 2 3] 8]] [[[3 2 3] 12]] [[5 8]]], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.25, 225.0, 104.0, 23.0 ],
					"style" : "",
					"text" : "[[3 3 2] 8], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.25, 225.0, 104.0, 23.0 ],
					"style" : "",
					"text" : "[[2 3 3] 8], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 221.5, 206.0, 25.0 ],
					"style" : "",
					"text" : "Different decompositions of 8/8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 225.0, 104.0, 23.0 ],
					"style" : "",
					"text" : "[[3 2 3] 8], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 436.0, 527.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notice that the time signature cannot be a single rational, since a 4/4 time signature is not the same as a 8/8, or a 2/2.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 190.0, 274.5, 25.0 ],
					"style" : "",
					"text" : "Create a measure with a 5/4 time signature",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 193.0, 73.0, 23.0 ],
					"style" : "",
					"text" : "[5 4], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 172.0, 162.0, 40.0 ],
					"style" : "",
					"text" : "This represents (3+2+3)/8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 422.0, 151.0, 68.0, 23.0 ],
					"style" : "",
					"text" : "[[3 2 3] 8]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 151.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 151.0, 370.0, 21.0 ],
					"style" : "",
					"text" : "[[ts_num1 ts_num2 ts_num3 ...] ts_denominator]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 102.0, 317.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can define time signatures with uneven number of divisions by substituting the numerator with an llll of numerator summands:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 339.25, 90.0, 220.0, 40.0 ],
					"style" : "",
					"text" : "This represents a 5/4 time signature",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 69.0, 37.0, 23.0 ],
					"style" : "",
					"text" : "[5 4]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 69.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 69.0, 237.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 324.0, 583.0, 103.333336 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: syntax, measureinfo, time, signature, nonstandard, simple, compound, uneven, even",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The time signature is the first part of the #measureinfo. In its simplest form, it is just defined by a plain llll containing the time signature numerator and denominator",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 65.5, 249.5, 109.5, 249.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 180.75, 251.5, 109.5, 251.5 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 291.75, 251.5, 109.5, 251.5 ],
					"source" : [ "obj-22", 0 ]
				}
