...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.5, 391.0, 283.0, 55.0 ],
					"text" : "This syllables are actual data contained in a text slot! Try to open slot window of slot 7."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 256.0, 431.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Text slots can also be associated to lyrics data (see #slot+linkage+lyrics):",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 98.0, 220.0, 25.0 ],
					"text" : "A text slot just contains some text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 452.0, 534.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "To know more about editing possibilities and syntax, see #slot+text+edit, #slot+text+syntax.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "A text slot can simply contain any text.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: slot+text+edit, slot+text+syntax, slot+linkage+lyrics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: slot, slotinfo, type, text",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
