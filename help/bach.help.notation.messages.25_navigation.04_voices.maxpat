...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 122.0, 264.885803, 386.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "...which solves the previous problem, if one needs to select sequences of tied notes, instead of sequences of tied chords",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 237.885803, 212.0, 25.0 ],
					"style" : "",
					"text" : "Select notes instead of chords"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 237.885803, 246.0, 23.0 ],
					"style" : "",
					"text" : "goto time 5000 @tiemode all @type note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 80.385803, 266.0, 40.0 ],
					"style" : "",
					"text" : "Select chords active at 6s, and don't bother to select the chords tied to them"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 88.885803, 191.0, 23.0 ],
					"style" : "",
					"text" : "goto time 5000 @tiemode each"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 185.0, 476.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notice that if a chord is not EXACTLY the same, e.g. if it has more or less notes, it will not be selected, since it isn't completely tied to the other ones.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 142.885803, 176.0, 23.0 ],
					"style" : "",
					"text" : "goto time 5000 @tiemode all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 127.385803, 266.0, 54.0 ],
					"style" : "",
					"text" : "Select chords active at 6s, but also the sequence of the chords tied to them (default)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 318.0, 461.0, 150.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tie mode for go-to system",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, goto, go-to, go, to, navigate, navigation, tie, mode, tiemode, sequence, type, note, chord",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 548.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"tiemode\" message attribute determines what to do when a portion of a tied sequence is to be selected.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
