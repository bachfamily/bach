...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.5, 94.5, 302.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "More than one articulation can be selected at once",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: slot+articulations, slot+notehead",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Interface for articulations slots",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, slot, articulations",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
