...
, 			{
				"box" : 				{
					"code" : "$res = 100 ; $fun = GoodFunnel($res + $l1) ; $res $fun ",
...
,
					"text" : "bach.eval $res = 100 \\; $fun = GoodFunnel($res + $l1) \\; $res $fun @out m"
				}
...
, 			{
				"box" : 				{
					"code" : "$res = 100 ; $fun = BadFunnel($res + $l1) ; $res $fun ",
					"fontname" : "Menlo Regular",
					"fontsize" : 13.0,
					"id" : "obj-22",
					"linecount" : 3,
...
,
					"text" : "bach.eval $res = 100 \\; $fun = BadFunnel($res + $l1) \\; $res $fun @out m"
				}
