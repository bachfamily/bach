...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 243.0, 236.0, 40.0 ],
					"style" : "",
					"text" : "A third argument tells what happens if a chord have names too"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 251.5, 172.0, 23.0 ],
					"style" : "",
					"text" : "sel all, nametoslot 7 append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 606.0, 195.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When you set names in a slot, you might want to handle the case when chord have names too.\nThis is done via the second argument of the #nametoslot message.\n\nPolicies are: \n- \"ignore\" (chord names are ignored)\n- \"replace\" (chord names, if present, are always used instead of note names)\n- \"replacenull\" (as the previous one, but only if note has no names)\n- \"prepend\" (prepend chord names to note names)\n- \"append\" (append chord names to note names)\n- \"merge\" or \"mergeprepend\" (prepend only chord names which aren't also note names).\n- \"mergeappend\" (append only chord names which aren't also note names).\n\nThe \"merge\" policy is the default.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 318.0, 349.0, 263.0, 108.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 349.0, 296.0, 101.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70908,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: name, label, name+slot+convert",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Names to slots conversion policies",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: name, slot, to, convert, conversion, export, policy, chord, merge, replace, append, prepend, postpend, replacenull, mergeprepend, mergeappend",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
