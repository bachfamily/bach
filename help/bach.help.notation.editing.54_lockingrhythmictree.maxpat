...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 82.0, 589.0, 65.0 ],
					"text" : "To toggle off the automatic recalculation of the rhythmic tree, you need to lock the measure rhythmic tree. In this mode of work, all interface operations are interpreted literally, as far as rhythm is concerned. For instance, if you turn chords into rests, they will not be merged unless you perform an explicit merging.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 308.5, 176.0, 84.0 ],
					"text" : "Try to delete some notes, with or without the rhythmic tree lock, and see the difference!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 166.5, 208.0, 84.0 ],
					"text" : "When the rhythmic tree of a given measure is locked, the icon of a beam with a cross appears above the measure number"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.0, 215.0, 409.0, 200.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, lock, rhythmic, tree, rhythm",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 589.0, 50.0 ],
					"text" : "bach.score automatically interprets and rebuild the rhythmic tree at each interface operation (e.g. when you join or split chords, when you create a rest, or when you add a tie), depending on the performed operation. If this is very handy in most cases, it could be sometimes annoying. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
