...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 303.0, 306.0, 292.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 255.0, 483.0, 34.0 ],
					"text" : "tonedivision 8, enharmonictable \"n ^ + +^ # #^ #+ #+^ n ^ + +^ # #^ d v n ^ + v n ^ + +^ # #^ d v n ^ + +^ # #^ d v n ^ + +^ # #^ d v n ^ + v\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 382.0, 197.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "For quartertonal grid you'll have to specify 24 elements, one for each degree of the chromatic scale. Remember that + = 1/4 tone up and d = 1/4 tone down (or you can use - equivalently)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 90.0, 473.0, 19.0 ],
					"text" : "tonedivision 4, enharmonictable \"n + b d n db b d n + n + # d n + # d n + # d n +\""
				}
