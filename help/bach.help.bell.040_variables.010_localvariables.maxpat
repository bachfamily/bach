...
, 			{
				"box" : 				{
					...
					"text" : "See Also: return+value, bell+sequence",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 117.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 448.0, 36.0 ],
					"text" : "bach.eval implements variables, that is, named containers for data.\nThere are two basic kinds of variables: local and global. Let's start with local.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
