...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 222.0, 246.0, 25.0 ],
					"style" : "",
					"text" : "Add 2 measures to voices 2 through 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 181.0, 209.0, 25.0 ],
					"style" : "",
					"text" : "Add 2 measures to voice 1 only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 181.0, 133.0, 23.0 ],
					"style" : "",
					"text" : "appendmeasures 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 177.0, 146.0, 126.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 146.0, 138.0, 23.0 ],
					"style" : "",
					"text" : "appendmeasures all 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 594.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can send an \"appendmeasures\" messageto append several empty measure at the end of the score. The syntax for this case is: insertmeasure <voice_number> <number_of_measures_to_add>.\nThe <voice_number> can also be an llll of the type (<start_voice> <end_voice>), or the \"all\" symbol, to insert measures in all voices (default, in case such element is omitted).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.0, 107.0, 267.0, 25.0 ],
					"style" : "",
					"text" : "Append 5 empty measures (for all voices)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 107.0, 122.0, 23.0 ],
					"style" : "",
					"text" : "appendmeasures 5"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Appending several empty measures",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, addmeasures, add, measure, adding, append, appendmeasures, several, empty, blank, end, multiple",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
