...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 410.833344, 316.0, 40.0 ],
					"style" : "",
					"text" : "Trim/extend this notehead and see what happens\n(open slotinfo for slot 6 to know more)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 192.0, 353.0, 365.0, 107.833336 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 272.0, 606.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For a given slot, if you set the \"Follow Notehead\" attribute to 1 in the #slotinfo+inspector, the slot value will be increased/decreased automatically whenever the notehead is trimmed, by the same amount of milliseconds of notehead change. This is useful if your slot value is associated to a starting point in a sample, or to anything which should be attached to the chord onset. Trimming will also stop automatically whenever the slot reaches its minimum or maximum.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 19.0, 134.0, 352.0, 122.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70904,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Trimming or extending noteheads or tails",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: edit, editing, interface, change, onset, duration, shift, trim, tail, preserve, absolute, position, ms, breakpoint, temporal, slot, extend, extending, trimming, notehead, notetail, head, follownoteheadtrim, follow, notehead, trim, adapt",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default editing the duration of a note will respace all the #breakpoints and #temporal+slots according to the new duration. If you wish to preserve all the absolute positions of breakpoints and temporal slots, you probably want to trim or extend the notehead or note tail.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
