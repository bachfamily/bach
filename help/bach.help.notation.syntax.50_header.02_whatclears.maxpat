...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.450012, 241.0, 554.0, 40.0 ],
					"text" : "Not only do these change header elements, but they also change the entire content (body)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.125, 220.0, 536.325012, 21.0 ],
					"presentation_rect" : [ 69.0, 252.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you also introduce some body, the entire musical content will be rebuilt from scratch:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.450012, 175.0, 348.0, 40.0 ],
					"presentation_rect" : [ 318.450012, 206.0, 0.0, 0.0 ],
					"text" : "This will just change the first slotinfo, but will try to keep the existing data (when slot types are compatible)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 259.850006, 337.0, 213.0, 137.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 124.5, 225.450012, 54.0 ],
					"text" : "These will change clefs, midichannels or markers, but keep the existing musical content"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "ttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 337.0, 248.0, 136.666672 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 136.666672 ],
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")", "(", ")" ],
...
, 			{
				"box" : 				{
					...
					"text" : "Body and header assignment",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: gathered, syntax, header, body, assign, input",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 602.450012, 108.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The header must be sent as a part of the notation object complete gathered syntax. As explained in #gathered+syntax+whole, this includes an optional starting router (a \"roll\" or \"score\" symbol, handy to know what the content represents, but not necessary at input) and then the #body of the object, containing the real musical data. When you send such gathered syntax llll through the first inlet of the notation object, what you get depends on what components you have introduced.\nIf you only introduce header elements, the object will just change the required individual header components, leaving the musical content untouched:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 129.5, 164.0, 14.0, 164.0, 14.0, 332.0, 269.350006, 332.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 129.5, 166.5, 15.5, 166.5 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 28.950012, 328.5, 269.350006, 328.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 28.950012, 330.5, 489.950012, 330.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 331.0, 269.350006, 331.0 ],
					"source" : [ "obj-7", 0 ]
				}
