...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 261.5, 102.0, 23.0 ],
					"text" : "6000 6900 7600"
				}
...
, 			{
				"box" : 				{
					"code" : "diff($x1, $x2, ($a, $b -> $a % 1200 == $b % 1200)) ",
					"id" : "obj-16",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
...
,
					"text" : "bach.eval diff($x1\\, $x2\\, ($a\\, $b -> $a % 1200 == $b % 1200)) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.0, 82.5, 102.0, 23.0 ],
					"text" : "6000 6900 7600"
				}
...
,
					"text" : "bach.eval diff($x1\\, $x2) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: intersection, union, symdiff, lambda",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, built, in, function, diff, set, difference",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
