...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 351.0, 264.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"autosize\" attribute also affects the behavior of the #addchords and #addmeasure message, but only when you ask for more voices than the existing ones.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 162.0, 91.0, 20.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 369.0, 235.0, 239.0, 40.0 ],
					"text" : "The bach.score we are constructing via separate syntax has only 1 voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 345.0, 245.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 308.0, 207.0, 19.0 ],
					"text" : "((1/4 2/4 1/8 1/8) (2/4 1/4 1/8 1/8))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 280.0, 165.0, 19.0 ],
					"text" : "((C4 E G E) (C4 Eb G Eb))"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 145.0, 376.0, 40.0 ],
					"text" : "This bach.roll's gathered syntax has 2 voices: if autosize is active, the number of voices will be automatically updated"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.5, 186.0, 483.0, 34.0 ],
					"text" : "roll ( ( 90. ( 6000. 140. 100 ) ) ( 230. ( 6700. 180. 100 ) ) ( 410. ( 7200. 390. 100 ) ) ) ( ( 90. ( 6000. 140. 100 ) ) ( 230. ( 6700. 180. 100 ) ) ( 410. ( 7200. 390. 100 ) ) )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 562.0, 51.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When constructing bach.roll or bach.score via separate or gathered syntax (see #syntax+intro),\nthe objects will by default adapt to the introduced number of voices. You can avoid this behavior by setting the \"autosize\" attribute to 0.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 296.0, 339.0, 283.0, 124.833336 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 97.0, 295.0, 40.0 ],
					"text" : "Toggles the ability to adapt the number of voices to the content of incoming lllls"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 17.0, 107.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.0, 239.0, 268.0, 101.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7400,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 131.0, 77.0, 19.0 ],
					"text" : "autosize $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: numvoices, syntax+intro, separate+syntax, gathered+syntax, addchords",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 304.0, 23.0 ],
					"text" : "Automatically adapting number of voices",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: voice, change, adapt, number, size, auto, autosize",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
