...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 106.0, 29.5, 23.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 178.0, 98.0, 23.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					"code" : "makepitch($x1, $x2, $x3) ",
					"id" : "obj-8",
					"maxclass" : "newobj",
					"numinlets" : 3,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 144.0, 262.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80900
					}
,
					"text" : "bach.eval makepitch($x1\\, $x2\\, $x3) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "makepitch() function reference",
					"varname" : "title"
				}
