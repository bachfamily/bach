...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 96.0, 29.5, 23.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 96.0, 29.5, 23.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.333333333333329, 96.0, 29.5, 23.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 96.0, 29.5, 23.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					"code" : "makepitchji($x1, $x2, $x3, $x4) ",
					"id" : "obj-7",
					"maxclass" : "newobj",
					"numinlets" : 4,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 136.0, 296.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80900
					}
,
					"text" : "bach.eval makepitchji($x1\\, $x2\\, $x3\\, $x4) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 129.5, 156.0, 79.0 ],
					"text" : "Arguments:\njiwhitekey (default: null)\nsharps (default: null)\noctave (default: null)\nratio (default: null)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 39.0, 338.0, 21.0 ],
					"text" : "The makepitchji() function returns an just intonation pitch.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 244.0, 23.0 ],
					"text" : "makepitchji() function reference",
					"varname" : "title"
				}
