...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.38092, 167.0, 327.61908, 65.0 ],
					"text" : "Answer is in the form: vzoom <vzoom_value>\nwhere <vzoom_value> is a percentage. \nEven if the vzoom attribute is set to auto, this message retrieves the actually used vertical zoom.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.380936, 91.0, 492.0, 36.0 ],
					"text" : "Answer is in the form: zoom <zoom_value>\nwhere <zoom_value> is a percentage (100% being the default)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 269.0, 142.0, 178.0, 25.0 ],
					"text" : "Retrieve the vertical zoom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 142.0, 67.0, 19.0 ],
					"text" : "getvzoom"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.5, 439.0, 138.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.380936, 439.0, 127.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 357.5, 407.5, 245.0, 21.0 ],
					"text" : "bach.keys zoom vzoom @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 13.380936, 407.5, 245.0, 21.0 ],
					"text" : "bach.keys zoom vzoom @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 256.0, 313.0, 139.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.380936, 66.0, 193.0, 25.0 ],
					"text" : "Retrieve the horizontal zoom"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 256.0, 280.0, 139.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.380936, 69.0, 60.0, 19.0 ],
					"text" : "getzoom"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: query, queries, zoom, vzoom, getzoom, getvzoom",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The horizontal and vertical zoom can be retrieved by the messages \"getzoom\" and \"getvzoom\"",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
