...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 177.5, 124.0, 25.0 ],
					"presentation_rect" : [ 186.0, 156.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 177.5, 105.0, 23.0 ],
					"presentation_rect" : [ 64.0, 162.5, 0.0, 0.0 ],
					"style" : "",
					"text" : "sel all, role none"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 355.0, 389.0, 21.0 ],
					"presentation_rect" : [ 7.0, 324.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "See #marker+role to know more about marker roles and contents.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 117.0, 208.0, 54.0 ],
					"presentation_rect" : [ 321.0, 101.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Set role for marker 1 to timesignature, and assign also the corresponding content"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 81.0, 203.0, 25.0 ],
					"style" : "",
					"text" : "Set role for marker 1 to barline"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 81.0, 240.0, 23.0 ],
					"style" : "",
					"text" : "sel marker 1, role barline, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 227.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can change a marker role, when it's selected, via the \"role\" message.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: marker+role, marker+content",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, change, marker, role, content, value",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
