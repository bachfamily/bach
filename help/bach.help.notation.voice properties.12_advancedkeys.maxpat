...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 413.0, 161.0, 36.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 161.0, 142.0, 222.0, 36.0 ],
					"style" : "",
					"text" : "The allowed ascii characters for accidentals are the following ones:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 142.0, 177.0, 123.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.5, 211.0, 140.0, 25.0 ],
					"style" : "",
					"text" : "reset all to C Major "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.5, 212.0, 62.0, 23.0 ],
					"style" : "",
					"text" : "keys CM"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 111.0, 311.0, 25.0 ],
					"style" : "",
					"text" : "You can use even more exotic key signatures."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 79.5, 311.0, 25.0 ],
					"style" : "",
					"text" : "Define C# and Gb, and all other steps are natural"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 114.0, 216.0, 23.0 ],
					"style" : "",
					"text" : "tonedivision 4, keys \"x db # d q n q\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 82.5, 123.0, 23.0 ],
					"style" : "",
					"text" : "keys \"# n n n b n n\""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 303.0, 355.0, 146.0 ],
					"pitcheditrange" : [ "null" ],
					"showstems" : 0,
					"stafflines" : [ 5, 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: quartertone, ascii, inspector",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Defining custom key signatures",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: voice, key, signature, custom, advanced, microtone, ascii, accidental",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "You can also define custom key signatures: just give the list of the 7 accidentals you want to use, one for each diatonic step (from C to B). Use \"n\" for naturals.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
