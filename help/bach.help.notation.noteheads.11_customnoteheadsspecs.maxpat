...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 218.0, 612.0, 108.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 137.0, 547.0, 65.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 612.0, 152.0 ],
					"showhand" : 0,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: notehead, define, custom, specification, syntax, spec, white, black, note, head, fullname, shortname, alias, font, basept, char, xshift, yshift, width, shift, xshiftsmall, yshiftsmall, small, distartxshift, offset",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
