...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 215.564010999999994, 208.0, 25.0 ],
					"presentation_linecount" : 2,
					"text" : "Select chords in measures >= 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.0, 260.837372000000016, 135.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 260.837372000000016, 125.0, 23.0 ],
					"text" : "select chord if grace"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 336.0, 129.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 215.564010999999994, 148.0, 23.0 ],
					"text" : "sel note if measure >= 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 166.667816000000016, 177.0, 25.0 ],
					"text" : "Select chords with 3 notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.5, 167.667816000000016, 179.0, 23.0 ],
					"presentation_linecount" : 2,
					"text" : "select chord if numnotes == 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 173.0, 99.38580300000001, 274.0, 54.0 ],
					"text" : "Select all chords whose duration is < 400ms (for bach.roll, this is the maximum duration of its notes)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 114.88580300000001, 158.0, 23.0 ],
					"text" : "sel chord if duration < 400"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 8.0, 314.0, 439.0, 70.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Conditional selection for chords",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, selection, conditional, select, sel, unsel, chord, if, onset, duration, grace, numnotes, measures",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
