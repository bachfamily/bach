...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.25, 286.0, 242.0, 25.0 ],
					"style" : "",
					"text" : "Select everything in the second voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.5, 289.0, 104.0, 23.0 ],
					"style" : "",
					"text" : "sel nil nil nil nil 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.5, 306.5, 226.5, 40.0 ],
					"style" : "",
					"text" : "Select anything between 0ms and 2000ms, below 6400mc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 242.5, 513.0, 21.0 ],
					"style" : "",
					"text" : "You can leave as nil the first or second element of each couple, to avoid putting a limit:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.5, 314.0, 130.0, 23.0 ],
					"style" : "",
					"text" : "sel 0 2000 nil 6400 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.75, 264.0, 357.5, 25.0 ],
					"style" : "",
					"text" : "Select everything in the first voice, from 1600ms onwards"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 267.0, 120.0, 23.0 ],
					"style" : "",
					"text" : "sel 1600 nil nil nil 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 314.0, 91.0, 23.0 ],
					"style" : "",
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.0, 199.5, 344.0, 40.0 ],
					"style" : "",
					"text" : "Perform only pitch selection: any note of the 2nd voice between 5000mc and 5800mc will be selected"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 210.0, 136.0, 23.0 ],
					"style" : "",
					"text" : "sel nil nil 5000 5800 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 125.0, 509.0, 36.0 ],
					"style" : "",
					"text" : "If you want to perform only temporal or only pitch selection, put a \"nil\" for the arguments you don't want to use:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 156.5, 369.0, 40.0 ],
					"style" : "",
					"text" : "Perform only temporal selection: any chord of any voice having onset between 1300ms and 2000ms will be selected"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 167.0, 138.0, 23.0 ],
					"style" : "",
					"text" : "sel 1300 2000 nil nil ()"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 67.0, 382.0, 40.0 ],
					"style" : "",
					"text" : "Select all the elements between 1300ms and 2000ms, whose pitch is between 5900mc and 8000 mc, in the first voice"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 108.0, 509.0, 21.0 ],
					"style" : "",
					"text" : "Arguments are: <start_ms>, <end_ms>, <start_cents>, <end_cents>, <voice_number>",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 77.5, 168.0, 23.0 ],
					"style" : "",
					"text" : "sel 1300 2000 5900 8000 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 288.0, 350.0, 292.0, 121.333336 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: select, unsel, sel+voices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, sel, content, region",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "The \"sel\" message selects all the content inside a \"rectangle\" given by a time range, and a pitch range, for a given voice. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 111.5, 341.5, 297.5, 341.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 84.5, 341.5, 297.5, 341.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 342.25, 297.5, 342.25 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 45.5, 342.5, 297.5, 342.5 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 97.0, 341.5, 297.5, 341.5 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 68.5, 341.0, 297.5, 341.0 ],
					"source" : [ "obj-8", 0 ]
				}
