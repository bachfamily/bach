...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.25, 263.5, 316.0, 36.0 ],
					"text" : "they're ultimately the same as integers if you multiply \nthem by the gcd of the denominators",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 262.0, 236.5, 231.0, 25.0 ],
					"text" : "If you want, use rational proportions"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 236.5, 157.0, 23.0 ],
					"text" : "split @proportions 1/7 2/9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.75, 180.0, 92.0, 21.0 ],
					"text" : "is the same as",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.75, 180.0, 42.0, 23.0 ],
					"text" : "split 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.75, 179.0, 135.0, 23.0 ],
					"text" : "split @proportions 4 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 74.0, 179.0, 135.0, 23.0 ],
					"text" : "split @proportions 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.5, 122.0, 245.5, 40.0 ],
					"text" : "Same, into 3 chords with proportions 1:3:7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 130.5, 146.0, 23.0 ],
					"text" : "split @proportions 1 3 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.5, 74.0, 245.5, 40.0 ],
					"text" : "Split each selected chord(s) into two  smaller chords, in proportion 2:5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 82.5, 135.0, 23.0 ],
					"text" : "split @proportions 2 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -328.0, 113.0, 163.0, 22.0 ],
					"text" : "loadmess sel [1] [1 1/8] nil nil"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 6.0, 340.0, 473.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Uneven splitting of chords using proportions",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, split, splitting, divide, proportion, subdivide, tuplet",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The \"split\" message in bach.score also accepts a set of proportions",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
