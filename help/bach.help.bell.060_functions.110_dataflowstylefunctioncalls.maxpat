...
,
					"text" : "bach.eval L = 1 2 3 4 5 6 7 8 @auto 1"
				}

			}
, 			{
				"box" : 				{
					"code" : "left(flat(rot($l1, 4)), -2) ",
					"fontname" : "Menlo Regular",
					"fontsize" : 13.0,
					"id" : "obj-26",
					"maxclass" : "newobj",
...
,
					"text" : "bach.eval left(flat(rot($l1\\, 4))\\, -2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 122.0, 98.0, 23.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 48.0, 65.0, 23.0 ],
					"text" : "q w e r t y"
				}
...
,
					"text" : "bach.eval $l1.length() @out m"
				}
...
,
					"text" : "bach.eval $l1.rot(4).flat().left(-2) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 48.0, 65.0, 23.0 ],
					"text" : "q w e r t y"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: global+variable, assigning+operator",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Dataflow-style function calls",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, function, call, calling, dataflow, style, first, argument, passing, assigning",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
