...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 328.833344, 312.0, 40.0 ],
					"style" : "",
					"text" : "Reset the articulation info completely, i.e. revert to only having the standard set of articulations"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 337.333344, 123.0, 23.0 ],
					"style" : "",
					"text" : "resetarticulationinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 303.0, 175.0, 25.0 ],
					"style" : "",
					"text" : "We assign \"cap\" to all G's"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 147.0, 558.0, 98.0 ],
					"style" : "",
					"text" : "By clicking on this, we are defining a custom articulation named \"cap\", having as base font \"Arial, 12\", and having a \"^\" character as main character (above note), and a \"v\" character for flipped character (below note). Notice that we also choose carefully its positioning (noteside), and a few tailoring parameters to define its center.\nNotice that we are forcing this \"cap\" articulation to lie outside the staff, and to be copiable."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 594.0, 108.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The existing palette of articulations can be customized by adding some personally tailored articulations. These custom articulations are then saved and stored as part of the #header syntax of the notation object, namely the #articulationinfo part.\nIn order to define an articulation, we need to set its names, its unicode characters (for main position and flipped position), its positioning properties, and all its graphical parameters. This is all included in the #articulationinfo header specification, as a sequence of (<key> <value>) pairs.\nLet us start with an example of an articulation definition:",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Defining custom articulations",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: articulation, define, custom, assign, introduce, slot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
