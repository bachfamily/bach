...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 67.5, 59.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.0, 156.0, 195.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.0, 141.5, 329.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 557.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Here are other basic parameter names (and expected contents) that can be set via the slotinfo (also see #slotinfo+example):",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Basic slotinfo parameters (2)",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: header, syntax, slotinfo, parameter, slot, width, height, snap, ysnap, zsnap",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
