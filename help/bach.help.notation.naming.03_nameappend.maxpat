...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 109.5, 124.0, 23.0 ],
					"style" : "",
					"text" : "nameappend Ringo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 75.0, 118.0, 23.0 ],
					"style" : "",
					"text" : "nameappend John"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 485.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can add names preserving the existing ones via the \"nameappend\" message.\nThis works essentially as the #name+message, without the #incremental feature.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
