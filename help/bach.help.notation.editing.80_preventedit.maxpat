...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.0, 314.0, 195.0, 25.0 ],
					"text" : "Inspector won't ever show up"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.5, 314.0, 131.0, 19.0 ],
					"text" : "preventedit inspector"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 495.0, 295.0, 93.0, 36.0 ],
					"text" : "also working for bach.slot",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 68.0, 598.0, 36.0 ],
					"text" : "The \"preventedit\" message expects a list where each element is either a notation items names (like \"notes\" or \"markers\") or a llll containing the notation items name and the operations to be prevented.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 165.0, 408.0, 25.0 ],
					"text" : "The two above, combined: no modifications for notes and markers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 166.0, 155.0, 19.0 ],
					"text" : "preventedit note markers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 138.0, 329.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 141.0, 126.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 111.0, 419.0, 25.0 ],
					"text" : "Users will be able to modify everything but notes (and thus chords)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 113.0, 111.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 339.5, 323.0, 25.0 ],
					"text" : "This will render all elements editable anew (default)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 339.5, 75.0, 19.0 ],
					"text" : "preventedit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 289.0, 306.0, 25.0 ],
					"text" : "Force the slot information to remain untouchable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 289.0, 120.0, 19.0 ],
					"text" : "preventedit slotinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 242.5, 317.0, 40.0 ],
					"text" : "Force the notes onset to remain exactly the same, and also notes cannot be deleted or created"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 190.0, 400.0, 54.0 ],
					"text" : "Force the notes onset to remain exactly the same. Nothing prevents, on the other hand, the durations or pitches to change. Also notes can be deleted or created!"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: prevent+complete",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Prevent editing for single elements",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, prevent, deny, ignore, preventedit",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 563.0, 36.0 ],
					"text" : "You can prevent single notation elements from being edited by using the \"preventedit\" attribute.\nWhen user tries to change such items, the interface operation is simply ignored or denied.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
