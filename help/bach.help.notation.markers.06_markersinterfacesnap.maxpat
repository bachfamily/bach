...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Snapping markers magnetically",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, marker, interface, shift, offset, snap, drag, snapping, chord, note, tail, magnetic, magnetically",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
