...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 275.0, 329.0, 327.0, 69.0 ],
					"text" : "This syntax is simply wrong: if you put a negative sign, it means that you need to define a rest, so bach ignores the following notes."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.0, 398.0, 367.0, 23.0 ],
					"text" : "addmeasures [[[[4 4] [60]] [-1/2 [E4 100 0] [G4 100 0]] [1/2]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 244.5, 232.0, 55.0 ],
					"text" : "A chord with a positive duration and no notes is still interpreted as a rest"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 301.5, 363.0, 23.0 ],
					"text" : "addmeasures [[[[4 4] [60]] [1/2 [E4 100 0] [G4 100 0]] [1/2]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 215.5, 315.0, 40.0 ],
					"text" : "The first chord is a rest, since its duration is negative"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 145.0, 605.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Yet it is always a good rule to put a negative sign to all durations corresponding to rests (even if in the gathered syntax this would be unneeded for a complete understanding of the score). Indeed, when bach outputs the chord content in gathered syntax, it follows this convention, and always puts a negative sign in front of any rest duration.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.399993999999992, 124.0, 22.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "or",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.0, 124.0, 159.0, 21.0 ],
					"text" : "[<duration> <flag>]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 420.5, 238.0, 54.0 ],
					"text" : "When you dump the content, bach always follows the convention of putting negative durations to rests"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.0, 438.0, 75.0, 23.0 ],
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 257.5, 367.0, 23.0 ],
					"text" : "addmeasures [[[[4 4] [60]] [-1/2] [1/2 [E4 100 0] [G4 100 0]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.0, 124.0, 104.0, 21.0 ],
					"text" : "[<duration>]"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax, syntax+flag, gathered+syntax+note, duration",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 307.0, 23.0 ],
					"text" : "Gathered syntax for rests in bach.score",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: gathered, syntax, chord, score, rest",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 605.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "A rest is nothing but a chord having no notes. By convention, rests are given negative symbolic durations. This is essential while dealing with #separate+syntax: if you only introduce durations, changing the sign of a duration is the simplest way you have to tell bach that it has to be a rest.\nNevertheless, this is not so essential while using the gathered syntax. Indeed, bach is completely able to understand that if you simply introduce a chord in gathered syntax with no notes, you want this to be a rest. The syntax is thus, quite simply",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 593.0, 308.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 591.0, 224.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 340.0, 215.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 454.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
