...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 48.5, 122.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 122.0, 421.0, 54.0 ],
					"text" : "The \"showdurations\" attribute must be also set to 1. This is by default the case in bach.roll, but not in bach.score, so if you use glissandi in bach.score, remember to set it manually."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.5, 150.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -77.0, 78.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 321.833344, 377.0, 55.0 ],
					"text" : "Otherwise, if you don't use glissandi, consider just turning the \"allowglissandi\" attribute off (no more Shift key issues!)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 116.0, 74.0, 326.0, 40.0 ],
					"text" : "The \"allowglissandi\" attribute must be set to 1 if you want to display glissandi (it is such by default)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 355.0, 215.0, 101.0 ],
					"pitcheditrange" : "null",
					"showdurations" : 1,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 101.0, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 67.0, 211.0, 234.0, 111.833336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: breakpoint+syntax",
...
, 			{
				"box" : 				{
					...
					"text" : "Adding and deleting pitch breakpoints",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: add, pitch, breakpoint, note, tail, allowglissandi, showdurations, glissando, glissandi, show, duration, allow",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Pitch breakpoints are handy to represent glissandi. You can add them via the interface in the following way (valid both for bach.roll and for bach.score).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 485.0, 261.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 177.0, 186.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
