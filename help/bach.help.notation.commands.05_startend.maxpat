...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 432.0, 66.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 399.0, 77.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 343.0, 362.0, 211.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
					"text" : "bach.playkeys [mycmd done cents]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.0, 147.0, 180.0, 55.0 ],
					"text" : "Here's a quick way to collect all cents of incoming notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 208.0, 376.0, 23.0 ],
					"text" : "[commands [1 [key k] [note mycmd] [name mycmd] [end done]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 142.5, 298.0, 66.0, 23.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80103
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 581.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "We can signal the beginning and end of a command dump by setting up three additional fields in the commands structure: \n• a command name (this may or may not coincide with the router you set for notes/chords/etc.)\n• a start symbol (output after the command name before selection output begins from the playout)\n• an end symbol (output after the command name once the selection output has ended)",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 227.0, 249.0, 230.0, 100.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 120.0, 592.0, 23.0 ],
					"text" : "[commands [1 [key k] [note mynotecmd] [chord mychordcmd] [name mycmd] [start begin] [end done]]]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 159.0, 213.0, 121.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80103,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 310.0, 23.0 ],
					"text" : "Notifying start and end of command dump",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: command, note, start, end, notify, begin, stop, signal, marker, symbol, dump, initial",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
