...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 205.0, 159.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "helpstarter.js",
						"parameter_enable" : 0
					}
,
					"text" : "js helpstarter.js bach.pc2mc"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 403.0, 251.5, 99.0, 21.0 ],
									"text" : "loadmess 6000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 439.0, 267.5, 288.0, 69.0 ],
									"presentation_rect" : [ 374.0, 202.5, 0.0, 0.0 ],
									"text" : "Right inlet, or second argument, sets the midicents of the base note, i.e. the midicents of the note which will correspond to the 0 pitch-class. Default is 6000 (middle C)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 376.0, 302.5, 53.0, 21.0 ],
									"presentation_rect" : [ 374.0, 264.5, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 14.0, 376.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 345.5, 82.0, 21.0 ],
									"text" : "bach.wrap 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 193.5, 44.0, 19.0 ],
									"text" : "dump"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 14.0, 402.0, 160.0, 86.0 ],
									"pitcheditrange" : "null",
									"showdurations" : 0,
									"stafflines" : 5,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 315.5, 81.0, 21.0 ],
									"text" : "bach.pc2mc"
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nn",
									"outlettype" : [ "", "", "int", "bang" ],
									"patching_rect" : [ 41.0, 215.5, 101.0, 93.0 ],
									"points" : [ 0, 3, 5, 8 ],
									"selectedpointinnercolor" : [ 0.831373, 0.0, 0.0, 1.0 ],
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"id" : "obj-7",
									"ignoreclick" : 1,
									"jsarguments" : [ "bach.pc2mc", 20 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 398.0, 351.0, 187.0, 60.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 300.0, 215.0, 255.0, 55.0 ],
									"text" : "The modulo is set in the middle inlet, or as first argument. Default is 12 (semitones)."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 214.0, 137.5, 158.0, 40.0 ],
									"text" : "...and with complex ones"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 123.0, 174.0, 69.0 ],
									"text" : "It works both with plain lists of pitch-classes (click on the points of bach.circle)..."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 437.5, 269.0, 34.0 ],
									"text" : "( ( 6000. 6200. 6400. ) ( 6700. 6900. 7100. ) ) ( 6300. 6100. )"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 232.0, 85.0, 21.0 ],
									"text" : "loadmess 12"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 300.0, 270.5, 53.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 368.5, 171.0, 21.0 ],
									"text" : "bach.pc2mc 12 6000 @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 184.5, 128.0, 18.0 ],
									"text" : "((0 2 4) (7 9 11)) (3 1)"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "bach.pc2mc", 80 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 616.0, 115.0 ]
								}
