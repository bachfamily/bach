...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 339.0, 195.0, 251.0, 83.0 ],
...
, 			{
				"box" : 				{
					"attr" : "linearedittimestep",
					"id" : "obj-6",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 182.0, 184.0, 22.0 ],
					"style" : "",
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 135.0, 203.0, 40.0 ],
...
, 			{
				"box" : 				{
					"attr" : "linearedittimemultipliers",
					"id" : "obj-8",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 144.0, 321.0, 22.0 ],
					"style" : "",
					"text_width" : 148.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 600.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "All the following commands are available in linear editing mode (see #linear+edit+intro to know more).\nYou can modify any note pitch by putting the linear editing cursor on its chord (to know how, see #linear+edit+time+cursor) until it turns yellowish (it becomes active for editing), and then pressing the desired letter key (A through G). \nYou can modify any chord duration by putting the editing cursor on the chord, and then pressing the desired numeric key (see #linearedittimemultipliers).",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: linear+edit+intro, linear+edit+time+cursor",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Linear editing: modifications in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 637.0, 31.0 ],
					"style" : "",
					"text" : "Tags: editing, edit, interface, linear, speedy, fast, left, linearedit, linearedittimemultipliers, linearedittimestep, time, multiplier, duration, cursor, modify, note, pitch, chord, step, multiplicative, fine, tune, adjust",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 264.0, 243.0, 84.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 387.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
