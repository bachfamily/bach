...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 319.142852783203125, 269.0, 36.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"text" : "Lifecycle of local variables",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Local variables are always reset at every evaluation of the code.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
