...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 194.0, 228.0, 25.0 ],
					"style" : "",
					"text" : "Insert some pitches and MIDIcents"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 159.0, 356.0, 23.0 ],
					"style" : "",
					"text_width" : 165.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 135.0, 356.0, 23.0 ],
					"style" : "",
					"text_width" : 165.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 111.0, 356.0, 23.0 ],
					"style" : "",
					"text_width" : 165.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 429.0, 123.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.5, 429.0, 126.0, 23.0 ],
					"style" : "",
					"text" : "bach.print Separate"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 26.0, 325.0, 289.0, 90.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: gathered+syntax, separate+syntax, playoutèsyntax",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 596.0, 43.0 ],
					"style" : "",
					"text" : "Tags: accidental, user, defined, userdefined, user-defined, graphic, enharmonic, enharmonicity, note, names, notenames, output, pitch, pitches, outputpitchesgathered, outputpitchesseparate, outputpitchesplayout, gathered, separate, playout",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 585.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "By default, pitches are only output in #gathered+syntax, and only for notes having user-defined enharmonicity (i.e. only when pitches were inserted); both #separate+syntax and #playout+syntax only output MIDIcents by default.\nThis can be changed via the following attributes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.5, 194.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
