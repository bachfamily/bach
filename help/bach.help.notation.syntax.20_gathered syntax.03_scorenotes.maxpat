...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.400002, 269.5, 198.0, 54.0 ],
					"style" : "",
					"text" : "When we dump the content, the note also has a fourth element (0), which is the flag"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 287.0, 75.0, 23.0 ],
					"style" : "",
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.399994, 282.0, 108.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.399994, 227.5, 225.0, 69.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.399994, 303.0, 291.0, 23.0 ],
					"style" : "",
					"text" : "addmeasures [[[[4 4] [60]] [4/4 [6000 100 0 4]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 174.0, 310.0, 69.0 ],
					"style" : "",
					"text" : "We're introducing a measure having a single chord, having a single, whose cents are 6000, whose velocity is 100, and which does not start a tie"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.899994, 153.0, 338.0, 21.0 ],
					"style" : "",
					"text" : "[<cents> <velocity> <start_a_tie?> <flag>]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.399994, 422.0, 167.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.399994, 363.5, 195.0, 55.0 ],
					"style" : "",
					"text" : "You can always replace midicents with note names"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.899994, 344.0, 275.0, 23.0 ],
					"style" : "",
					"text" : "addmeasures [[[[4 4] [60]] [4/4 [D#4 100 0]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 243.0, 280.0, 23.0 ],
					"style" : "",
					"text" : "addmeasures [[[[4 4] [60]] [4/4 [6000 100 0]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 76.0, 598.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where #cents and #velocity define the pitch and the dynamic, whereas the last element is a number being 1 if the note starts a tie, 0 otherwise. A more general form involves a final numeric flag for the given note, representing the state of the note (is it locked? or muted? or set as solo?). See #syntax+flag to have a complete understanding of this number. In any case, this is the form in which notes are output from the object's first outlet:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.899994, 53.0, 284.0, 21.0 ],
					"style" : "",
					"text" : "[<cents> <velocity> <start_a_tie?>]"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: gathered+syntax, syntax+flag, gathered+note+name, cents, velocity, tie",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Gathered syntax for notes in bach.score",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: gathered, syntax, note",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "In its simplest form, a bach.score note in gathered syntax is represented by",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.399994, 174.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 551.400024, 381.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 346.399994, 204.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 295.0, 273.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
