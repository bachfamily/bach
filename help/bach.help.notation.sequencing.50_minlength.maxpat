...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 389.0, 239.0, 36.0 ],
					"presentation_rect" : [ 11.0, 386.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "We can control the buffer play even if no notes are present in the bach.roll",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 224.0, 100.0, 40.0 ],
					"presentation_rect" : [ 251.0, 211.5, 0.0, 0.0 ],
					"text" : "Play, or use spacebar"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.0, 136.5, 93.0, 25.0 ],
					"presentation_rect" : [ 210.0, 144.0, 0.0, 0.0 ],
					"text" : "Load buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 429.0, 107.0, 25.0 ],
					"text" : "Turn audio on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 425.285706, 419.5, 44.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 425.285706, 358.0, 147.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 469.285706, 283.0, 36.0, 19.0 ],
					"presentation_rect" : [ 408.285706, 420.0, 0.0, 0.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.285706, 283.0, 36.0, 19.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 425.285706, 251.0, 151.0, 21.0 ],
					"text" : "bach.keys play stop end"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 425.285706, 323.0, 132.0, 21.0 ],
					"text" : "play~ helpbufferbach"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 235.0, 35.0, 19.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 94.5, 235.0, 86.0, 19.0 ],
					"text" : "minlength $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 6.0, 205.0, 137.0, 21.0 ],
					"text" : "info~ helpbufferbach"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 139.5, 133.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 317.285706, 138.5, 187.0, 52.5 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 6.0, 171.0, 180.0, 21.0 ],
					"text" : "buffer~ helpbufferbach 10000"
				}
...
, 			{
				"box" : 				{
					...
					"loop" : "null",
					"maxclass" : "bach.roll",
					"minlength" : 3478.45805,
					"numinlets" : 6,
					"numoutlets" : 8,
					"numvoices" : 1,
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 277.0, 373.0, 96.0 ],
					"pitcheditrange" : "null",
					"ruler" : 1,
					"rulerlabels" : 1,
					"showplayhead" : 1,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Sometimes it might be handy to have the playbar play even if no content is displayed in a bach.roll. This is not by default the case, since the sequencing stops as soon as there's no more content to play. More precisely, the sequencing stops when the length of the bach.roll is reached. \nThe \"minlength\" attribute is a way to overcome this behavior, by explicitly telling bach.roll that its length must not be inferior to a defined length. As a consequence, this will force the playing to last at least until the defined length. Here's an example of usage.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, minimum, length, minlength, play",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 286.5, 430.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 360.0, 233.5, 20.0, 20.0 ],
					"presentation_rect" : [ 350.5, 213.5, 0.0, 0.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 245.5, 138.5, 20.0, 20.0 ],
					"presentation_rect" : [ 184.5, 145.0, 0.0, 0.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 318.928571, 382.0, 397.357138, 382.0, 397.357138, 242.0, 434.785706, 242.0 ],
					"source" : [ "obj-1", 6 ]
				}
