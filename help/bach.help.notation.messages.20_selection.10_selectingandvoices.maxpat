...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 224.0, 221.0, 25.0 ],
					"presentation_rect" : [ 286.0, 217.0, 0.0, 0.0 ],
					"text" : "...or simply drop the last element"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 224.0, 121.0, 19.0 ],
					"presentation_rect" : [ 115.0, 210.5, 0.0, 0.0 ],
					"text" : "select 0 1000 nil nil"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 175.0, 221.0, 40.0 ],
					"presentation_rect" : [ 219.5, 169.5, 0.0, 0.0 ],
					"text" : "Use an empty llll (or nil) in order to select in all voices"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.5, 150.5, 183.0, 19.0 ],
					"presentation_rect" : [ 238.0, 129.5, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.5, 129.5, 78.0, 40.0 ],
					"presentation_rect" : [ 237.5, 114.0, 0.0, 0.0 ],
					"text" : "These coincide"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.5, 60.0, 328.0, 54.0 ],
					"text" : "Select all the elements between 1300ms and 2000ms, whose pitch is between 4900mc and 8000 mc, in the first and second voice"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Selecting content in different voices",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, selection, sel, unsel, select, voice, more, than, one, different, several, range",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "To select content in more than one voice, just substitute a llll with the voice numbers instead of a single voice number:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 43.5, 341.75, 297.5, 341.75 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 56.0, 340.75, 297.5, 340.75 ],
					"source" : [ "obj-6", 0 ]
				}
