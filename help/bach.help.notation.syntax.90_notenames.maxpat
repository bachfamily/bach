...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 96.333344, 483.0, 55.0 ],
					"text" : "Here we use note names instead of midicents amounts. Notice that such names already contain a representation of the enharmonicity (thus of the \"graphic\" extra)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 152.333344, 450.0, 19.0 ],
					"text" : "addmeasures ((((4 4) (60)) (1/2 (Db4 100 0)) (1/2 (E#4 100 0) (G#4 100 0))))"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.0, 301.333344, 178.0, 55.0 ],
					"text" : "If no octave is given, the last used one is kept"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 508.0, 81.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 532.25, 113.333344, 36.0, 19.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 113.333344, 35.0, 19.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 489.0, 139.333344, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.375, 191.333344, 159.0, 69.0 ],
					"text" : "Set the octave number of the middle C (by default: 4, typically 3 or 4)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.0, 164.333344, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 439.0, 600.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "On the other hand, as far as outputs are concerned, both bach.roll and bach.score only output midicents. To convert midicents into note names, use bach.mc2n.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.333313, 336.333344, 285.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "General syntax is: <pitchname><accidental(s)><octave>.\nTo know more about supported accidentals characters, see #ascii+accidentals",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 267.600006, 322.0, 69.0 ],
					"text" : "Anglo-Saxon naming (C, D, E, F....) and Latin naming (Do, Re, Mi, Fa...) can be mixed and they are both case insensitive. Also, you can mix them with the standard midicents assignment"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -138.0, 89.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 286.333344, 253.0, 19.0 ],
					"text" : "( C#4 d4 E4 6500 Sol4 la sib 7200 ), bang"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: separate+syntax, gathered+syntax, show+note+name, ascii+accidentals",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, note, name, middlecoctave",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Pitches can be always input equivalently as number of midicents (say: 6100) or as note name (say: C#4). This is valid both for gathered and for separate syntax. The second representation, on the other hand, is richer than the first one, since it already contains an enharmonicity information regarding the note. Such information will be automatically set as #graphic extra.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
