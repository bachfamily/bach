...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 569.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In bach.score, you can substitute to the millisecond positions of the \"sel\" syntax a timepoint, representing a measure and a position inside the measure. Such timepoint must be in the #timepoint llll syntax (<measure_number> <symbolic_onset_in_measure>) or \n(<voice_number> <measure_number> <symbolic_onset_in_measure>), if a voice needs to be specified (for instance, because voices have independent time signatures or tempi).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 378.0, 139.0, 69.0 ],
					"text" : "of course, \"nil\" is still supported to skip boundaries"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 211.5, 279.0, 99.0 ],
					"text" : "The same, for the second voice.\nNow the timepoints explicitely refer to the second voice (since voices don't have synchronous time signatures and tempi, this information is precious)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 175.0, 338.333313, 400.0, 134.333333 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 114.0, 374.0, 40.0 ],
					"text" : "In this example, (1 1/4) means: measure 1, symbolic onset 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 139.5, 382.0, 54.0 ],
					"text" : "Select all the elements between measure 1, onset 1/4, and measure 2 onset 3/8, with pitch falling between 5900mc and 8000mc, in the first voice"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 15.0, 193.5, 292.0, 135.666672 ],
					"pitcheditrange" : "null",
					"showmeasurenumbers" : [ 1, 1 ],
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: sel, select, unsel, sel+voices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Selecting content via timepoints",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, selection, sel, timepoint",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 382.0, 165.5, 382.0, 165.5, 334.333313, 184.5, 334.333313 ],
					"source" : [ "obj-5", 0 ]
				}
