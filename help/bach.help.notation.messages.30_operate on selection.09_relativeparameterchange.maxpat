...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.5, 247.0, 410.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.5, 200.682632, 507.0, 50.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, relative, change, onset, duration, tail, cents, velocity, modify, exist, existing, times, div, plus, minus, parameter, pitch, transpose, symduration",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "All the \"onset\", \"duration\", \"symduration\", \"tail\", \"cents\" and \"velocity\" messages have another way to work. Instead of assigning a fixed value, you can assign a simple formula to tell how the existing values of such parameters have to be modified.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
