...
, 			{
				"box" : 				{
					...
					"text" : "See Also: recursion, sequence, precedence, lookup, assigning+operator, for+loop",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 254.0, 23.0 ],
					"text" : "\"While\" loop examples and details",
					"varname" : "title"
				}
