...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 328.0, 238.0, 69.0 ],
					"text" : "Send a \"clearall\" message in the first inlet to clear all the separate parameters inlet at once."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 302.416687, 52.0, 19.0 ],
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.0, 121.0, 35.0, 19.0 ],
					"text" : "nil"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 120.0, 23.0, 21.0 ],
					"text" : "= "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 146.0, 238.0, 113.0 ],
					"text" : "When sent in one of the separate parameters inlet, the \"clear\" message will clear the content that was stored in the given inlet (waiting for a bang to rebuild the object). So it's no different than a \"nil\" message."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 121.0, 40.0, 19.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 430.0, 176.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 74.0, 40.0, 19.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.0, 113.0, 51.0, 19.0 ],
					"text" : "clear 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 187.0, 113.0, 51.0, 19.0 ],
					"text" : "clear 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 113.0, 51.0, 19.0 ],
					"text" : "clear 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 113.0, 51.0, 19.0 ],
					"text" : "clear 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 113.0, 51.0, 19.0 ],
					"text" : "clear 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.0, 71.0, 327.0, 40.0 ],
					"text" : "You can add a parameter to clear only a specific voice:"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 154.0, 342.0, 315.833344 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, clear, clearall, voice",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The \"clear\" message delete all the musical content in a bach.roll or bach.score, without deleting all the header information (such as slotinfo or commands, or keys...). Markers are, on the other hand, deleted.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
