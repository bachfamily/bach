...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 206.0, 198.0, 83.0 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, keyboard, cut, copy, paste, measure, music, content, allowcopypaste, allow, tempi, tempo, replace, inplace, in-place",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
