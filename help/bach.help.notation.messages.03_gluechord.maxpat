...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.5, 285.0, 90.0, 25.0 ],
					"presentation_rect" : [ 320.0, 281.5, 0.0, 0.0 ],
					"style" : "",
					"text" : "Also select"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -207.0, 332.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.5, 162.5, 232.0, 40.0 ],
					"style" : "",
					"text" : "As for addchord, the first integer parameter can be the voice number"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 205.0, 521.0, 36.0 ],
					"style" : "",
					"text" : "Optional ending parameters for the gluechord syntax: \n<threshold in ms> and <threshold in cents> for gluing",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.0, 239.5, 284.0, 40.0 ],
					"style" : "",
					"text" : "In this case we glue notes which only if they fall inside a threshold of 10 ms and 30 cents"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 121.5, 249.0, 40.0 ],
					"style" : "",
					"text" : "...then \"glue\" this chord! If possible, bach glues this notes to existing notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 68.5, 187.0, 40.0 ],
					"style" : "",
					"text" : "First add a chord in the standard \"addchord\" way..."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.0, 315.0, 523.0, 153.666672 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: addchord, addchords, gluechord+example, sel",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Gluing chords in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, gluechord, glue, chord, gluing, glueing, select, sel, selection",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 528.0, 36.0 ],
					"style" : "",
					"text" : "Very similar to the \"addchord\" message, the \"gluechord\" message glues chords to already existing ones (before or after the chords themselves), whenever possible:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.5, 77.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 587.0, 112.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
