...
, 			{
				"box" : 				{
					...
					"text" : "We define four commands as before"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 112.0, 269.0, 81.0 ],
					"text" : "[commands [1 [note granularnote] [chord granularchord] [key g]] [2 [note plainnote] [chord plainchord] [key p]] [3 [note notequery] [chord chordquery] [key q]] [4 [note thismsg] [chord thismsg] [key S]]]"
				}
