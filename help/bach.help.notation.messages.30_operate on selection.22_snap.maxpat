...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, snap, pitch, snappitchtogrid, snaponsettogrid, snaptailtogrid, onset, grid, tail, retranscribe, to",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
