...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 115.0, 361.0, 25.0 ],
					"presentation_rect" : [ 162.0, 117.0, 0.0, 0.0 ],
					"text" : "reset width factors from measure 2 to the end of the score"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 118.0, 120.0, 19.0 ],
					"presentation_rect" : [ 22.0, 120.0, 0.0, 0.0 ],
					"text" : "resetwidthfactors 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 152.0, 242.0, 25.0 ],
					"text" : "reset width factors for measure 2 to 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 155.0, 131.0, 19.0 ],
					"text" : "resetwidthfactors 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 68.0, 150.0, 25.0 ],
					"text" : "reset all width factors"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 71.0, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 197.0, 509.0, 135.666672 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "The \"resetwidthfactors\" message reset the local spacing multipliers to the default value of 1.",
...
, 			{
				"box" : 				{
					...
					"text" : "Resetting spacing factors",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, score, spacing, measure, multiplier, factor, local, widthfactor, reset, resetwidthfactors",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
