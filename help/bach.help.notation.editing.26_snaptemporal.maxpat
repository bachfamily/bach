...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 313.0, 359.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 160.0, 73.0, 19.0 ],
					"text" : "snaptail $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 58.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 99.0, 89.0, 19.0 ],
					"text" : "snaponset $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 204.0, 520.0, 122.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, snap, onset, tail, snaponset, snaptail",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
