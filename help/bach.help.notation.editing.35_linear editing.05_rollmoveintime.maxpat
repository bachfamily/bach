...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.5, 326.0, 321.0, 36.0 ],
					"presentation_rect" : [ 252.0, 327.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notice that when the cursor is exactly on a chord, the chord is \"active for editing\" and turns yellow.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 337.0, 363.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 337.0, 392.0, 250.0, 79.0 ],
					"pitcheditrange" : [ "null" ],
					"rulermode" : 0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 396.0, 325.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If a grid is displayed and the \"snaplinearedit\" attribute is on, the basic time step is the grid subdivision and adding the shift key will move by the grid division.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.5, 113.0, 198.0, 22.0 ],
					"style" : "",
					"text_width" : 137.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 75.0, 321.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "By default the standard left/right movement is 100ms.\nYou can change it via the linearedittimestep attribute:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Linear editing: moving in time in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, linear, speedy, fast, left, right, move, time, shift, linearedit, linearedittimestep, time, step, snap, snaplinearedit, cursor",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.0, 79.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
