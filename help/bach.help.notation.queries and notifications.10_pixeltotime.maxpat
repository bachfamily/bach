...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: dumpnotepixelpos, timepoint+syntax, timetopixel",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: query, queries, get, time, at, pixel, pixeltotime, convert, conversion, interp, left, right, nearest",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
