...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 429.5, 388.0, 21.0 ],
					"presentation_rect" : [ 10.0, 414.5, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When you unlock a barline, its width goes back to its default one.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 210.0, 183.0, 21.0 ],
					"presentation_rect" : [ 313.0, 176.5, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "(the #autoclear attribute is off)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.5, 202.5, 221.0, 36.0 ],
					"presentation_rect" : [ 6.0, 179.5, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "or you can lock/unlock barline width via the interface:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 163.5, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.0, 84.5, 227.0, 40.0 ],
					"text" : "Locking barlines is only possible if \"allowbarlinelock\" is 1 (default)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 488.0, 104.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.0, 127.5, 120.0, 19.0 ],
					"text" : "allowbarlinelock $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 126.5, 330.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can define barline locking by sending a \"width\" measureinfo field (see #syntax+measureinfo+width). In this case the measure will be assigned the fixed measure width, and its ending barline will be locked:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default measure widths adapt to the amount of musical content inside them. On the other hand, you can lock measure widths so that they remain fixed, independently from their content (see #spacing+measure+width).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 290.5, 507.0, 132.833328 ],
					"pitcheditrange" : "null",
					"spacingwidth" : 1.4,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: edit, editing, lock, unlock, locking, unlocking, barlines, measure, width",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
