...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 207.0, 222.0, 40.0 ],
					"text" : "select some markers and press M"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 581.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can define commands on markers as well",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 377.0, 147.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 74.0, 222.0, 69.0 ],
					"text" : "Here we define a command symbol to be sent when the command is set for markers"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 367.0, 239.0, 230.0, 100.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 145.0, 270.0, 23.0 ],
					"text" : "[commands [1 [marker modifmarker] [key m]]]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 239.0, 359.0, 100.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80103,
...
, 			{
				"box" : 				{
					...
					"text" : "Using commands on markers",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: command, note, marker, router",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
