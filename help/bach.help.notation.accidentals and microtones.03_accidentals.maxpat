...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 160.0, 165.0, 21.0 ],
					"presentation_rect" : [ 450.0, 162.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "only for tonedivision 2, 4, 8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 147.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.5, 245.5, 445.5, 25.0 ],
					"presentation_rect" : [ 171.0, 235.0, 0.0, 0.0 ],
					"text" : "Display accidentals as cents differences with respect to the diatonic note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 208.0, 261.0, 40.0 ],
					"presentation_rect" : [ 282.0, 213.0, 0.0, 0.0 ],
					"text" : "Display accidentals as fractions, and never reduce them to the lowest terms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 183.0, 212.0, 25.0 ],
					"presentation_rect" : [ 215.0, 182.0, 0.0, 0.0 ],
					"text" : "Display accidentals as fractions."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 270.5, 231.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Beware: represented cents will still in general differ from the note midicents (unless #tonedivision = 100)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 156.0, 259.0, 25.0 ],
					"presentation_rect" : [ 219.5, 152.5, 0.0, 0.0 ],
					"text" : "Display accidentals with classical glyphs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 247.5, 44.0, 21.0 ],
					"presentation_rect" : [ 152.0, 238.0, 0.0, 0.0 ],
					"text" : "Cents"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 217.5, 125.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.5, 126.5, 188.0, 25.0 ],
					"presentation_rect" : [ 320.0, 153.0, 0.0, 0.0 ],
					"text" : "Don't display any accidental"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 189.0, 72.0, 20.0 ],
					"text" : "loadmess 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 296.5, 137.0, 19.0 ],
					"presentation_rect" : [ 136.0, 279.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 225.0, 32.5, 19.0 ],
					"text" : "8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.25, 203.5, 32.5, 19.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 183.0, 32.5, 19.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 250.5, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 296.5, 95.0, 19.0 ],
					"text" : "tonedivision $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 189.0, 57.0, 21.0 ],
					"text" : "Fraction"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 158.0, 63.0, 21.0 ],
					"text" : "Classical"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 124.0, 128.5, 42.0, 21.0 ],
					"text" : "None"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.0, 128.5, 18.0, 152.0 ],
					"size" : 5,
					"value" : 4
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 331.0, 302.0, 137.333328 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 137.333328 ],
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tonedivision" : 8,
					"versionnumber" : 7100,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 0.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: accidentalfont, font+support, tonedivision",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: accidental, microtone, microtonality, display, classic, classical, fraction, unreduced, reduced, cents, diatonic",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 606.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "bach.roll and bach.score support, of course, the classical display of accidentals (naturals, flats, sharps...). They also extend this classical display to the quartertonal system, and to the eighttonal system (provided that the accidental font are supported: see #accidentalfont and #font+support).\nSince for different types of microtonal subdivisions a commonly agreed notation does not exist, bach does not propose a classical accidentals display for other type of temperaments, but provides you with alternative ways to deal with accidental display, via the \"accidentalsgraphic\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
