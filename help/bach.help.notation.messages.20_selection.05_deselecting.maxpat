...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 569.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Once some content is selected, the standard way to deselect all of it is to use \"clearselection\". Nonetheless, sometimes it is needed to deselect only a portion of it. This can be done via the \"unsel\" command, which works exactly like the #sel command, except that it will force the unselection of the content.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 273.5, 135.0, 19.0 ],
					"text" : "unsel nil nil nil 6000 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 60.0, 216.5, 228.0, 55.0 ],
					"text" : "On non-selected content, the \"unsel\" message doesn't do anything."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 223.5, 284.0, 69.0 ],
					"text" : "And exaclty as for #sel, bach.score support the timepoint syntax instead of the millisecond position (see #sel+timepoint)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 299.0, 189.0, 19.0 ],
					"text" : "unsel [1 0] [2 1/8] 6000 8000 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 184.0, 282.0, 25.0 ],
					"text" : "As for #sel, the \"nil\" syntax is fully supported"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 187.0, 135.0, 19.0 ],
					"text" : "unsel nil nil 7000 nil 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 135.0, 342.0, 40.0 ],
					"text" : "Remove from the selection elements between 1100ms and 3000ms, and between 6000mc and 8000mc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 145.5, 182.0, 19.0 ],
					"text" : "unsel 1100 3000 6000 8000 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 299.0, 91.0, 19.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 105.5, 311.0, 25.0 ],
					"text" : "Select everything before 5000ms in the first voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 108.5, 120.0, 19.0 ],
					"text" : "sel nil 5000 nil nil 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 15.0, 335.0, 265.0, 135.666672 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 288.0, 335.0, 292.0, 135.666672 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: select, sel, unsel+voices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, selection, unsel, deselect, deselection, deselecting",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 145.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 461.5, 108.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 111.5, 326.5, 297.5, 326.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 76.5, 328.25, 297.5, 328.25 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 327.25, 297.5, 327.25 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 41.5, 329.75, 297.5, 329.75 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 55.5, 327.5, 297.5, 327.5 ],
					"source" : [ "obj-9", 0 ]
				}
