...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.333336000000003, 187.0, 141.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 20.0, 247.0, 531.0, 124.666656000000003 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Boxing music is not such a straightforward task, as it involves dealing with the rhythmic tree (see #rhythmic+tree), and with all its intricacies and attributes. Here's an example of a behaviour which might be different from what you expect.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
