...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 312.5, 231.0, 54.0 ],
					"text" : "The value returned by $argcount includes the values that are not actually passed in a specific call."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 320.5, 293.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 125.5, 302.0, 38.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80001
					}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, function, $args, $argcount, pseudo, variable, argument, position",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
