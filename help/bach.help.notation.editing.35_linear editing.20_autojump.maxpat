...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.5, 106.0, 251.0, 54.0 ],
					"style" : "",
					"text" : "This can be changed by disabling the \"autojump\" attribute. Try to insert musical content without autojump!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.5, 115.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 592.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When in #linear+edit mode, by default whenever a new chord is inserted, the cursor goes automatically to the end of the enterd chord, ready to insert a new one.",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Autojumping to next chord",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, linear, speedy, linearedit, auto, jump, autojump, next, chord",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
