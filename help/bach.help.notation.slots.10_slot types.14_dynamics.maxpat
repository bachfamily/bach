...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 96.0, 166.0, 40.0 ],
					"style" : "",
					"text" : "Double click on the slot window to edit dynamics"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -232.0, 236.0, 137.0, 22.0 ],
					"style" : "",
					"text" : "select all, openslotwin 2"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 73.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 200.0, 585.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Dynamics slots can be shown as dynamics via slot linkage techniques.\nSee #dynamics, #dynamics+slot+linkage.",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Slots of type \"dynamics\" contain a textual information about the chord dynamics.\nThe dynamic marking is stored as a symbol.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, slotinfo, type, dynamics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
