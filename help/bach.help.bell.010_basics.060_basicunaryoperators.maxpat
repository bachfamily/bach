...
, 			{
				"box" : 				{
					...
					"text" : "See Also: concatenation, whitespace, bell+llll",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, unary, operator",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 511.0, 36.0 ],
					"text" : "Because of the interaction between implicit list construction and arithmetical operators, some extra care must be taken when dealing with unary plus and minus.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
