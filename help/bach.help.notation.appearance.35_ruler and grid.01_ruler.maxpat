...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 258.0, 72.0, 20.0 ],
					"text" : "loadmess 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 241.0, 81.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.0, 201.0, 151.0, 40.0 ],
					"text" : "...and their font size (up to vzoom scaling)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.0, 201.0, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 314.0, 228.0, 134.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "A ruler and a grid are at your disposition if you need to precisely frame your data. In bach.roll, they are also useful, as you zoom in or out, to immediately retrieve the zoom scale (see #zoom+interface)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.0, 80.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 149.0, 480.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each grid has a division and a subdivision value, the first one being stressed with slightly darker grid lines and slightly longer ruler ticks. The divisions and subdivision you see are default one, see #grid+division to know more.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 197.0, 146.0, 54.0 ],
					"text" : "Choose whether to show ruler labels at the division points..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 228.0, 87.0, 19.0 ],
					"text" : "rulerlabels $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 122.0, 293.0, 25.0 ],
					"text" : "Choose whether to also show the grid"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 133.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 160.0, 51.0, 19.0 ],
					"text" : "grid $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 78.0, 293.0, 25.0 ],
					"text" : "Choose whether and where to show the rulers"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-5",
					"items" : [ "None", ",", "Above", ",", "Below", ",", "Both" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.0, 78.0, 100.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 103.0, 55.0, 19.0 ],
					"text" : "ruler $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 371.0, 598.0, 101.0 ],
					"pitcheditrange" : "null",
					"ruler" : 1,
					"rulerlabels" : 1,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, ruler, grid, rulerlabels, label, rulerlabelsfontsize",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
