...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 104.0, 441.0, 273.5, 36.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 458.0, 135.0, 32.5, 23.0 ],
									"style" : "",
									"text" : "null"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 373.0, 135.0, 72.0, 23.0 ],
									"style" : "",
									"text" : "1.2 3.4 8/3"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 414.0, 295.0, 77.0, 108.0 ],
									"style" : "",
									"text" : "... in which\ni = integer \nr = rational\nf = float\ns = symbol\nl = llll\np = pitch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 269.5, 217.0, 76.0, 23.0 ],
									"style" : "",
									"text" : "print Penny"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 148.0, 247.0, 87.0, 23.0 ],
									"style" : "",
									"text" : "print Leonard"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 148.0, 217.0, 100.0, 23.0 ],
									"style" : "",
									"text" : "bach.bitdecode"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 247.0, 87.0, 23.0 ],
									"style" : "",
									"text" : "print Sheldon"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "" ],
									"patching_rect" : [ 10.0, 186.0, 278.5, 23.0 ],
									"style" : "",
									"text" : "bach.contains"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 233.0, 345.0, 79.0, 94.0 ],
									"style" : "",
									"text" : "... in which\n1 = int\n2 = rational\n3 = float\n4 = symbol\n8 = pitch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 375.0, 85.0, 94.0 ],
									"style" : "",
									"text" : "2 = int\n4 = rational\n8 = float\n16 = symbol\n32 = llll\n256 = pitch"
								}
