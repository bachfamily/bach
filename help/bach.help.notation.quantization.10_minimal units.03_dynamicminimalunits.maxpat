...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 438.0, 544.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Have a look at #symbolic+density and #dynamic+minimalunits+syntax to fully understand the concept of symbolic density, and the required syntax",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -138.0, 297.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.0, 200.0, 320.0, 55.0 ],
					"text" : "These long notes have a low symbolic density (below 10), so quantize uses the (1/8 1/12) minimal units."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 86.0, 330.0, 40.0 ],
					"text" : "This fast figure has a symbolic density of more than 25, thus quantize uses the (1/32) minimal unit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 81.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 298.0, 544.0, 134.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 244.0, 65.0, 19.0 ],
					"text" : "[4 4] [60]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 271.0, 432.0, 21.0 ],
					"text" : "bach.quantize @minimalunits dynamic (1/8 1/12) 10 (1/16 1/24) 25 (1/32)"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, minimal, units, minimalunits, dynamic, adaptive",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Adaptive or dynamic dynamic minimal units are a way to have different minimal units in each box, according to the box events' density: if there are a lot of events, thus, you might want to have smaller units; vice versa, if only few events appear, you might desire a loose quantization.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 102.5, 104.5, 15.5, 104.5 ],
					"source" : [ "obj-5", 0 ]
				}
