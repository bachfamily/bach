...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 80.0, 319.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Some of the help patches have the \"embed\" attribute turned off in order to avoid Max asking to save the help file each time it is modified and then closed. If you copy and paste snippets from the help files, be sure to check whether your objects have @embed 1.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 63.5, 162.0, 21.0 ],
					"style" : "",
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 108.0, 69.0, 23.0 ],
					"style" : "",
					"text" : "embed $1"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: data, embed, save, data, with, patch, patcher, help, caveat, beware",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
