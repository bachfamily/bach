...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 429.0, 525.0, 36.0 ],
					"presentation_rect" : [ 19.0, 429.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "You can set the number of voices also as argument when digiting inside the object box. For instance you can type [bach.score 4], or [bach.roll 3 @clefs G FG F]",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 168.0, 274.0, 54.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.5, 186.0, 74.0, 23.0 ],
					"style" : "",
					"text" : "vzoom 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 186.0, 79.0, 23.0 ],
					"style" : "",
					"text" : "vzoom auto"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 175.0, 120.0, 403.0, 36.0 ],
					"style" : "",
					"text" : "If more voices than the existing ones are defined, the clefs and keys of the additional voices will be taken from the last existing voice.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 255.0, 283.0, 101.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 80.0, 295.0, 40.0 ],
					"style" : "",
					"text" : "Changing the \"numvoice\" attribute will define immediately a new number of voices."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 17.0, 80.0, 53.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.0, 255.0, 268.0, 101.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 104.0, 91.0, 23.0 ],
					"style" : "",
					"text" : "numvoices $1"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: voice, numvoices, change, number, add, delete, insert, argument, type, box",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Both bach.roll and bach.score are multi-voice editors. There are a few immediate ways to add, delete, insert voices, or to change the number of voices.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
