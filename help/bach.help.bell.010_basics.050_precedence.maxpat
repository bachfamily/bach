...
, 			{
				"box" : 				{
					...
					"text" : "See Also: concatenation, bell+llll, literal",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 93.0, 23.0 ],
					"text" : "Precedence",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, operator, precedence, paren",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Keeping track of operation precedence can be challenging, but precedence can be forced with parens, just like in bach.expr. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
