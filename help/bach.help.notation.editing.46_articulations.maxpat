...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 204.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 360.0, 162.0, 21.0 ],
					"style" : "",
					"text" : "IMPORTANT:",
					"textcolor" : [ 0.792157, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 378.0, 589.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "bach supports most standard articulations, such as accents, portato, staccato, bowing, fermata, tremolo, trills and much more. Nonetheless not all the supported #articulation+fonts have a glyph for all articulations. Especially Boulez only has a few articulation glyphs. If you don't see an articulation as you wish (e.g. tremoli with Boulez), it might be because the font doesn't have the proper character, so try to use another #articulation+font, if you can."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 53.0, 201.0, 299.0, 128.333313 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, articulation, add, delete, change, modify, switch",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Provided that an #articulation+slot is linked with articulation display (see #slot+linkage+articulations), which is the case by default, articulations can be inserted by selecting the note(s) or chord(s) to which they should be attached, and pressing a given key combination. For instance, Alt+S will insert a \"staccato\" articulation, Alt+F will insert a fermata, and so on. The list of all possible commands can be found at #edit+articulations+list. This is valid for rests as well as for notes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
