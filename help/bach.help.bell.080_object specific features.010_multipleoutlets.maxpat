...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 371.0, 24.0, 24.0 ]
				}
...
,
					"text" : "bach.eval outlet(1 2\\, 123\\, 456) @extraoutlets 2 @out m"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 259.0, 24.0, 24.0 ]
				}
...
,
					"text" : "bach.eval outlet(2\\, 123) \\; outlet(1\\, 456) \\; outlet(2\\, 789) @extraoutlets 2 @out m"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 11.0, 149.0, 24.0, 24.0 ]
				}
...
,
					"text" : "bach.eval outlet(1\\, 123) \\; 456 @extraoutlets 1 @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 118.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, multiple, outlet, extraoutlet",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
