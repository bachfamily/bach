...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 420.0, 570.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.5, 326.0, 302.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The duration of the created chord will be the same as the last created one.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 127.0, 321.0, 22.0 ],
					"style" : "",
					"text_width" : 148.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 75.0, 332.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The duration of the note will be a multiple of the #linearedittimestep. The multiplier for each one of the key is defined by the \"linearedittimemultipliers\" attribute ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 600.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "All the following commands are available in linear editing mode (see #linear+edit+intro to know more).\nTo add notes in bach.roll you can either use the numeric keys or the letter keys",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: linear+edit+intro, linearedittimestep, linear+edit+time+cursor",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Linear editing: notes in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 599.0, 31.0 ],
					"style" : "",
					"text" : "Tags: editing, edit, interface, linear, speedy, fast, left, linearedit, linearedittimemultipliers, time, multiplier, duration, cursor, insert, add, note, chord, accidental, raise, lower, new, delete",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 155.0, 526.0, 171.666672 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 232.0, 330.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
