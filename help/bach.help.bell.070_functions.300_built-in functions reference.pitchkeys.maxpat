...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 97.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"code" : "pitchkeys(D#2+1/16t+F{}3+4/3r) ",
					"id" : "obj-7",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 136.0, 302.0, 23.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80900
					}
,
					"text" : "bach.eval pitchkeys(D#2+1/16t+F{}3+4/3r) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 39.0, 507.0, 36.0 ],
					"text" : "The pitchkeys() function returns an key-based llll with sublists containing all the details of a given pitch.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: jicommas, pitchkeys",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "pitchkeys() function reference",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, built, in, function, jicommas, just, intonation, exponents",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
