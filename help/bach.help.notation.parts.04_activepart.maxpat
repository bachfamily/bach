...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 288.0, 326.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The activepart attribute does not affect modification of existing chords. Also, if you duplicate chords via Alt+drag, they will retain their own voice.\nBut if you copy them and paste them, they will be pasted in the active part.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 21.0, 317.666687, 219.0, 128.999969 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 401.0, 415.666656, 191.0, 23.0 ],
					"style" : "",
					"text_width" : 142.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 81.5, 398.0, 54.0 ],
					"style" : "",
					"text" : "By default, when you add a chord, or a measure, or you'll enter linear editing, this will be in part 1 of a voice ensemble. You can change the active voice via the \"activepart\" attribute."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 137.666656, 545.0, 145.0 ],
					"pitcheditrange" : [ "null" ],
					"showpartcolors" : 1,
					"stafflines" : [ 5, 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 97.0, 180.0, 23.0 ],
					"style" : "",
					"text_width" : 146.0
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can establish which part of a voice ensemble should be edited (e.g. when adding chords, or when toggling the linear editing mode) by means of the \"activepart\" attribute",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: voice+ensemble, showpartcolors, linear+edit, chord+add, measure+add, numparts",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Set active part for editing",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: part, voice, ensemble, voiceensemble, edit, part, interface, active, set, editing, duplicate, copy, paste, new, swap",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
