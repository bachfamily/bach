...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 96.5, 402.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.5, 432.0, 105.0, 23.0 ],
					"text" : "padbeforeclef $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 336.0, 219.0, 50.0 ],
					"text" : "If you need to add empty staff before the clef, you can use the \"padbeforeclef\" attribute",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 319.0, 95.0, 23.0 ],
					"text" : "padafterclef $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 272.0, 357.166687000000024, 336.0, 99.666663999999997 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 80300,
					"voicenames" : [ "[", "]" ],
					"voicespacing" : [ 0.0, 16.399999999999999 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 119.0, 95.0, 23.0 ],
					"text" : "padafterclef $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Padding space before and after clefs",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, pad, startpad, additional, padding, space, additionalstartpad, adjustadditionalstartpad, start, pretime, pre, time, after, before, padbeforeclef, padafterclef, clef",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Sometimes in bach.roll you can have chords nearly at 0ms having a certain number of accidentals.\nThose accidentals are thus not fully shown. You can use the \"padafterclef\" attribute to handle this case.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 166.0, 111.0, 23.0 ],
					"text" : "adjustpadafterclef"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 106.0, 465.0, 8.25, 465.0, 8.25, 204.0, 26.5, 204.0 ],
					"order" : 1,
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 106.0, 465.0, 253.75, 465.0, 253.75, 346.166687000000024, 281.5, 346.166687000000024 ],
					"order" : 0,
					"source" : [ "obj-14", 0 ]
				}
