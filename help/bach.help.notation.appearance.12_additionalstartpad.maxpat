...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: appearance, pad, startpad, additional, padding, space, additionalstartpad, adjustadditionalstartpad, start, pretime, pre, time",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
