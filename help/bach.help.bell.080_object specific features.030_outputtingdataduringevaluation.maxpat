...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 365.0, 66.0, 23.0 ],
					"text" : "1 [2 3 4] 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 447.5, 133.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 237.0, 66.0, 23.0 ],
					"text" : "1 [2 3 4] 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 331.5, 133.0, 23.0 ],
					"text" : "print result @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 90.0, 50.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 35.0, 591.0, 50.0 ],
					"text" : "It is possible to output data during the evaluation, either through the directout function, or through the $do<1> ... $do<n> pseudovariables. The output happens through one or more specific outlets, all placed at the right of the main outlet.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 185.5, 133.0, 23.0 ],
					"text" : "print result @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: return+value, multiple+outlet, directin, bell+outlet",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 249.0, 23.0 ],
					"text" : "Outputting data during evaluation",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, directout, direct, out, outlet, output, lambda",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
