...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 75.0, 289.0, 21.0 ],
					"text" : "Answer is in the form: numvoices <num_voices>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.5, 447.0, 147.0, 21.0 ],
					"text" : "print Answer @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 447.0, 147.0, 21.0 ],
					"text" : "print Answer @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "bang" ],
					"patching_rect" : [ 352.5, 401.5, 260.0, 36.0 ],
					"text" : "bach.keys numvoices numchords numnotes nummeasures @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 240.5, 292.0, 36.0 ],
					"text" : "A number for each voice is output, all preceeded by the \"nummeasures\" symbol",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 177.0, 314.0, 36.0 ],
					"text" : "In the output llll there's one number for each chord. The whole llll is routed by a \"numnotes\" symbol",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.5, 177.0, 126.0, 40.0 ],
					"text" : "Retrieve the number of notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 127.0, 571.0, 50.0 ],
					"text" : "For bach.roll, this returns a list of numbers (one for each voice). For bach.score, this returns a list of lists of numbers: one for each measure, and for each voice. Both lists are preceeded by the \"numchords\" symbol",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 99.0, 202.0, 25.0 ],
					"text" : "Retrieve the number of chords"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.5, 215.5, 220.0, 25.0 ],
					"text" : "Retrieve the number of measures"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 189.0, 86.0, 19.0 ],
					"text" : "getnumnotes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 102.0, 93.0, 19.0 ],
					"text" : "getnumchords"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 219.714279, 217.5, 111.0, 19.0 ],
					"text" : "getnummeasures"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "bang" ],
					"patching_rect" : [ 13.380936, 401.5, 207.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 280.0, 313.0, 112.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 72.0, 200.0, 25.0 ],
					"text" : "Retrieve the number of voices"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 280.0, 281.0, 112.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7100,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 75.0, 91.0, 19.0 ],
					"text" : "getnumvoices"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Querying number of elements",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: query, queries, getnumvoices, getnumchords, getnumnotes, getnummeasures, number, of, voice, measure, chord, note",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "You can ask bach.roll and bach.score how many nottion notation items of a certain type they contain.\nAll the answers come out from the playout, with a specific query router.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 260.5, 304.5, 260.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 229.214279, 257.75, 304.5, 257.75 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 259.5, 304.5, 259.5 ],
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 44.5, 259.5, 304.5, 259.5 ],
					"source" : [ "obj-8", 0 ]
				}
