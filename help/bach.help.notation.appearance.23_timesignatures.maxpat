...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 251.0, 335.0, 208.0, 54.0 ],
					"text" : "Notice that if the time signature changes only locally, the small time signatures are used"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 95.0, 208.0, 40.0 ],
					"text" : "Sets the ratio of the \"big\" time signatures display"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 104.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 66.0, 240.0, 22.0 ],
					"text_width" : 130.0
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, time, signature, timesignature, timesig, big, large, display",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "You can choose to display time signatures as big numbers above the staff (or hide them altogether):",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
