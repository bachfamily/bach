...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 261.5, 173.0, 23.0 ],
					"style" : "",
					"text" : "subsel note if cents == 7900"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 159.5, 180.0, 25.0 ],
					"style" : "",
					"text" : "Only keep notes in voice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 159.5, 151.0, 23.0 ],
					"style" : "",
					"text" : "subsel note if voice == 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.5, 569.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"subsel\" message restrict the current selection to the elements that also belong to the specified selection. The syntax is identical to #sel, #unsel and #select.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.0, 193.5, 239.0, 40.0 ],
					"style" : "",
					"text" : "...works with score timepoint syntax too"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 122.5, 282.0, 25.0 ],
					"style" : "",
					"text" : "Only keep notes lying between 1 and 6 secs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 122.5, 113.0, 23.0 ],
					"style" : "",
					"text" : "subsel 1000 6000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 81.0, 174.0, 23.0 ],
					"style" : "",
					"text" : "sel note if cents % 1200 != 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 81.0, 198.0, 25.0 ],
					"style" : "",
					"text" : "Select all notes except for C's"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 15.0, 305.0, 265.0, 135.666672 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 288.0, 305.0, 292.0, 135.666672 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: sel, unsel, select, timepoint+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Restricting the selection",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, restrict, restricting, narrow, thin, intersect, inter, intersel, sel, subsel, subselection",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 471.0, 162.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 409.0, 81.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 469.0, 125.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
