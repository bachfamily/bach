...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 221.0, 331.0, 21.0 ],
					"text" : "The alter() function is equivalent to the etalter() function.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 136.0, 172.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 39.0, 437.0, 36.0 ],
					"text" : "The alter() function returns the alteration in semitones (or fraction thereof) of the equal-tempered part of one or more pitches. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 185.0, 23.0 ],
					"text" : "alter() function reference",
					"varname" : "title"
				}
