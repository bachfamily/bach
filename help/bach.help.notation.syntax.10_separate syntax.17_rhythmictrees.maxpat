...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 445.0, 606.0, 21.0 ],
					"presentation_rect" : [ 2.0, 445.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "See #rhythmic+tree+output to know how to retrieve rhythmic trees from #dump messages.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 391.0, 606.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Simply put: you can add level of parentheses to the duration separate syntax llll. In such a way, you can define #nested+tuplets and custom beamings. In order to know more, refer to #rhythmic+tree+level: to rhythmic trees is dedicated a wide section in the rhythm chapter of this documentation.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 280.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 302.0, 322.0, 69.0 ],
					"text" : "We have added some parenthesis: bach understands that we are defining hierarchical relationships in the rhythm, and modifies the beaming accordingly"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.5, 280.0, 406.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 2.0, 310.0, 272.0, 72.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 237.0, 591.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Furthermore, you can add levels of parentheses in the separate syntax durations llll, identifying groups of chords which constitute hierarchical levels. For instance:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 123.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 145.0, 285.0, 84.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.5, 123.0, 372.0, 19.0 ],
					"text" : "((1/8 1/24 1/24 1/24 1/16 1/64 1/64 1/64 1/64 1/16 1/16)), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 2.0, 153.0, 272.0, 72.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "Inputting rhythmic tree levels",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, hierarchy, hierarchical, rhythmic, tree, level, beam, tuplet, separate, duration, input",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 591.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In CAC environments, rhythm is very often represented in a structured form, where beams, tuplets and ideally any other meaningful rhythmic figuration are isolated by delimiting them into proper level of parenthesis. bach makes no exception to this tradition, but deals with the rhythmic tree interface differently than other pieces of software.\nFor instance, nothing prevents you from using the completely plain durations to define your rhythm:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
