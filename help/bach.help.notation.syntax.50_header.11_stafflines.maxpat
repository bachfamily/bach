...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.5, 266.5, 83.0, 19.0 ],
					"text" : "stafflines 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.5, 168.0, 575.5, 84.0 ],
					"presentation_rect" : [ 29.5, 185.0, 0.0, 0.0 ],
					"text" : "A plain llll of numbers is considered as an llll containing the indices of the lines to be drawn. Line 1 correspond to the bottommost staffline of a standard staff; line 5 correspond to the topmost staffline of a standard staff. Integers need not be positive: indices like -2 or 7 will be extrapolated from the standard staff. The total number of lines is thus the length of the llll."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.5, 91.0, 324.0, 54.0 ],
					"presentation_rect" : [ 204.0, 86.0, 0.0, 0.0 ],
					"text" : "A single number simply sets the number of stafflines for a given voice. Those will be distributed evenly with respect to the staff center, if possible."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 150.0, 510.0, 21.0 ],
					"presentation_rect" : [ 75.0, 107.0, 0.0, 0.0 ],
					"text" : "(<index_staff_line1> <index_staff_line2> <index_staff_line3>...)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 31.0, 62.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.5, 300.0, 357.0, 40.0 ],
					"text" : "Voice 1 has 4 staff lines, whose custom specific indices are given; voice 2 is a standard 5-lines-staff voice"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.5, 263.5, 380.0, 25.0 ],
					"text" : "Voice 1 has 3 staff lines, voice 2 has just 1 staff line"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 107.5, 190.0, 21.0 ],
					"text" : "<number_of_staff_lines>"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 52.0, 602.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "A list of elements (one for each voice) is expected. Since staff lines can be set both as header element and as attribute, also refer to #voice+stafflines. Each element can be in one of the following forms:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.5, 310.5, 129.0, 19.0 ],
					"text" : "stafflines (-1 0 5 8) 5"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 237.450012, 354.333344, 247.0, 104.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"out" : "ttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 29.0, 354.333344, 198.0, 102.666664 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax+whole, syntax+header, voice+stafflines",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 472.0, 602.0, 19.0 ],
					"text" : "Tags: header, syntax, staff, lines, stafflines",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"showhand" : 0,
					"text" : "Staff lines are set by the                symbol, and are all defined in the header of the notation object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
