...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 348.0, 160.0, 23.0 ],
...
, 			{
				"box" : 				{
					"code" : "finditems($l1, 1, ($x, $y -> abs($x - $y) < 0.1)) ",
...
,
					"text" : "bach.eval finditems($l1\\, 1\\, ($x\\, $y -> abs($x - $y) < 0.1)) @out m"
				}
...
, 			{
				"box" : 				{
					"code" : "$closeEnough = ($x, $y -> abs($x - $y) < 0.1) ; finditems($l1, 1, $closeEnough) ",
					"fontname" : "Menlo Regular",
					"fontsize" : 13.0,
					"id" : "obj-14",
					"linecount" : 3,
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y -> abs($x - $y) < 0.1) \\; finditems($l1\\, 1\\, $closeEnough) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 37.0, 585.0, 65.0 ],
					"text" : "Sometimes, you can tailor the behavior of a function by means of another function. A typical example is search: we can look for elements equal to something, or matching some other, more complex criterion (such as proximity, or modulo equality) which can effectively be described by an auxiliary (or \"lambda\") function passed as data to the search function.",
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: local+variable, built+in",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: bell, function, user, defined, argument, lambda, anonymous, finditems",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
