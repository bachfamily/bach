...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.900002, 317.0, 201.0, 21.0 ],
					"presentation_rect" : [ 19.0, 313.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Also see #voice+syntax+padding",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 227.0, 266.0, 98.0 ],
					"style" : "",
					"text" : "Notice that all other parameters will assume some default values (on which you must consider to have no control: if you need to assign precise values to those parameters, just assign them!)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.899994, 143.0, 247.850006, 69.0 ],
					"style" : "",
					"text" : "Add a \"bang\" after a comma directly inside the parameter message to rebuild directly only according to that parameter."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 127.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.75, 327.0, 238.0, 23.0 ],
					"style" : "",
					"text" : "((1/4 1/8 1/8 1/12 1/12 1/12 -1/4)), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 112.5, 354.0, 482.0, 103.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.300003, 88.0, 387.0, 52.0 ],
					"style" : "",
					"text" : "((6000) (6200) (6400) (6500) (6700) (6900) (7100) (6000 7200)) ((6200) (6400) (6500) (6700) (6900) (7000) (7300) (6200 7400)), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.900002, 157.0, 310.0, 158.0 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: separate, syntax, build, rebuild, construct, paint, multiple, drop, level, parentheses, parenthesis, single, message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 608.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you only use a single parameter to build your bach.roll or bach.score, you can send the bang to build the object directly in the parameter inlet, so that you can simply use a single message to create your musical content.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
