...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.0, 118.833344, 296.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This means that, for bach.score, one will also get the timepoints for each voices: see #getdomain",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 78.0, 280.0, 98.0 ],
					"presentation_rect" : [ 300.0, 78.0, 0.0, 0.0 ],
					"text" : "If you change the domain, for instance by dragging the scrollbar, or zooming, or scrolling, notifications about the current domain are sent. Those notifications are in the same form as the \"getdomain\" answers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 451.0, 485.0, 21.0 ],
					"presentation_rect" : [ 76.0, 401.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can have notified also changes done via message: see #message+notification",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.0, 78.0, 263.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #zoom+interface, #scrollbar+interface",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 311.5, 173.833344, 280.0, 84.0 ],
					"text" : "If you move the playhead by Alt+clicking or Alt+click and drag, a notification is sent, outputting the position of the playhead cursor in the form: cursor <cursor_ms>."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 472.5, 415.0, 138.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.380936, 314.0, 127.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 260.0, 313.0, 139.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 154.833344, 280.0, 139.333328 ],
					"pitcheditrange" : "null",
					"showplayhead" : 1,
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: zoom+interface, scrollbar+interface, getdomain, message+notification",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Playhead cursor and domain notifications",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: notify, notification, playhead, cursor, bar, playbar, domain, change, move",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The playout is also the outlet dedicated to receiving notifications concerning playhead cursor, domain and loop region. Whenever one of this three elements",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
