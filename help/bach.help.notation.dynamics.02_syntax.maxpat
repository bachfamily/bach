...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 162.0, 257.0, 25.0 ],
					"presentation_rect" : [ 231.0, 152.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "...or end the hairpin when the note ends"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 141.0, 162.0, 35.0, 23.0 ],
					"presentation_rect" : [ 165.0, 163.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "pp<|"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 212.0, 242.0, 25.0 ],
					"style" : "",
					"text" : "Use \"0\" for the zero dynamic marking"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.5, 213.0, 59.0, 23.0 ],
					"style" : "",
					"text" : "0<<f>>0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 264.5, 251.0, 40.0 ],
					"style" : "",
					"text" : "Use the underscore to concatenate dynamics without any hairpin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 273.5, 62.0, 23.0 ],
					"style" : "",
					"text" : "p<ff_ff>p"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 238.5, 206.0, 25.0 ],
					"style" : "",
					"text" : "Combine all previous things"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 240.0, 74.0, 23.0 ],
					"style" : "",
					"text" : "p<ff>>mp<"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 186.0, 378.0, 25.0 ],
					"style" : "",
					"text" : "use << or >> to create \"exponential\" crescendi/diminuendi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 186.0, 41.0, 23.0 ],
					"style" : "",
					"text" : "pp<<"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.0, 122.0, 275.0, 40.0 ],
					"style" : "",
					"text" : "Leave an ending hairpin to create an hairpin till next defined dynamic marking..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 130.5, 35.0, 23.0 ],
					"style" : "",
					"text" : "pp<"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 310.0, 126.0, 25.0 ],
					"style" : "",
					"text" : "Remove marking"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 310.0, 152.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 3, eraseslot 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.0, 80.0, 426.0, 40.0 ],
					"style" : "",
					"text" : "add hairpins inside the marking to create a sequence of dynamics for the chord. Dynamics are uniformly spaced inside the chord duration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 89.0, 59.0, 23.0 ],
					"style" : "",
					"text" : "f<fff>mp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.0, 56.0, 157.0, 25.0 ],
					"style" : "",
					"text" : "...or a more exotic one"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 33.0, 32.0, 23.0 ],
					"style" : "",
					"text" : "sffz"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.5, 33.0, 33.0, 23.0 ],
					"style" : "",
					"text" : "mp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 56.0, 44.0, 23.0 ],
					"style" : "",
					"text" : "fffppp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 354.0, 31.5, 248.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Dynamics are assigned as any other slot content. See #slot+syntax to know more",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 31.5, 228.0, 25.0 ],
					"style" : "",
					"text" : "Add a standard dynamic marking..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 33.0, 30.0, 23.0 ],
					"style" : "",
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: slot+edit, slot+interface, addslot, eraseslot, checkdynamics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: dynamic, define, assign, syntax, marking, piano, forte, p, pp, ppp, f, ff, fff, sforzato, fortissimo, pianissimo, crescendo, decrescendo, hairpin, sign, exponential, dimminuendo, next",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
