...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 403.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 118.5, 421.5, 69.0 ],
					"style" : "",
					"text" : "If this is the only accepted configuration, any box solution containing 3 events will be discarded, and bach quantize will try to reduce the number of events. But also any solution containing 2 events will be discarded! The result will probably be different from what you want..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 190.0, 170.0, 25.0 ],
					"style" : "",
					"text" : "Send a \"quantize\" to test"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.0, 313.0, 89.0, 23.0 ],
					"style" : "",
					"text" : "loadmess 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 193.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 115.0, 223.0, 358.0, 87.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.0, 366.0, 570.0, 101.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 269.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "(2 4) (40)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 340.0, 385.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 143.5, 165.0, 23.0 ],
					"style" : "",
					"text" : "allow (1/16 1/16 1/16 1/16)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 67.0, 602.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "If you give, for instance, only configuration having a certain number of durations, this will put bach.quantize in the impossibility to find any solution for a box containing a different number of durations, so he'll reduce the number of events, which might probably be far from what you want.",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "Beware: if you use the allow message, be sure that you give at least one possibility for each number of durations in each box. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 350.0, 23.0 ],
					"style" : "",
					"text" : "Dangers of allow and forbid",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: quantize, quantization, allow, deny, configuration, danger, beware, forbid",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
