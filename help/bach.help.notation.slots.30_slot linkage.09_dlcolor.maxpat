...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 395.0, 191.0, 55.0 ],
					"style" : "",
					"text" : "This duration line has no color assigned inside the first slot"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 47.0, 311.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -213.0, 281.0, 170.0, 22.0 ],
					"style" : "",
					"text" : "sel 0 100 nil nil, openslotwin 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -213.0, 252.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 73.5, 209.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "you can do the same by using the #slotinfo+inspector",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 73.5, 270.0, 55.0 ],
					"style" : "",
					"text" : "We prepare a color slot named \"color\", and link the durationlinecolor to the slot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 292.0, 202.0, 290.0, 83.0 ],
					"style" : "",
					"text" : "bach immediately understands that the duration line colorhas to be matched to the one contained inside the slot. Open the first slot window and change the color to have the duration line color change"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 174.0, 295.0, 125.0 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 1,
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can also use int/float/intlist/floatlist slots, analogously to the #linknotecolortoslot case.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: slot+linkage, slotinfo+inspector, linknotecolortoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Changing duration line color",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, link, linkage, appearance, change, changing, duration, line, dl, durationline, durationlinecolor, linkdurationlinecolortoslot, linkdlcolortoslot, dlcolor, color",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
