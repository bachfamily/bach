...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "In fact, these are not very polite examples, as in general if you want to pass a value to a function the proper way to do it is through an argument, not through lifting a variable. \nLifting is useful in some specific scenarios that will be discussed later, namely recursion and lambda functions.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 51.5, 152.0, 52.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80006
					}
,
					"text" : "bach.eval PlusYglobal = ($x -^ $y -> $x + $y) @auto 1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Here we define a function lifting a $y variable, and make it available globally."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 234.0, 23.0 ],
					"text" : "Lifted local variables: examples",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, function, user, defined, variable, local, assignment, scope, visibility, scoping, lift, lifted",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
