...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 493.5, 136.5, 112.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #inscreenpos",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.5, 225.0, 410.0, 36.0 ],
					"text" : "With the addmarker command, you can use the symbol \"cursor\" instead of a millisecond position or of a bach.score timepoint",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 263.0, 366.0, 25.0 ],
					"text" : "Add a cursor named \"cur\" at the current playhead position"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.0, 378.0, 80.0, 55.0 ],
					"text" : "Show/hide playhead"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.0, 353.416656, 71.0, 19.0 ],
					"text" : "hidecursor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 180.0, 366.0, 25.0 ],
					"text" : "Set the playhead position on the marker named \"marker S\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 117.5, 299.5, 40.0 ],
					"text" : "Force the first marker having \"pippo\" as name to be positioned at 20% of the screen window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 443.0, 297.0, 21.0 ],
					"text" : "The same commands equally apply to bach.score",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.5, 265.0, 135.0, 19.0 ],
					"text" : "addmarker cursor cur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 482.0, 328.0, 78.0, 19.0 ],
					"text" : "showcursor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 146.5, 71.5, 270.5, 40.0 ],
					"text" : "Force the first marker having \"johnny\" as name to be shown inside the screen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 135.0, 138.0, 19.0 ],
					"text" : "inscreenpos 0.2 pippo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.5, 80.0, 102.0, 19.0 ],
					"text" : "inscreen johnny"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 183.0, 120.0, 19.0 ],
					"text" : "setcursor marker S"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 319.0, 471.0, 117.833336 ],
					"pitcheditrange" : "null",
					"showplayhead" : 1,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: inscreen, inscreenpos, setcursor, showcursor, hidecursor, addmarker",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 314.0, 23.0 ],
					"text" : "Marker interaction with cursor and domain",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: showcursor, hidecursor, inscreen, inscreenpos, setcursor, addmarker, screen, domain",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 426.0, 36.0 ],
					"text" : "Commans like inscreen, inscreenpos, setcursor, work with markers too, both for bach.roll and for bach.score.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
