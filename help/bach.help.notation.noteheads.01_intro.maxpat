...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 6.0, 281.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 310.0, 170.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 243.0, 580.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Finally, noteheads are handled in the same way both in bach.roll and in bach.score.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 339.0, 526.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 202.0, 579.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Default notehead font is the defined #notationfont; however this can be changed locally for any custom defined notehead (see #custom+noteheads).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 109.0, 597.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For your convenience, in all newly created notation objects, the 23th slot is already set up as an articulation slot linked with articulation display, with hotkey H. All you need to do is to open the slot window for a given note (press 'h' while the note is selected) and choose which notehead should be assigned to the note. In this section we will document how to display and modify noteheads, and how to define custom noteheads in adddition to the standard set of predefined ones. These custom noteheads are saved as part of the #header in the #gathered+syntax.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: notehead, define, assign, linknoteheadtoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 580.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The simplest way to define articulation is to assign them to notes via slot linkage techniques (see #slot+linkage). The idea is simple: you define a slot of type \"notehead\" and then link it to the articulations display via the \"linknoteheadtoslot\" attribute. (Incidentally, in this way, you might also have more than one notehead slot, and switch them instantaneously when changing the \"linknoteheadtoslot\" attribute). ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
