...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.5, 386.0, 572.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notehead slots are the simplest and standard way to use noteheads, modify them, define custom noteheads and much more. Please refer to the dedicated section on #noteheads to know more.\n\nOn the other hand, if you want to manually change font, size or notehead character, you can still have a look at #slot+linkage+notehead+char, #slot+linkage+notehead+font, #slot+linkage+size",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "sel chord 1, openslotwin 23"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The simplest way to modify noteheads is to use a \"notehead\" slot. By default, the 23th slot is already a notehead slot (key H), linked with the notehead.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, link, linkage, appearance, change, changing, note, head, notehead",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
