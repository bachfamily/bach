...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 335.0, 72.0, 22.0 ],
					"text" : "10 20 30 40"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 362.5, 383.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 409.0, 91.0, 22.0 ],
					"text" : "print @popup 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 364.5, 180.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 68.0, 585.0, 224.0 ],
					"text" : "The syntax of the \"for\" loop is:\n   for [address variable 1] <index variable 1> in <llll 1>\n        [[address variable 2] <index variable 2> in <llll 2>\n        [...] ]\n   [with @<attribute name 1> <attribute value 1> [@<attribute name 2> <attribute value 2>] [...]]\n   [as <condition>]\n   repeat <body>\nwhere the lllls, attribute values, condition and body are expression of any complexity.\n\nThe general idea is that the \"for\" loop roughly behave like bach.iter: given one or more lllls, their elements (optionally alongside the respective addresses) are iteratively assigned to the given variables, for each element or set of elements the loop body is evaluated, and the value of the \"for\" loop is the last value of the body. The \"with\" clause allows setting some attributes to control the details of the parallel iteration of multiple lllls, and the \"as\" clause allows setting a condition to be checked before every iteration, and causing the iteration to terminate if false.",
