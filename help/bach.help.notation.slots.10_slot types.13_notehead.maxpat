...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 96.0, 303.0, 54.0 ],
					"style" : "",
					"text" : "All available noteheads are shown in the slot window. By hovering with the mouse on them, their short name is shown in the slot legend."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 73.0, 427.0, 155.833328 ],
					"pitcheditrange" : [ "null" ],
					"slotwinzoom" : 150.0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 240.0, 585.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Notehead slots can be shown as actual notehead changes via slot linkage techniques.\nSee #noteheads, #notehead+slot+linkage.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 567.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Slots of type \"notehead\" contain information about a non-standard or custom notehead associated with the note (or none, if the slot is empty). The notehead is stored as a symbol (tag).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, slotinfo, type, notehead",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
