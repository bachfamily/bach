...
,
					"text" : "bach.eval finditems($x1\\, 1\\, ($x\\, $y -> abs($x - $y) < 0.1)) @out m"
				}
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y -> abs($x - $y) < 0.1) \\; finditems($x1\\, 1\\, $closeEnough) @out m"
				}
...
,
					"text" : "bach.eval finditems($x1\\, 1) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, function, user, defined, argument, lambda, anonymous, finditems",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
