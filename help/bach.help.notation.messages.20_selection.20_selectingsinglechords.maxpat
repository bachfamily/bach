...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.5, 310.0, 278.0, 25.0 ],
					"style" : "",
					"text" : "Chord index is global, not measure-wise"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.5, 310.0, 111.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 1 any 8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 215.5, 279.0, 278.0, 25.0 ],
					"style" : "",
					"text" : "Last voice, first measure, third chord – rest!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.5, 252.5, 320.0, 25.0 ],
					"style" : "",
					"text" : "Select first chord of second measure (of first voice)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.5, 283.0, 100.0, 23.0 ],
					"style" : "",
					"text" : "sel chord -1 1 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.5, 255.5, 85.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 283.5, 347.0, 308.0, 123.333336 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.5, 146.5, 320.0, 40.0 ],
					"style" : "",
					"text" : "Negative indices are also allowed: this involutively selects last-but-one chord of second voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.5, 154.375, 107.0, 23.0 ],
					"style" : "",
					"text" : "select chord 2 -2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 155.5, 125.5, 231.0, 25.0 ],
					"style" : "",
					"text" : "Deselect fourth chord of first voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.5, 127.75, 99.0, 23.0 ],
					"style" : "",
					"text" : "unsel chord 1 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.5, 103.0, 231.0, 25.0 ],
					"style" : "",
					"text" : "Select fourth chord of second voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.5, 105.25, 85.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 2 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 185.5, 541.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can use the \"chord\" symbol with all the #sel, #unsel, #select messages:\nfor bach.roll: sel/unsel/select chord <voice_number> <chord_index>    \nfor bach.score: sel/unsel/select chord <voice_number> <measure_number> <chord_index>\nIf less arguments than expected are inserted, the first numbers will be assumed to be 1's.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 80.5, 218.0, 25.0 ],
					"style" : "",
					"text" : "Select fourth chord (of first voice)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 82.75, 74.0, 23.0 ],
					"style" : "",
					"text" : "sel chord 4"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 15.0, 347.0, 258.0, 123.333336 ],
					"pitcheditrange" : [ "null" ],
					"showstems" : 0,
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: sel, unsel, select, sel+voices",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, chord, index, position, single, path, sel, unsel, select, global, measure, measure-wise, any",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 607.0, 50.0 ],
					"style" : "",
					"text" : "You can also select a chord by specifying the path leading to it: which voice?, (for bach.score: which measure?), which chord? Chords are considered ordered by onset. This is handy if you have a sequence of chords and you want to retrieve a given one depending on its position in the list.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
