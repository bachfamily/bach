...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 54.5, 287.0, 25.0 ],
					"style" : "",
					"text" : "Quick way to set a tempo for the whole score"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 54.5, 162.0, 23.0 ],
					"style" : "",
					"text" : "cleartempi, addtempo (50)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 233.5, 186.0, 40.0 ],
					"style" : "",
					"text" : "Add a tempo with interpolation to the next"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 242.0, 149.0, 23.0 ],
					"style" : "",
					"text" : "addtempo 1 (1/4 60 0 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 208.5, 230.0, 25.0 ],
					"style" : "",
					"text" : "Add a tempo only in voices 2 and 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 236.0, 175.5, 332.0, 25.0 ],
					"style" : "",
					"text" : "add a 3/8 = 90 tempo at measure 3, with offset of 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 175.5, 149.0, 23.0 ],
					"style" : "",
					"text" : "addtempo 3 (3/8 90 1/4)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 208.5, 209.0, 23.0 ],
					"style" : "",
					"text" : "addtempo 2 (1/4 114) @voices 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.0, 143.5, 230.0, 25.0 ],
					"style" : "",
					"text" : "add a 3/8 = 72 tempo at measure 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 143.5, 128.0, 23.0 ],
					"style" : "",
					"text" : "addtempo 3 (3/8 72)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.5, 115.5, 275.0, 25.0 ],
					"style" : "",
					"text" : "Add a quarter = 60 tempo at the beginning "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.0, 85.5, 165.0, 25.0 ],
					"style" : "",
					"text" : "Delete all existing tempi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 116.5, 128.0, 23.0 ],
					"style" : "",
					"text" : "addtempo 1 (1/4 60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 451.0, 254.0, 152.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Also see #tempo+syntax",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 85.5, 70.0, 23.0 ],
					"style" : "",
					"text" : "cleartempi"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 7.0, 280.0, 578.0, 192.0 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: tempo+syntax, addchord",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Adding and deleting tempi",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, addchords, add, tempo, adding, offset, measure, append, set, delete, clear, tempi, cleartempi, addtempo, cleartempo, addtempi, interpolation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tempi can be added via \"addtempo\" messages.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
