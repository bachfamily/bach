...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"attr" : "playwhenlinearediting",
					"id" : "obj-6",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.5, 156.0, 209.0, 22.0 ],
					"style" : "",
					"text_width" : 146.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 254.214279, 388.0, 97.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.5, 134.0, 356.0, 54.0 ],
					"style" : "",
					"text" : "Turn this off if you don't want the automatic playback of entered notes (i.e. if you don't want notes' playout syntax to be sent out from playout outlet during linear editing)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.5, 236.0, 301.0, 123.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 592.5, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When in #linear+edit mode, by default inserted notes are immediately sent from the playout in standard #playout+syntax. In other words, they are \"played\" as soon as introduced.\nThis is handy in most situations, but if you need to disable, you can do that by turning the \"playwhenlinearediting\" attribute off.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 315.5, 236.0, 287.0, 123.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70909,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Playing while linear editing",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, linear, speedy, linearedit, auto, play, playwhenlinearediting, autoplay",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
