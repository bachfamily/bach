...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 149.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 490.0, 21.0 ],
					"text" : "At its simplest, the syntax of bach.eval's expressions are very similar to bach.expr's.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
