...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 428.0, 535.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "These attributes work in the exactly same way for bach.score, and also applies to notes entered in #linear+editing+mode.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 251.0, 108.0, 25.0 ],
					"style" : "",
					"text" : "Remove them"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 180.5, 168.0, 54.0 ],
					"style" : "",
					"text" : "Define a default set of slots for newly created notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 251.0, 117.0, 22.0 ],
					"style" : "",
					"text" : "defaultnoteslots null"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 244.0, 146.0, 359.0, 25.0 ],
					"style" : "",
					"text" : "Change the default markername (by default it is \"marker\")"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 146.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "defaultmarkername john"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 111.5, 247.0, 25.0 ],
					"style" : "",
					"text" : "Define a default velocity for new notes"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 180.5, 247.75, 49.0 ],
					"style" : "",
					"text" : "defaultnoteslots [ 1 [ 0. 4.586111 0. ] [ 0.375 116.769444 0. ] [ 0.5625 63.852778 0. ] [ 1. 0.352778 0. ] ] [ 3 1 4 5]"
				}

			}
, 			{
				"box" : 				{
					"attr" : "defaultvelocity",
					"id" : "obj-5",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 111.5, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 28.0, 290.0, 452.0, 131.0 ],
					"pitcheditrange" : [ "null" ],
					"showvelocity" : 1,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: velocity, marker+name, slot+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Default editing parameters",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, default, note, velocity, slot, content, marker, name, defaultvelocity, defaultmarkername, defaultnoteslots",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 33.0, 607.0, 65.0 ],
					"style" : "",
					"text" : "You can set some default parameters for newly created elements, namely:\n- a default velocity for newly created notes\n- some default slot content for newly created notes\n- a default name for newly created markers",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
