...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 6.0, 281.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 310.0, 156.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 253.0, 580.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Finally, articulations are handled in the same way both in bach.roll and in bach.score.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 212.0, 580.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Articulations font can be changed globally, via the \"articulationsfont\" attribute (see #articulationsfont), or locally for any custom defined articulation (see #custom+articulations).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 116.0, 605.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For your convenience, the 22th slot is already set up as an articulation slot linked with articulation display, with hotkey A. All you need to do is to open the slot window for a given note (press 'a' while the note is selected) and choose which articulations should be assigned to the note. To know more about articulation editing see #articulation+editing; in this section we will document how to display, insert articulations, and how to define custom articulations in adddition to the standard set of predefined articulations. These custom articulations are saved as part of the #header in the #gathered+syntax.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: articulation, define, assign, linkarticulationstoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The simplest way to define articulation is to assign them to notes via slot linkage techniques (see #slot+linkage). The idea is simple: you define a slot of type \"articulation\" and then link it to the articulations display via the \"linkarticulationstoslot\" attribute. (Incidentally, in this way, you might also have more than one articulation slot, and switch them instantaneously when changing the \"linkarticulationstoslot\" attribute). ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
