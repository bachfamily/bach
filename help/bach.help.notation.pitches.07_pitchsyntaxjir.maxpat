...
, 			{
				"box" : 				{
					...
					"text" : "Writing justly tuned intervals as ratios or commas",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, note, name, pitch, notename, pitches, just, intonation, justintonation, ji, ratio, interval, r",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
