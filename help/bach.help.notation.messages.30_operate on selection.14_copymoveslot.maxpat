...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 16.0, 65.0, 64.0, 23.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 156.0, 260.0, 25.0 ],
					"style" : "",
					"text" : "Copy slot 2 to slot 1 (deletes original)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 156.0, 85.0, 23.0 ],
					"style" : "",
					"text" : "moveslot 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.51532, 126.0, 241.0, 25.0 ],
					"style" : "",
					"text" : "Copy slot 1 to slot 10 (keeps original)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.0, 126.0, 91.0, 23.0 ],
					"style" : "",
					"text" : "copyslot 1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 98.0, 45.0, 23.0 ],
					"style" : "",
					"text" : "sel all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 318.0, 482.0, 36.0 ],
					"style" : "",
					"text" : "These messages also apply to bach.score and bach.slot as well (in this last case, no selection is needed)",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 14.0, 202.0, 423.0, 111.0 ],
					"pitcheditrange" : [ "null" ],
					"showvelocity" : 1,
					"slotwinzoom" : 150.0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, slot, moveslot, copyslot, move, copy",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "You can copy or move selected items' slots via the \"copyslot\" and \"moveslot\" messages:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
