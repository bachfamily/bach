...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 361.0, 124.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 188.0, 174.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 219.0, 385.0, 36.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 75.5, 209.0, 54.0 ],
...
, 			{
				"box" : 				{
					"code" : "$i := $fact := 1 ; while $i < $l1 repeat $fact := $fact * print($i := $i + 1) ",
					"fontname" : "Menlo Regular",
					"id" : "obj-4",
					"linecount" : 3,
					"maxclass" : "newobj",
...
,
					"text" : "bach.eval $i := $fact := 1 \\; while $i < $l1 repeat $fact := $fact * print($i := $i + 1) @out m"
				}
