...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.25, 174.0, 167.0, 21.0 ],
					"presentation_rect" : [ 244.5, 200.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "(see #slot+link+annotation)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 429.0, 275.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "These can be also defined via the sequence of attributes of the form \"link.....toslot\"",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.5, 231.0, 408.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "(see #articulations)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.5, 263.0, 520.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "(see #noteheads), or an integer slot containing the new ASCII or Unicode glyph number (see #slot+link+noteheadchar)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.5, 411.0, 220.0, 54.0 ],
					"style" : "",
					"text" : "When a slot is linked to a feature, such feature appears in the right bottom corner of the slot window"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -327.0, 365.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -327.0, 393.0, 197.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 323.0, 341.666656, 278.0, 109.333336 ],
					"pitcheditrange" : [ "null" ],
					"slotwinzoom" : 130.0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.75, 306.0, 495.5, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.5, 379.0, 221.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "by setting the font name inside a text slot (see #slot+link+noteheadfont)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.5, 334.0, 408.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.5, 203.5, 159.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 159.0, 135.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 160.0, 595.0, 253.0 ],
					"showhand" : 0,
					"text" : "– lyrics: must be associated to a text slot\n– annotation: a text placed over the chord, usually associated to a text slot\n– notecolor: this is the color of the notehead, and must be associated to an int, float or floatlist slot\n\n– articulations: articulations are handled via slot-linkage, linked with a slot of type \"articulation\".\n\n– notehead: you can change the character (glyph) of the notehead, by using a slot of type \"notehead\"\n\n\n– notesize: you can change the size of the note by adding a size percentage in a float slot\n\n– noteheadadjust: this is an additional horizontal and vertical offset for the notehead, and must be\n                   \n           \n– noteheadfont: you can change the notehead font \n\n\n",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 506.0, 585.0, 19.0 ],
					"style" : "",
					"text" : "See Also: lyrics, notecolor, noteheadad, articulation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, link, linkage, introduction, linkarticulationstoslot, linklyricstoslot, linknotecolortoslot, linknoteheadtoslot, linknotesizetoslot, linknoteheadadjusttoslot, linknoteheadfonttoslot, linkannotationtoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
