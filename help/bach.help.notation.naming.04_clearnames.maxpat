...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 214.0, 231.0, 173.0, 25.0 ],
					"style" : "",
					"text" : "Clear marker names only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 231.0, 128.0, 23.0 ],
					"style" : "",
					"text" : "clearnames markers"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 195.0, 234.0, 25.0 ],
					"style" : "",
					"text" : "Clear voice and chords names only"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 89.5, 537.0, 50.0 ],
					"style" : "",
					"text" : "You can clear the names of single categories only by adding one or more symbols after the \"clearname\" message. Symbols must be among the following ones: \"notes\", \"chords\", \"measures\", \"markers\", \"voices\".",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 195.0, 161.0, 23.0 ],
					"style" : "",
					"text" : "clearnames voices chords"
				}
