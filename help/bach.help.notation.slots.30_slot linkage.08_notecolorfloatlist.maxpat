...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.0, 339.0, 200.0, 40.0 ],
					"text" : "This note has no 1st slot content"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 400.0, 196.0, 69.0 ],
					"text" : "If you only assign 3 float values inside the slot, the alpha value is set to 1 by default"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 309.0, 215.0, 55.0 ],
					"text" : "Here there's a note, you can select it, only it is completely transparent!"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 62.0, 326.0, 526.0, 120.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -213.0, 281.0, 170.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -213.0, 252.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 81.0, 209.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 73.5, 257.0, 55.0 ],
					"text" : "We prepare a floatlist slot named \"RGBA\", and link the notecolor to the slot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 174.0, 280.0, 112.0 ],
					"text" : "RGBA 4-plets assign indeed values of red, green, blue and alpha (transparence) components. All these components go from 0 (color is absent) to 1 (color is fully present). The alpha component also ranges from 0 (completely transparent) to 1 (completely opaque)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 174.0, 293.0, 135.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can map noteheads to different color by means of an floatlist slot. In this case, bach expects 4 values to be interpreted as RGBA components, ranging from 0. to 1.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Changing note color with a floatlist slot",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: slot, link, linkage, appearance, change, changing, note, color, head, notehead, floatlist, linknotecolortoslot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
