...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 367.0, 190.0, 98.0 ],
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y\\, $e = $epsilon ||| 0 -> abs($x - $y) <= $e) \\; $epsilon = $x2 \\; finditems($x1\\, 1\\, $closeEnough) @out m"
				}
...
,
					"text" : "bach.eval $closeEnough = ($x\\, $y -> abs($x - $y) <= ($epsilon ||| 0)) \\; finditems($x1\\, 1\\, $closeEnough) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 117.5, 173.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, function, user, defined, passing, finditems, lambda",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
