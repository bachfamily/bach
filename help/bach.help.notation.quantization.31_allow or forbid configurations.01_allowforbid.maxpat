...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 151.0, 203.0, 50.0 ],
					"presentation_rect" : [ 168.0, 152.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "In this way, you can also work with a \"database\" of allowed or forbidden rhythms.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.0, 337.0, 124.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "see #regularity+box",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.0, 297.0, 133.0, 40.0 ],
					"style" : "",
					"text" : "It was the default, but we explicit it!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 384.0, 88.0, 21.0 ],
					"style" : "",
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 403.0, 179.0, 65.0 ],
					"style" : "",
					"text" : "The \"allow\" and \"forbid\" information is not saved within the object: they are messages, not attributes!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.0, 179.0, 206.0, 25.0 ],
					"style" : "",
					"text" : "Send a \"quantize\" to test them!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 119.0, 200.0, 25.0 ],
					"style" : "",
					"text" : "forbid the list of configurations"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 72.0, 243.0, 25.0 ],
					"style" : "",
					"text" : "allow just one of these configurations"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.5, 146.0, 196.0, 25.0 ],
					"style" : "",
					"text" : "don't forbid anything (default)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 62.0, 95.0, 217.0, 25.0 ],
					"style" : "",
					"text" : "allow all configurations (default)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 386.0, 299.0, 89.0, 23.0 ],
					"style" : "",
					"text" : "loadmess 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 146.0, 43.0, 23.0 ],
					"style" : "",
					"text" : "forbid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 122.0, 219.0, 23.0 ],
					"style" : "",
					"text" : "forbid (1/16 1/8 1/16) (1/16 1/16 1/8)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 99.0, 41.0, 23.0 ],
					"style" : "",
					"text" : "allow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 75.0, 339.0, 23.0 ],
					"style" : "",
					"text" : "allow (1/16 1/16 1/16 1/16) (1/16 1/16 1/8) (1/8 1/8) (1/4)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 179.0, 61.0, 23.0 ],
					"style" : "",
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 118.0, 209.0, 358.0, 87.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -159.0, 337.0, 99.0, 23.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 20.0, 364.0, 385.0, 104.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 299.0, 65.0, 23.0 ],
					"style" : "",
					"text" : "(2 4) (40)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 337.0, 385.0, 23.0 ],
					"style" : "",
					"text" : "bach.quantize @minimalunits 1/16 1/12 @smalleventshandling 0"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "If you know/define precisely the width for each box, you can assign a set of duration configurations which has to be satisfied or denied. This is done via the \"allow\" and \"forbid\" messages.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Allow or forbid configurations",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: quantize, quantization, allow, deny, configuration, forbid, database, rhythm",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
