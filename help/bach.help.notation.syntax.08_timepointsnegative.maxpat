...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 350.666687, 371.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Use the \"end\" keyword in #inscreenpos to point to the very end",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 374.0, 158.0, 25.0 ],
					"style" : "",
					"text" : "Show end at the end!!!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 375.0, 129.0, 23.0 ],
					"style" : "",
					"text" : "inscreenpos 1. end"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 318.666687, 319.0, 25.0 ],
					"style" : "",
					"text" : "Show beginning of last measure at half the domain"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 16.0, 406.0, 365.0, 63.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.5, 142.0, 234.0, 40.0 ],
					"style" : "",
					"text" : "Add a marker in first measure, first voice, 1/4 before the end."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.5, 96.0, 222.0, 40.0 ],
					"style" : "",
					"text" : "Add a marker after 1/4 of the one-but-last measure in last voice"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 58.0, 227.0, 40.0 ],
					"style" : "",
					"text" : "Add a marker at the beginning of last measure (voice 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.0, 443.666687, 169.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 16.0, 186.000031, 562.0, 117.666656 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: addmarker, inscreen, timepoint+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Negative timepoint syntax",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: syntax, time, point, timepoint, symbolic, absolute, numeric, position, negative, end, ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Timepoint syntax also supports negative numbers, as usual counting from the end.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
