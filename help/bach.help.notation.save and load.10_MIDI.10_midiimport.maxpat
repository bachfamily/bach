...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 309.5, 143.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 208.0, 143.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: data, read, midi, import, tracks2voices, chans2voices, channel, track, voice, file, message, open",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
