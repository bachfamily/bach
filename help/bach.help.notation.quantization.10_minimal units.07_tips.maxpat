...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.0, 182.0, 103.0, 25.0 ],
					"presentation_rect" : [ 332.0, 179.0, 0.0, 0.0 ],
					"text" : "...but do this!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 439.0, 185.0, 141.0, 19.0 ],
					"presentation_rect" : [ 439.0, 182.0, 0.0, 0.0 ],
					"text" : "minimalunits 1/24 1/32"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 143.0, 573.0, 36.0 ],
					"presentation_rect" : [ 47.0, 147.0, 0.0, 0.0 ],
					"text" : "There's no point in having a minimal unit which is multiple of another minimal unit: it just makes the algorithm slower! In such a case, just use the smallest one!",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 31.0, 611.0, 65.0 ],
					"text" : "The quantization algorithm is a box-wise algorithm. By default the boxes are the measure divisions. Please notice that if you choose awkward units (as 1/17), and you choose not to mix units within a box (mixingmode 0), there is no way that you can have a bunch of 1/17's quantizing a box whose width is 1/4. If you need to use such approximations, be sure that the box is wide enough!",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 179.0, 103.0, 25.0 ],
					"presentation_rect" : [ 166.0, 133.0, 0.0, 0.0 ],
					"text" : "Don't do this:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 182.0, 162.0, 19.0 ],
					"presentation_rect" : [ 42.0, 133.5, 0.0, 0.0 ],
					"text" : "minimalunits 1/24 1/8 1/32"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 159.0, 103.0, 357.0, 40.0 ],
					"text" : "1/17 is a very bad choice if your boxes have width 1/4 (which is the default for a 4/4 time signature"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 113.5, 141.0, 19.0 ],
					"presentation_rect" : [ 214.0, 87.0, 0.0, 0.0 ],
					"text" : "minimalunits 1/17 1/24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -138.0, 366.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 224.0, 60.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 128.0, 253.0, 436.0, 79.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 41.0, 367.0, 523.0, 90.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : "<none>",
					"voicespacing" : [ -4.8, 26.0 ],
					"vzoom" : 75.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 340.0, 193.0, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: quantization+box",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, minimal, units, minimalunits, tips",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
