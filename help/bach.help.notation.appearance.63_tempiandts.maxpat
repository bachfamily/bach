...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.0, 221.0, 353.0, 23.0 ],
					"text_width" : 134.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 149.0, 192.0, 153.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 311.0, 401.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 263.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 288.0, 141.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, tempo, tempi, time, signature, show, hide, showtempi, showtimesignatures, vertical, shift, position, adjust, tempovadj, showtempointerpline, interpolation, acc, rall, accelerando, rallentando, line, dashed, temposize, showtempointerp",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 183.5, 133.0, 40.0 ],
					"presentation_linecount" : 2,
					"text" : "Increase/decrease tempi size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 263.0, 148.0, 40.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 158.5, 230.5, 29.5, 230.5 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 158.5, 258.5, 29.5, 258.5 ],
					"source" : [ "obj-26", 0 ]
				}
