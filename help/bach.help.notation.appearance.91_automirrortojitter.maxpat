...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.5, 131.0, 181.0, 25.0 ],
					"presentation_rect" : [ 191.5, 115.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Remove link to jitter matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 45.0, 285.0, 128.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 93.0, 72.0, 22.0 ],
					"presentation_rect" : [ 53.0, 98.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "jitmatrix foo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 426.0, 494.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This works equally for bach.roll, bach.score and bach.slot.\nAlso see #notifypaint to see an example of bach-Jitter synchronization.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.5, 77.0, 238.0, 54.0 ],
					"style" : "",
					"text" : "Press this button, then modify the bach.score, and see how the jitter matrix stays in sync."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 133.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "jitmatrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 345.0, 301.0, 67.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 45.0, 168.0, 502.0, 107.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The #paintjit message draws the object onto a Jitter matrix once. However, if you need to keep the object in sync with that specific Jitter matrix, you should set the \"jitmatrix\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: notifypaint, manual+mirroring+jitter",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Automatic mirroring to Jitter matrix",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: appearance, mirror, display, jitter, matrix, paint, jit, draw, automatic, mirroring, sync, keep, jitmatrix",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
