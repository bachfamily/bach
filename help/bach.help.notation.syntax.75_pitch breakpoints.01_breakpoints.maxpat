...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 440.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.0, 278.0, 166.0, 55.0 ],
					"style" : "",
					"text" : "Add breakpoints as extras (separate syntax)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 281.0, 238.0, 55.0 ],
					"style" : "",
					"text" : "Adds a note with a breakpoint in the middle (gathered syntax)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 311.0, 303.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.0, 378.807343, 77.0, 22.0 ],
					"style" : "",
					"text" : "[[[C4] [G4]]]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 311.0, 406.0, 244.0, 62.333332 ],
					"pitcheditrange" : [ "null" ],
					"showdurations" : 1,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 8.0, 378.807343, 207.0, 88.192657 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 337.5, 335.0, 276.0, 38.0 ],
					"style" : "",
					"text" : "[breakpoints [[[[[ 0. 0. 0. ] [0.5 500 0.5] [1. 0. 0.]]] [[[ 0. 0. 0. ] [0.5 -200 0.1] [1. 0. 0.]]]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 335.0, 274.0, 38.0 ],
					"style" : "",
					"text" : "addchord 1 [0 [6000 1000 100 [breakpoints [0 0 0] [0.5 800 0.8] [1 460 -0.5]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 151.0, 600.0, 123.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"relative_x_position\" is a number between 0 and 1 specifying the position of the pitch breakpoint inside the note duration line (0 being the note head, 1 being the note tail). \nThe \"delta_cents\" is the difference (in midicents) of the breakpoint pitch and the base note pitch. \nThe slope is a number between -1 and 1 characterizing the slope of the segment of duration line before the given breakpoint (0 being linear): this slope is always output when notes are dumped, but can be omitted at input (and the default linear slope will be used. \nFinally, the last parameter represents the breakpoint velocity only if the slope is given and #breakpointshavevelocity attribute is set to 1.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 121.0, 588.0, 21.0 ],
					"style" : "",
					"text" : "[<relative_x_position> <delta_cents> <optional:slope> <optional:velocity>]",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 102.0, 593.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each one of the breakpoint sublists is in the form",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 81.0, 549.0, 21.0 ],
					"style" : "",
					"text" : "<BPT1_LLLL> <BPT2_LLLL> <BPT3_LLLL>...",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: syntax+extra, hierarchy, note+gathered+syntax, breakpointshavevelocity",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: syntax, breakpoint, pitch, breakpoint, break, point",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 571.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Pitch breakpoints are a propriety of each note. Their routing symbol is \"breakpoints\" (see #syntax+extra+gathered, #syntax+extra+separate). An llll specifying a breakpoint content is always in the form",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
