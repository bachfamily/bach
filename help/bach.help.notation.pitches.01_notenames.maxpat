...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 113.0, 449.0, 55.0 ],
					"text" : "Here we use pitches instead of midicents amounts. Notice that such pitches already contain a representation of the enharmonicity."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 169.0, 450.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 439.0, 600.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "To output pitches, see #pitch+output.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.0, 296.0, 226.0, 25.0 ],
					"text" : "You can mix pitches and midicents"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -138.0, 89.0, 91.0, 22.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 296.0, 258.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 8.0, 333.333344000000011, 297.0, 106.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.333312999999976, 399.600006000000008, 268.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Note names can be also shown in the upper legend: see #show+note+name",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: separate+syntax, gathered+syntax, show+note+name, pitch+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, note, name, pitch, middlecoctave, notename",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 604.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can input pitch information equivalently as number of midicents (say: 6100) or as actual pitches (say: C#5). This is valid both for gathered and for separate syntax. The second representation, on the other hand, is richer than the first one, since it already contains an enharmonicity information regarding the note. Such information is entered via the #pitch+syntax, supporting both equal-tempered and justly tuned pitches",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
