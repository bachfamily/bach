...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.0, 256.0, 189.0, 25.0 ],
					"style" : "",
					"text" : "Also select the added chord"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.5, 203.0, 260.0, 40.0 ],
					"style" : "",
					"text" : "Add a chord with two notes, breakpoints and some slot information"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.5, 111.0, 283.5, 54.0 ],
					"style" : "",
					"text" : "Optional argument before the chord gathered syntax is the voice number. Here we add the same chord at the second voice."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 295.0, 512.0, 166.666672 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 170.0, 189.0, 25.0 ],
					"style" : "",
					"text" : "Add a chord with two notes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.5, 68.0, 339.0, 40.0 ],
					"style" : "",
					"text" : "Add a chord having onset 1000 and a single note (pitch 6100 midicents, duration 1000 ms, velocity 50)"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: addchords, gluechord, sel",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Adding a chord in bach.roll",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, addchord, add, chord, adding, select, sel, selection, note",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 562.0, 36.0 ],
					"style" : "",
					"text" : "The \"addchord\" message is probably the the most important message in order to create content inside a bach.roll. It add a single chord, whose gathered syntax has to be given as argument.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
