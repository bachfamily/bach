...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.399994, 276.5, 229.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Also, some more weird stuff appears like some more levels of parentheses and some odd \"leveltype\" lllls... see #syntax+measure+level",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.399994, 233.0, 314.0, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.299988, 179.0, 173.100006, 69.0 ],
					"style" : "",
					"text" : "This is the sequence of chords, each represented with a gathered-syntax llll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 183.0, 380.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This syntax is for instance used by the #addmeasures message:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.400002, 206.5, 147.0, 40.0 ],
					"style" : "",
					"text" : "This is the measureinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.400002, 233.0, 73.0, 21.0 ],
					"style" : "",
					"text" : "_______"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -174.0, 293.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.400002, 276.5, 237.600006, 54.0 ],
					"style" : "",
					"text" : "When we dump the content, the measure also has a last numeric element (0), which is its flag."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 294.0, 75.0, 23.0 ],
					"style" : "",
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 448.0, 199.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 504.400024, 433.0, 108.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.399994, 386.0, 221.100006, 69.0 ],
					"style" : "",
					"text" : "We can explicitely as last numeric element a flag, for instance, saying that the measure is muted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.399994, 351.0, 353.0, 38.0 ],
					"style" : "",
					"text" : "addmeasures [[[[4 4] [60]] [1/2 [6000 100 0]] [1/2 [E4 100 0] [G4 100 0]] 2]]"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "[<MEASUREINFO_LLLL> <CHORD1_LLLL> <CHORD2_LLLL>... <flag>]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 254.0, 475.0, 23.0 ],
					"style" : "",
					"text" : "addmeasures [[[[4 4] [60]] [1/2 [6000 100 0]] [-1/4] [1/4 [E4 100 0] [G4 100 0]]]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 71.0, 603.0, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where #measureinfo is the information concerning time signatures and tempi, as well as possibly other information regarding barlines, widths and more. A specific help section is dedicated to the #measureinfo. Each chord llll must be in the #chord+gathered+syntax. A more general plain form involves a final numeric flag for the given note, representing the state of the measure (is it locked? or muted? or set as solo? or is it #rhythmic+tree locked?). See #syntax+flag to have a complete understanding of this number. In any case the form is:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.899994, 53.0, 409.0, 21.0 ],
					"style" : "",
					"text" : "[<MEASUREINFO_LLLL> <CHORD1_LLLL> <CHORD2_LLLL>...]"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: gathered+syntax, syntax+flag, gathered+syntax+chord, measureinfo, addmeasures, rhythmic+tree",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Plain gathered syntax for measures",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: gathered, syntax, measure, plain",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "In its simplest plain form, a bach.score measure is represented by",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 483.5, 254.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.399994, 402.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
