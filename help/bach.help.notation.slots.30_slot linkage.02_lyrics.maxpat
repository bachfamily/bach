...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 404.0, 597.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Or you can use slot 21 which is by default automatically associated with lyrics when you create a new object. is by default mapped on the L hotkey. See #lyrics+interface to know how to enter lyrics. See #lyrics+appearance to know more about some attributes handling the appearance, and #lyrics+advantage to have an example of usage.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 110.0, 259.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 152.0, 103.0, 23.0 ],
					"style" : "",
