...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "Try to send different domain, playhead cursor or loop messages with or without the \"notificationsformessages\" attribute being set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.0, 227.0, 76.0, 19.0 ],
					"text" : "showloop 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 227.0, 76.0, 19.0 ],
					"text" : "showloop 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 227.0, 100.0, 19.0 ],
					"text" : "loop 1000 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 91.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 201.0, 136.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 201.0, 93.0, 19.0 ],
					"text" : "inscreen 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 175.0, 119.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 175.0, 97.0, 19.0 ],
					"text" : "setcursor 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 119.0, 170.0, 19.0 ],
					"text" : "notificationsformessages $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 422.5, 138.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.714279, 422.5, 127.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Notifications are by default sent throught the playout when the playhead cursor, the domain or the loop region are changed via the interface. These notification may be extended also to the changes due to the arrival of incoming messages via the \"notificationsformessages\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
