...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 249.0, 488.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 301.0, 542.0, 148.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: marker+assignment",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Snapping markers to chords",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, marker, interface, shift, offset, snap, drag, snapping, chord, note, tail, magnetic",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
