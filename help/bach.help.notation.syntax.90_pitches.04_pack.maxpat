...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 34.0, 258.0, 54.0, 23.0 ],
					"style" : "",
					"text" : "E#4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.5, 71.0, 206.0, 40.0 ],
					"style" : "",
					"text" : "Degrees are 0 through 6 (corresponding to C through A)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 79.5, 32.0, 23.0 ],
					"style" : "",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 369.0, 142.0, 35.0, 23.0 ],
					"style" : "",
					"text" : "C#4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 368.0, 175.0, 112.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 210.0, 137.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Packing and unpacking pitches",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: syntax, note, name, pitch, pitches, create, break, build, pack, unpack, pitchpack, pitchunpack",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "To build/split a pitch from/into its degree, alteration and octave, use the following abstractions:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
