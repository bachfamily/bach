...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 96.0, 618.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In order to achieve this, we might use the linear editing capabilities of bach.roll or bach.score.\nIn linear editing (a bit like in Finale's speedy edit mode) notes are introduced one after the other, linearly (as the name suggests). In the following pages, we will explore how #linear+editing can help us write notes, change their duration or pitch, modify them, turn into grace notes, and much more. ",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 239.0, 301.0, 123.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 618.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "We have learned in the #edit+add+chord pages, at the beginning of the #edit subsection, how to insert music in a bach.roll (essentially by Cmd+clicking), or in bach.score (essentially by creating new measures, turning rests into notes, and splitting them). This approach is not always the most intuitive, especially if one needs to enter a sequence of notes or chords starting from a given point in time.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 428.0, 580.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "To exit linear editing mode, press Esc or simply click outside the staff.\nRefer to the other #linear+edit pages in order to know how to introduce music.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 364.0, 404.0, 65.0 ],
					"style" : "",
					"text" : "When you enter linear editing mode, the measure turns by default yellowish, and a vertical cursor appears, having an horizontal tick. The cursor represents the current time position (in bach.roll also see the legend), while the tick represents the current pitch position.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 309.0, 239.0, 288.0, 123.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7900,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: linear+edit, edit+add+chord",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "An introduction to linear editing",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, linear, speedy, fast, introduce, intro, linearedit, enter, exit, pitch, cursor",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.25, 165.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 579.5, 382.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
