...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 402.0, 274.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 380.0, 68.0, 23.0 ],
					"text" : "vzoom 75"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 380.0, 79.0, 23.0 ],
					"text" : "vzoom auto"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 299.0, 450.0, 284.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 307.416687000000024, 271.0, 65.0 ],
					"text" : "If you have N voices, N+1 values are expected, since they include the spacing before the first voice and the spacing after the last one.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 106.416672000000005, 237.0, 55.0 ],
					"text" : "...or you can explicitely assign values via the \"voicespacing\" attribute"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 235.0, 197.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 185.0, 31.0, 20.0 ],
					"text" : "150"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 257.0, 28.0, 20.0 ],
					"text" : "-50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 239.0, 19.0, 20.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 172.0, 101.0, 22.0 ],
					"text" : "0 17 17 17 17 17"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 148.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 195.0, 151.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 278.0, 178.0, 22.0 ],
					"text" : "voicespacing $1 $2 $3 $4 $5 $6"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 299.0, 88.416672000000005, 286.0, 315.833333333333371 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"text" : "Change space between voices",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: voice, space, spacing, position, change, voicespacing, offset",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 587.0, 21.0 ],
					"text" : "You have a couple of ways to change the voice vertical spacing.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 27.5, 305.0, 292.0, 305.0, 292.0, 78.416672000000005, 308.5, 78.416672000000005 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 119.5, 408.0, 292.0, 408.0, 292.0, 78.416672000000005, 308.5, 78.416672000000005 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 27.5, 408.0, 292.0, 408.0, 292.0, 78.416672000000005, 308.5, 78.416672000000005 ],
					"source" : [ "obj-22", 0 ]
				}
