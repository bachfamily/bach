...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "The measure parameters are applied to the given measure numbers for all voices. If you want them to be applied only to a given voice, use the llll (<measure_number> <voice_number>) instead.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 308.5, 216.0, 23.0 ],
					"text_width" : 168.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.0, 267.0, 216.0, 23.0 ],
					"text_width" : 168.0
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 9.0, 341.0, 582.0, 132.333327999999995 ],
					"pitcheditrange" : [ "null" ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, measure, parameter, set, setmeasureparameters, width, barline, number, shownumber, measureparameter",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
