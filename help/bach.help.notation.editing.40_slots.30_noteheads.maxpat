...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.5, 98.5, 341.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Only one notehead can be defined in a notehead slot",
...
, 			{
				"box" : 				{
					...
					"out" : "nn",
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 19.0, 61.0, 209.0, 96.5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Interface for notehead slots",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, slot, notehead",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
