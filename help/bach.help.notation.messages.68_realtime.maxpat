...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 101.0, 595.0, 50.0 ],
					"presentation_rect" : [ 6.0, 94.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "The best way to set up an object so that it will be as reactive as possible in realtime is to send a \"realtime 1\" message. This will: disable undo, hide the legend, disable the play highlighting.\nYou will always be able to revert to the previous conditions by sending a \"realtime 0\" message.",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "When using notation objects in real-time, one often needs the best performance.\nThis is not always the case by default: a certain number of cosy feature in bach.roll and bach.score are extremely handy, but also rather CPU- or memory-consuming. For instance, having undo steps is handy during editing, but useless (and harmful!) during real-time processing.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
