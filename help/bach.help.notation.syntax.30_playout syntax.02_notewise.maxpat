...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 298.0, 158.0, 22.0 ],
					"style" : "",
					"text_width" : 70.75
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.0, 241.0, 329.0, 54.0 ],
					"style" : "",
					"text" : "In notewise playmode, when you dump a chord, the information about each note is output, but keeping some elements regarding parent chords and voices"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 144.0, 609.5, 36.0 ],
					"style" : "",
					"text" : "note <voice_number> <MIDI_channel> [<chord_sym_duration> <chord_duration_ms> <chord_sym_onset_in_measure> <chord_onset_ms> [<NOTE_LLLL>] <chord_flag>]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 126.0, 471.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where the chord onset is in milliseconds. For bach.score:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 176.0, 609.5, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where \"chord_sym_duration\" is the symbolic duration of the chord, followed by: the duration in milliseconds, the symbolic onset of the chord inside its measure, and the global onset of the chord in milliseconds (with respect to the beginning of the score).\nIn both cases, \"NOTE_LLLL\" is the gathered syntax of the played note (see #note+gathered+syntax)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 453.0, 137.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 298.0, 251.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 251.5, 273.0, 23.0 ],
					"style" : "",
					"text" : "clearselection, sel somechord, dumpselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 108.0, 609.5, 21.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.428574, 453.0, 126.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.25, 298.0, 34.0, 23.0 ],
					"style" : "",
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: note+gathered+syntax, syntax+flag, playmode",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: playout, syntax, notewise",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 608.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If the #playmode is notewise, the information about each played note is output from the playout, exactly at the moment when such note is sequenced or dumped. The output llll, however, is not really the #gathered+syntax of the note, since it contains some more information about the chord and the voice, which is very handy to be retrieved at play time with no effort. Syntax depends on the notation object.\nFor bach.roll it is",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
