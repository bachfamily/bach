...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -138.0, 315.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.0, 262.0, 371.0, 40.0 ],
					"text" : "You don't need to put anything: minimal units are already dynamic, and will adapt to the incoming content's density"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 99.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 93.0, 125.0, 436.0, 133.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 316.0, 544.0, 134.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 262.0, 65.0, 19.0 ],
					"text" : "[4 4] [60]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 289.0, 193.0, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: minimalunits+dynamic",
...
, 			{
				"box" : 				{
					...
					"text" : "Adaptive minimal units are the default",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, minimal, units, minimalunits, dynamic, adaptive, default",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 611.0, 50.0 ],
					"text" : "A choice of minimal units is used by default when a new bach.quantize is created. This is meant to simplify your life, and let you have a a-bit-smarter-than-\"quick'n'dirty\" quantization, even without setting any parameter, just roughly putting a quantize object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 102.5, 122.5, 15.5, 122.5 ],
					"source" : [ "obj-5", 0 ]
				}
