...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 7.5, 129.0, 582.0, 120.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 569.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Rests do have slots too. You can use any #slot+interface command and any slot-based message such as #addslot, #eraseslot, #changenoteslot on rests too (if previously selected)",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: clearselection, sel+rest, selection, slot+hotkeys",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: slot, rest, articulation, fermata",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
