...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 170.0, 535.0, 50.0 ],
					"text" : "The modification function actually receives three arguments: the element to be modified, its address in the original llll and its address in the new llll—the two may be different, as the modification function can remove or insert new elements.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
,
					"text" : "bach.eval map($x1\\, ($a -> $a * 2)) @out m"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: evaluation, language, script, scripting, code, bell, built, in, function, map",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
