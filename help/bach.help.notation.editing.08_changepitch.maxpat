...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: edit, editing, interface, mouse, keyboard, note, pitch, change, interface, preserve, note, voice, prevent, change",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
