...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 382.642822000000024, 132.0, 312.0, 50.0 ],
									"text" : "bach.playkeys can also interpret custom markers used to notify start/end of command iteration (see \"command+notify\" in the Help center)"
								}
