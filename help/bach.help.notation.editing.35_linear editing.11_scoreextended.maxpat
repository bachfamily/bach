...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Linear editing: modifications in bach.score",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: editing, edit, interface, mouse, keyboard, linear, speedy, fast, number, assign, existing, rest, tie, grace, chord, navigate, delete, insert",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
