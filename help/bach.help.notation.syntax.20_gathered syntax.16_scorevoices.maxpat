...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.899994, 291.0, 75.0, 19.0 ],
					"text" : "dump body"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 452.0, 199.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.400024, 441.0, 108.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 343.400024, 372.0, 264.599976, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.400024, 280.0, 261.0, 92.0 ],
					"text" : "(((( 4 4 ) ( )) (1 ( 7000. 100 0 ))) ( ( ( 4 4 ) ( ) ) ( 1/4 ( 7100. 100 0)) ( 1/4 ( 7100. 100 0)) ( 1/4 ( 7100. 100 0)) ( 1/4 ( 7100. 100 0)))) ( ( ( ( 4 4 ) ( ) ) ( 1/4 ( 4700. 100 0)) ( 1/4 (4700. 100 0)) ( 1/4 ( 4700. 100 0 0 ) 0 ) ( 1/4 ( 4700. 100 0))) (((4 4) ( )) ( -1)) 4)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 167.0, 528.0, 55.0 ],
					"text" : "We introduce a whole new bach.score by sending a list of 2 voices, each containing a list of measure in llll gathered syntax (the \"score\" symbol at the beginning is optional)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 223.0, 534.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 330.0, 335.0, 118.666664 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.899994, 135.0, 471.0, 21.0 ],
					"text" : "(<MEASURE1_LLLL> <MEASURE2_LLLL> <MEASURE3_LLLL>... <flag>)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.899994, 53.0, 416.0, 21.0 ],
					"text" : "(<MEASURE1_LLLL> <MEASURE2_LLLL> <MEASURE3_LLLL>...)"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax, gathered+syntax+measure, syntax+flag",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Gathered syntax for voices in bach.score",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 345.400024, 442.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
