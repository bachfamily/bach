...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 288.0, 144.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 263.0, 133.0, 19.0 ],
					"text" : "addslot ( 5 10 20 30 )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 215.0, 94.0, 19.0 ],
					"text" : "addslot ( 5 1. )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 190.0, 90.0, 19.0 ],
					"text" : "addslot ( 5 1 )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 453.0, 155.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.5, 453.0, 169.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 407.0, 242.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.0, 150.0, 239.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 360.0, 175.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 385.0, 70.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot llll:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 321.0, 555.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The text must be wrapped inside a unique symbol, possibly using the double quotes if needed (mind #llll+double+quote).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 304.0, 70.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot text:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 242.0, 141.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot intlist or floatlist:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 173.0, 109.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot int or float: ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 53.0, 98.0, 21.0 ],
					"showhand" : 0,
					"text" : "– slot function: ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "The syntax of the slot content depends on the slot type. Here's the complete list (with some examples):",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
