...
,
		"rect" : [ 76.0, 44.0, 637.0, 319.0 ],
		"bglocked" : 0,
		"defrect" : [ 76.0, 44.0, 637.0, 319.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "When the inspector is open, you can navigate hierarchically between structures; all the needed commands\nare given at the bottom of each inspector window, so that if you have any doubt, just have a look at those key commands!",
					"linecount" : 3,
					"patching_rect" : [ 5.0, 234.0, 626.0, 48.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"spacingwidth" : 1.6,
					"voicenames" : [ "Foo", "Fee" ],
					"patching_rect" : [ 3.0, 45.0, 620.0, 184.0 ],
					"id" : "obj-15",
					"midichannels" : [ 1, 2 ],
					"popupmenuslots" : [  ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"varname" : "wclose",
					"text" : "clean, wclose",
					"patching_rect" : [ 215.0, 331.0, 81.0, 18.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 b \"Inspector As A Gadget\"",
					"patching_rect" : [ 215.0, 383.5, 233.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "thispatcher",
					"patching_rect" : [ 215.0, 356.0, 69.0, 20.0 ],
					"id" : "obj-51",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 211.0, 278.0, 245.0, 34.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolA",
					"text" : "tosymbol",
					"patching_rect" : [ 5.0, 365.0, 140.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 340.0, 145.0, 18.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerA",
					"text" : "t b b",
					"patching_rect" : [ 5.0, 315.0, 40.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "textbutton",
					"varname" : "textbuttonA",
					"patching_rect" : [ 5.0, 290.0, 151.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolB",
					"text" : "pcontrol",
					"patching_rect" : [ 480.0, 415.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependB",
					"text" : "prepend load",
					"patching_rect" : [ 480.0, 390.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolB",
					"text" : "tosymbol",
					"patching_rect" : [ 480.0, 365.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 340.0, 145.0, 18.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerB",
					"text" : "t b b",
					"patching_rect" : [ 480.0, 315.0, 40.0, 20.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "textbutton",
					"varname" : "textbuttonB",
					"patching_rect" : [ 480.0, 290.0, 151.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 224.5, 409.5, 206.5, 409.5, 206.5, 351.0, 224.5, 351.0 ]
				}
