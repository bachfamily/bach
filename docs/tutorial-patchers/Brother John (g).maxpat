...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.5, 517.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.5, 569.5, 183.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 g \"Brother John\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.5, 542.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 374.0, 283.0, 74.0 ],
					"style" : "",
					"text" : "In this case, the first tie is ignored, since there's no common note between the first two chords! The same thing happen for the tie between the two rests. On the other hand, the (0 1 0) sublist ties the secondo note of the chord (i.e. the E5) note."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 395.0, 341.0, 121.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 242.0, 197.0, 47.0 ],
					"style" : "",
					"text" : "pitches on chord notes will be ignore! So you can put everything! Our advice is to use the \"nil\" list"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 305.0, 318.0, 161.0, 22.0 ],
					"style" : "",
					"text" : "[ [ 1/8 1/8 -1/4 -1/8 1/8 1/4] ]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 283.0, 199.0, 87.0 ],
					"style" : "",
					"text" : "Defining a tie value for each chord (as we did in previous section) means that the whole chord will be tied/untied. But you can also define tie values note-by-note, as we did with the (0 1 0) sublist!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 293.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.0, 242.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.0, 265.0, 83.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 293.0, 255.0, 22.0 ],
					"style" : "",
					"text" : "[ [ [C5 E5 G5] D5 nil nil [A4 E5 G5] [E5 G5]] ]"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 190.0, 364.0, 265.0, 90.666664 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 304.0, 184.0, 114.0 ],
					"style" : "",
					"text" : "Since it doesn't make any sense to tie a rest, [bach.score] is intelligent enough to ignore your tie request, when it is referred to a rest. The same thing happens for notes that cannot be tied to any note of the next chord, as this example will clarify:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 459.0, 116.0, 201.0, 74.0 ],
					"style" : "",
					"text" : "It's really no more complicated than this... As you see, [bach.score] splits the rest into two or more rests (as this -5/16 case) if it is needed for better displaying."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 210.0, 189.0, 74.0 ],
					"style" : "",
					"text" : "To turn a single note into a rest, you can do it via the interface: select a note and press Backspace, or Cmd+click (mac) or Ctrl+click (win) on the note!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 87.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.0, 41.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.0, 64.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "t b b clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 91.0, 185.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 113.0, 189.0, 87.0 ],
					"style" : "",
					"text" : "Well, defining a rest is very easy: just put a minus before the duration of the rest! In such a way, all positive durations refer to notes, and all negative durations refer to rests:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 593.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 568.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 543.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 518.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "Brother John [h]",
					"varname" : "messageB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 596.0, 493.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 596.0, 468.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-124", 0 ],
					"midpoints" : [ 346.5, 293.5, 199.5, 293.5 ],
					"source" : [ "obj-122", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 335.0, 595.5, 317.0, 595.5, 317.0, 537.0, 335.0, 537.0 ],
					"source" : [ "obj-198", 0 ]
				}
