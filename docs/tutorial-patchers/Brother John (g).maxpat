...
,
		"rect" : [ 333.0, 44.0, 751.0, 493.0 ],
		"bglocked" : 0,
		"defrect" : [ 333.0, 44.0, 751.0, 493.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 325.5, 517.0, 81.0, 18.0 ],
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 325.5, 569.5, 183.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 325.5, 542.0, 69.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "In this case, the first tie is ignored, since there's no common note between the first two chords! The same thing happen for the tie between the two rests. On the other hand, the (0 1 0) sublist ties the secondo note of the chord (i.e. the E4) note.",
					"linecount" : 5,
					"numoutlets" : 0,
					"id" : "obj-146",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 454.0, 374.0, 283.0, 75.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 395.0, 341.0, 121.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 358.0, 246.0, 197.0, 48.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 305.0, 318.0, 161.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 550.0, 283.0, 199.0, 89.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 190.0, 293.0, 91.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-121",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.0, 247.0, 20.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 273.0, 270.0, 83.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "( ( (C4 E4 G4) D4 nil nil (A3 E4 G4) (E4 G4)) )",
					"numoutlets" : 1,
					"id" : "obj-123",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 289.0, 296.0, 255.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 4.0, 304.0, 184.0, 117.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 459.0, 116.0, 201.0, 75.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 4.0, 210.0, 189.0, 75.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 190.0, 87.0, 91.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 273.0, 64.0, 63.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 313.0, 91.0, 185.0, 18.0 ],
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"patching_rect" : [ 4.0, 113.0, 189.0, 89.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 427.0, 457.0, 185.0, 34.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 596.0, 593.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 596.0, 568.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 596.0, 543.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 596.0, 518.0, 140.0, 18.0 ],
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 596.0, 493.0, 40.0, 20.0 ],
					"numinlets" : 1,
					"hidden" : 1
				}
