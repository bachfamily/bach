...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 105.0, 653.0, 60.0 ],
					"style" : "",
					"text" : "Whereas it is true, indeed, that there is no way to explicitely tell how many beams a level should have (only there's a way to suggest that the level should have beamings), at the same time we have an attribute that helps us handling the conversion, guiding those \"suggestions\" to become real beamings: leveltobeam.\nThis attribute can assume three values:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 503.0, 296.0, 33.0 ],
					"style" : "",
					"text" : "Levels are perfectly allowed to share all the beams they can share."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.0, 315.0, 384.0, 74.0 ],
					"style" : "",
					"text" : "The algorithm will try to break one or more beams when a level starts or ends, but only if the level is a tuplet. The idea is that tuplets will have their own beam (e.g. the first tuplet has its own second beam). This is, on the other hand, no more true for non-tuplet levels, so the (1/16 1/16) level is no more \"isolated\" by broken beams"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 315.0, 274.0, 47.0 ],
					"style" : "",
					"text" : "The algorithm tries to assign a beam information for each level, i.e.: will try to break one or more beams when a level starts or ends."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 377.850006, 222.0, 24.0 ],
					"style" : "",
					"text" : "LEVELS CAN SHARE BEAMS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.0, 191.850006, 265.0, 24.0 ],
					"style" : "",
					"text" : "BREAK BEAMS AROUND TUPLETS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 195.0, 55.0, 20.0 ],
					"style" : "",
					"text" : "(default)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 191.850006, 252.0, 24.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.0, 470.333313, 255.0, 31.0 ],
					"style" : "",
					"text" : "treehandling = PROCESS\nleveltobeam = LEVELS CAN SHARE BEAMS"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 69.0, 402.0, 315.0, 99.333313 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 283.333313, 260.0, 31.0 ],
					"style" : "",
					"text" : "treehandling = PROCESS\nleveltobeam = BREAK BEAMS AROUND TUPLETS"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 353.0, 215.0, 315.0, 99.333313 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70911,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 283.333313, 255.0, 31.0 ],
					"style" : "",
					"text" : "treehandling = PROCESS\nleveltobeam = BREAK BEAMS AROUND LEVELS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 166.0, 465.0, 22.0 ],
					"style" : "",
					"text" : "((((1/24 1/24 1/24) 1/16 1/16) (1/16 (1/16 1/16) 1/16) (1/12 1/12 1/12) (1/8 1/8))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 18.0, 215.0, 315.0, 99.333313 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70911,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 597.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 649.5, 253.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 i \"Beams Through The Trees\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 224.0, 622.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 43.0, 653.0, 60.0 ],
					"style" : "",
					"text" : "It could be deceiving the fact that inside the rhythmic tree structure there's no way to explicitely assign a certain number of beams to a certain level. Yet bach is not an engraving software. The rhythmic tree, in its semplicity, has the advantage to be in charge both for beams and for tuplets. This, of course, has some drawbacks (you lose finer control on the engraving), but has some important advantages, first of all: simplicity."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 302.0, 7.74086, 210.0, 25.0 ],
					"style" : "",
					"text" : "- level to beam conversion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 680.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 655.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 630.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 605.0, 170.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 580.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 680.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 655.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 630.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 599.0, 605.0, 166.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 599.0, 580.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 599.0, 555.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 233.5, 675.5, 210.5, 675.5, 210.5, 617.0, 233.5, 617.0 ],
					"source" : [ "obj-198", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.580392, 0.121569, 0.121569, 0.396078 ],
