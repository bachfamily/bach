...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 152.0, 176.0, 20.0 ],
					"text" : "as before, but stop at 10000ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 276.0, 483.0, 87.0 ],
					"text" : "When a note is played, its \"content\" is output from the Playout. Its \"content\" is, actually, a list containing all the information about the chord (duration, onset, pitches, velocities...)\nThere are a few bach abstractions which are able to handle this information; the easiest one (when you just need to play some midi) is [bach.ezmidiplay]. This is the abstraction we have always used to play: it comverts the pitches, durations and velocities into midi messages, and plays them... yet a rough midi is not always enough, is it?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 103.0, 532.0, 20.0 ],
					"text" : "syntax in milliseconds: play starting from 5000ms (accepted both by roll and by score)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 79.0, 363.0, 20.0 ],
					"text" : "easy play/stop (or you can select the object and use the spacebar)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 77.0, 33.0, 18.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 125.0, 498.0, 20.0 ],
					"text" : "score-timepoint syntax: play from measure 3, after 1/4, in voice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 102.0, 63.0, 18.0 ],
					"text" : "play 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 77.0, 33.0, 18.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 182.0, 624.0, 91.666664 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 251.5, 472.0, 49.0, 20.0 ],
					"text" : "delay 0",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.5, 498.0, 81.0, 18.0 ],
					"text" : "clean, wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.5, 553.0, 228.0, 20.0 ],
					"text" : "linksections 0 1 a \"The Gift Of Synthesis\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 251.5, 525.5, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 535.0, 279.0, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 377.0, 32.0, 20.0 ],
					"text" : "So?",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 7.74086, 309.0, 25.0 ],
					"text" : "- play, then what?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 43.0, 630.0, 33.0 ],
					"text" : "We have learned in previous tutorials how to play a [bach.score] or a [bach.roll]. You have a few messages to handle a starting offset:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 508.0, 140.0, 20.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 483.0, 140.0, 20.0 ],
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 458.0, 140.0, 20.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 496.0, 408.0, 40.0, 20.0 ],
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 496.0, 383.0, 151.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 261.0, 579.0, 245.5, 579.0, 245.5, 520.5, 261.0, 520.5 ],
					"source" : [ "obj-198", 0 ]
				}
