...
,
		"rect" : [ 131.0, 46.0, 744.0, 553.0 ],
		"bglocked" : 0,
		"defrect" : [ 131.0, 46.0, 744.0, 553.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 139.0, 191.0, 91.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 367.0, 573.0, 81.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 367.0, 625.5, 183.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"hidden" : 1,
					"patching_rect" : [ 367.0, 598.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 404.0, 280.0, 271.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Pitches can be set either via their midicents (e.g. 6100), or via the symbolic note (e.g. C#4). 6000 is middle C (C4), and each semitone is 100 cents. So, for example, B4 will have 7100 cents.",
					"linecount" : 4,
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 404.0, 217.0, 278.0, 62.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 12.0, 176.0, 86.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 550.0, 353.0, 166.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 175.0, 198.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 348.0, 386.0, 155.0, 117.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 194.0, 386.0, 150.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 1.0, 354.0, 165.0, 75.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.0, 369.0, 310.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "( ((C4) (6200) (6400) (6000)) (6000 6200 6400 6000) )",
					"id" : "obj-415",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 126.0, 299.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 149.0, 211.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontface" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 336.0, 514.0, 259.0, 34.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 16.787033,
					"patching_rect" : [ 167.0, 7.74086, 253.0, 26.0 ]
				}
