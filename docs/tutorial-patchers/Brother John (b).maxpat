...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 191.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 573.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 625.5, 183.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 b \"Brother John\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 367.0, 598.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 280.0, 271.0, 47.0 ],
					"style" : "",
					"text" : "Velocities represent the dynamic of the notes, and they can go from 0 (minimum) to 127 (maximum), which is handy if you deal with midi."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 217.0, 320.0, 60.0 ],
					"style" : "",
					"text" : "Pitches can be set either via their midicents (e.g. 6100), or via the diatonic note name (e.g. C#5). 6000 is middle C (C5), and each semitone is 100 cents. So, for example, B5 will have 7100 cents."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 176.0, 86.0, 33.0 ],
					"style" : "",
					"text" : "here we send the final bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 175.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "here we assign velocities"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.0, 149.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "here we assign durations"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 125.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "here we assign pitches"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 192.0, 78.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 353.0, 166.0, 87.0 ],
					"style" : "",
					"text" : "Velocities and Midicents can thus be either note-attached or chord-attached (which means that they affect the whole chord). Durations can only be chord-attached."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.0, 175.0, 198.0, 22.0 ],
					"style" : "",
					"text" : "( ( 100 90 80 80 ) ( 100 90 80 80 ) )"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 352.289215, 37.0, 17.0 ],
					"style" : "",
					"text" : "meas2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 352.289215, 37.0, 17.0 ],
					"style" : "",
					"text" : "meas1",
					"textcolor" : [ 0.756863, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 352.0, 346.0, 20.0 ],
					"style" : "",
					"text" : "______________________   __________________",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 386.0, 155.0, 114.0 ],
					"style" : "",
					"text" : "The second measure only goes until \"level 3\" in depth: each chord is just a value and not an llll! When you do this, bach understands that you want to create a chord of 1 note, with the given parameter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 386.0, 150.0, 87.0 ],
					"style" : "",
					"text" : "The first measure goes until \"level 4\": each chord is in fact a list of values, each value for a note. We set the value of each note explicitely!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 354.0, 165.0, 74.0 ],
					"style" : "",
					"text" : "By the way, did you pay attention? To introduce the midicents, we used two different type of assignments for the two measures:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 183.0, 369.0, 310.0, 22.0 ],
					"style" : "",
					"text" : "( ((6000) (6200) (6300) (6000)) (6000 6200 6400 6000) )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 126.0, 299.0, 22.0 ],
					"style" : "",
					"text" : "( ((C5) (6200) (6400) (6000)) (6000 6200 6400 6000) )"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.0, 149.0, 211.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 72.0, 219.0, 329.0, 107.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 43.0, 716.0, 33.0 ],
					"style" : "",
					"text" : "If you want to have more parameter setted at once, it's very easy! Just send in the inlets all the list with all the parameters, and send the final bang ONLY when all parameters have been sent to the score! For example:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 7.74086, 253.0, 25.0 ],
					"style" : "",
					"text" : "- when John just woke up"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 653.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 628.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 603.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 578.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "Brother John (c)",
					"varname" : "messageB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 589.0, 553.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 376.5, 651.5, 358.5, 651.5, 358.5, 593.0, 376.5, 593.0 ],
					"source" : [ "obj-198", 0 ]
				}
