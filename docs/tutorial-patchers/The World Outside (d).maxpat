...
,
		"rect" : [ 246.0, 47.0, 538.0, 350.0 ],
		"bglocked" : 0,
		"defrect" : [ 246.0, 47.0, 538.0, 350.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 409.0, 178.0, 97.0, 20.0 ],
					"numinlets" : 3,
					"id" : "obj-20",
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 271.0, 45.0, 35.0, 18.0 ],
					"numinlets" : 2,
					"id" : "obj-22",
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The simple \"read\" command is perfectly able  to load a MIDI file inside a [bach.roll]. Clefs will be automatically choosen according to the pitch range. Tempo and time signature meta-events are shown via special markers, which for the moment are quite static and idle, but which will be more strongly connected, in future versions, with the bach.quantize object, in order to ease the quantization of the MIDI file. \nFor the time being, if you want to display the file on a measured score, you have to perform the quantization yourself.",
					"linecount" : 7,
					"fontsize" : 12.0,
					"patching_rect" : [ 12.0, 202.0, 498.0, 103.0 ],
					"numinlets" : 1,
					"id" : "obj-21",
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"preventedit" : [  ],
					"loop" : "null",
					"patching_rect" : [ 10.0, 71.0, 485.0, 101.0 ],
					"versionnumber" : 6999,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 183.0, 374.0, 81.0, 18.0 ],
					"numinlets" : 2,
					"id" : "obj-19",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 d \"The World Outside\"",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 183.0, 426.5, 214.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-198",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 183.0, 399.0, 69.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-90",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "I want to have a SCORE not a piano roll. How can I do that?",
					"linecount" : 2,
					"frgb" : [ 0.0, 0.168627, 0.67451, 1.0 ],
					"fontface" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 209.0, 307.0, 194.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 442.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-1",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 417.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-4",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 392.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-5",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 342.0, 40.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 317.0, 151.0, 20.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 383.0, 442.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-11",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 383.0, 417.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-12",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 383.0, 392.0, 140.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-13",
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 383.0, 342.0, 40.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-16",
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
					"patching_rect" : [ 383.0, 317.0, 151.0, 20.0 ],
					"numinlets" : 1,
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 192.5, 452.5, 174.5, 452.5, 174.5, 394.0, 192.5, 394.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-67", 0 ],
					"hidden" : 0,
					"midpoints" : [ 280.5, 66.5, 19.5, 66.5 ]
				}
