...
,
		"rect" : [ 46.0, 44.0, 771.0, 395.0 ],
		"bglocked" : 0,
		"defrect" : [ 46.0, 44.0, 771.0, 395.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "... et voila. \nThe only tiny-tiny issue is that all the slot values are \"wrong\", in the sense that they're obviously NOT automatically linked to the note pitch. Our big task is now to make the proper link, so that when we change a note, or a group of notes, the correspondance between pitch and frequency is never lost.",
					"linecount" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 479.0, 183.0, 248.0, 117.0 ],
					"id" : "obj-36",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"stafflines" : "5",
					"numoutlets" : 8,
					"patching_rect" : [ 6.0, 184.0, 471.0, 165.666672 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"vzoom" : 115.850822,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "One idea immediately jumps to our mind: we can use a slot to keep the frequency information for each note. If we are smart enough, we make it of type float, of a proper range, and we give it a \"Hz\" extension (representation). If we're even smarter, we know that we can keep some slot always in background, and we'll assign this slot as a background slot.",
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 94.0, 717.0, 48.0 ],
					"id" : "obj-33",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "clean, wclose",
					"numoutlets" : 1,
					"patching_rect" : [ 362.0, 625.0, 81.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 b \"Lambda Scores\"",
					"numoutlets" : 1,
					"patching_rect" : [ 362.0, 677.5, 198.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "thispatcher",
					"numoutlets" : 2,
					"patching_rect" : [ 362.0, 650.0, 69.0, 20.0 ],
					"id" : "obj-90",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 511.0, 371.0, 94.0, 20.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "As an example, suppose that you want to work with pitch and frequencies at the same time. So you might want to see the Hertz value of each pitch at every given moment on your [bach.roll] or your [bach.score]. This could be very common and useful, for instance when dealing with spectral musical content.",
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 43.0, 711.0, 48.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "prepend load",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 470.0, 140.0, 20.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "tosymbol",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 445.0, 140.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "t b b",
					"numoutlets" : 2,
					"patching_rect" : [ 5.0, 395.0, 40.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"patching_rect" : [ 5.0, 370.0, 151.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"outlettype" : [ "", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"numoutlets" : 1,
					"patching_rect" : [ 616.0, 495.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend load",
					"numoutlets" : 1,
					"patching_rect" : [ 616.0, 470.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "tosymbol",
					"numoutlets" : 1,
					"patching_rect" : [ 616.0, 445.0, 140.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "t b b",
					"numoutlets" : 2,
					"patching_rect" : [ 616.0, 395.0, 40.0, 20.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ],
					"numoutlets" : 3,
					"patching_rect" : [ 616.0, 370.0, 151.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"outlettype" : [ "", "", "int" ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 371.5, 703.5, 353.5, 703.5, 353.5, 645.0, 371.5, 645.0 ]
				}
