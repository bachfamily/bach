...
,
		"rect" : [ 217.0, 44.0, 742.0, 519.0 ],
		"bglocked" : 0,
		"defrect" : [ 217.0, 44.0, 742.0, 519.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 325.5, 551.0, 81.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 325.5, 603.5, 183.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 325.5, 576.0, 69.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 47.0, 142.0, 33.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 335.0, 39.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.0, 335.0, 39.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Actually, a lot of information can come out from the playout outlet. You see some weird \"cursor\" message, or \"domain\" messages in the Max window, don't you? But just lllls starting with \"note\" or \"chord\" refer to note or chord information! And those are the only lllls which [bach.unpacknote] considers.",
					"linecount" : 4,
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 388.0, 449.0, 62.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 552.0, 262.0, 107.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Have a look at each outlet of [bach.unpacknote]!",
					"linecount" : 3,
					"id" : "obj-187",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 615.0, 329.0, 110.0, 48.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 3,
					"patching_rect" : [ 508.0, 409.0, 169.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 577.0, 355.0, 32.5, 20.0 ],
					"outlettype" : [ "int" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 1,
					"patching_rect" : [ 508.0, 383.0, 88.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 508.0, 440.0, 169.0, 20.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 508.0, 360.0, 41.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 508.0, 337.0, 41.0, 20.0 ],
					"outlettype" : [ "float" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 222.0, 67.0, 34.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 9,
					"patching_rect" : [ 508.0, 307.0, 127.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 508.0, 283.0, 46.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "[bach.score] is not a midi output object, nor a MSP object. All he does, when a play message is received, is to dump out a specific outlet (named Playout) all the information regarding the played chords and notes. This information can be organized in a simple way via the [bach.unpacknote] abstraction.",
					"linecount" : 5,
					"id" : "obj-176",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 310.0, 357.0, 75.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 255.0, 174.0, 48.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 142.0, 33.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 629.0, 129.0, 72.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 107.0, 446.0, 34.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 42.0, 714.0, 62.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.0, 481.0, 154.0, 34.0 ],
					"fontface" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 587.0, 619.0, 140.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 587.0, 594.0, 140.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 587.0, 569.0, 140.0, 20.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 587.0, 544.0, 140.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 587.0, 519.0, 40.0, 20.0 ],
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
					"hidden" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 544.5, 330.5, 586.5, 330.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 531.0, 334.5, 552.0, 334.5 ]
				}
