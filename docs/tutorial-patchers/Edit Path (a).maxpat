...
,
		"rect" : [ 37.0, 44.0, 713.0, 417.0 ],
		"bglocked" : 0,
		"defrect" : [ 37.0, 44.0, 713.0, 417.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "When undo is turned off, no warnings like \"Can't undo\" or \"Can't redo\" will appear in the Max window",
					"linecount" : 4,
					"numoutlets" : 0,
					"id" : "obj-31",
					"fontname" : "Arial",
					"patching_rect" : [ 539.0, 251.0, 149.0, 62.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<< you are allowed to have 50 undo steps",
					"numoutlets" : 0,
					"id" : "obj-29",
					"fontname" : "Arial",
					"patching_rect" : [ 122.0, 165.0, 308.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<< undo is turned off",
					"numoutlets" : 0,
					"id" : "obj-28",
					"fontname" : "Arial",
					"patching_rect" : [ 132.0, 187.0, 308.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<< infinite undo steps! (beware, this can take memory...)",
					"numoutlets" : 0,
					"id" : "obj-27",
					"fontname" : "Arial",
					"patching_rect" : [ 149.0, 209.0, 308.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 209.0, 105.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 187.0, 99.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "maxundosteps 50",
					"numoutlets" : 1,
					"id" : "obj-23",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 16.0, 165.0, 105.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The first thing you want to know about is probably the undo system. If you need to turn it off for some reason (for instance for pedagogical purposes), you can modify the \"maxundosteps\" attribute:",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-21",
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 120.0, 697.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"bgslots" : [  ],
					"popupmenuslots" : [  ],
					"patching_rect" : [ 10.0, 253.0, 526.0, 120.0 ],
					"out" : "nnnnnnn",
					"voicenames" : [ "(", ")" ],
					"numvoices" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 429.0, 81.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 0 1 a \"Edit Path\"",
					"numoutlets" : 1,
					"id" : "obj-198",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 481.5, 163.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 248.0, 454.0, 69.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "- or how to make musical elements untouchable",
					"numoutlets" : 0,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.0, 517.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.0, 492.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.0, 467.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 558.0, 442.0, 140.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 558.0, 417.0, 40.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 558.0, 392.0, 151.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 257.5, 507.5, 239.5, 507.5, 239.5, 449.0, 257.5, 449.0 ]
				}
