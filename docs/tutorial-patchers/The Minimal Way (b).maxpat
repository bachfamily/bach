...
,
		"rect" : [ 213.0, 44.0, 925.0, 515.0 ],
		"bglocked" : 0,
		"defrect" : [ 213.0, 44.0, 925.0, 515.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 b \"The Minimal Way\"",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Select the score and press spacebar to play!",
					"patching_rect" : [ 497.0, 460.0, 247.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 746.0, 460.0, 97.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"numinlets" : 3,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "We apply the same algorithm to each parameter: we just repeat the measure-content (which is at depth = 1). We just have to be careful to unwrap it before repeating and re-wrap it afterwards (which is done automatically by @unwrap 1).",
					"linecount" : 9,
					"patching_rect" : [ 743.0, 112.0, 167.0, 131.0 ],
					"id" : "obj-77",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess clear",
					"patching_rect" : [ 32.0, 234.0, 91.0, 20.0 ],
					"id" : "obj-75",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t l clear",
					"patching_rect" : [ 430.0, 231.0, 49.0, 20.0 ],
					"id" : "obj-74",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.repeat 4",
					"patching_rect" : [ 643.0, 182.0, 84.0, 20.0 ],
					"id" : "obj-72",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 430.0, 160.0, 232.0, 20.0 ],
					"id" : "obj-73",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.repeat 4",
					"patching_rect" : [ 502.0, 217.0, 84.0, 20.0 ],
					"id" : "obj-70",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.mapelem @maxdepth 1 @unwrap 1",
					"patching_rect" : [ 289.0, 195.0, 232.0, 20.0 ],
					"id" : "obj-71",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.repeat 4",
					"patching_rect" : [ 246.0, 229.0, 84.0, 20.0 ],
					"id" : "obj-66",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.mapelem @maxdepth 1 @unwrap 1",
					"patching_rect" : [ 33.0, 207.0, 232.0, 20.0 ],
					"id" : "obj-62",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 7.0, 144.0, 20.0, 20.0 ],
					"id" : "obj-60",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< outlets of subpatch are:\n        entire score, measures, cents, durations",
					"linecount" : 2,
					"patching_rect" : [ 268.0, 114.0, 342.0, 34.0 ],
					"id" : "obj-56",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< we have encapsulated fragment, doubleclick to see it!",
					"patching_rect" : [ 106.0, 100.0, 320.0, 20.0 ],
					"id" : "obj-55",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 7.0, 99.0, 98.0, 20.0 ],
					"id" : "obj-53",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
,
						"rect" : [ 25.0, 69.0, 369.0, 414.0 ],
						"bglocked" : 0,
						"defrect" : [ 25.0, 69.0, 369.0, 414.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 145.25, 365.0, 25.0, 25.0 ],
									"id" : "obj-4",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : ""
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 113.5, 365.0, 25.0, 25.0 ],
									"id" : "obj-2",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : "Durations"
...
, 							{
								"box" : 								{
									...
									"versionnumber" : 6750,
									"patching_rect" : [ 50.0, 100.0, 273.0, 204.0 ],
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 81.75, 365.0, 25.0, 25.0 ],
									"id" : "obj-52",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : "Measures"
...
, 			{
				"box" : 				{
					...
					"slotminimumwindowwidth" : 100.0,
					"versionnumber" : 6750,
					"patching_rect" : [ 7.0, 261.0, 864.0, 196.0 ],
					"syncopationposdurratio" : 4.5,
					"voicespacing" : [ 0.0, 26.0, 26.0, 26.0 ],
					"id" : "obj-47",
					"breakpointshavevelocity" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 13,
					"patching_rect" : [ -605.0, 63.0, 619.0, 184.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Hey, our enharmonic equivalents are NOT preserved...",
					"frgb" : [ 0.0, 0.168627, 0.67451, 1.0 ],
					"patching_rect" : [ 467.0, 489.0, 301.0, 20.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "- pure repetitions",
					"patching_rect" : [ 216.0, 7.74086, 309.0, 26.0 ],
					"id" : "obj-50",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The first thing we might want to do is to repeat this measure a certain number of times. This shouldn't be that hard. We can work it out either working with the separate inlets, or directly with the \"Whole Score\" gathered data. Yet, we choose to go the first way, since it's much more general, and we will modify it in the next sections.",
					"linecount" : 2,
					"patching_rect" : [ 3.0, 43.0, 898.0, 34.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 540.0, 140.0, 18.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerA",
					"text" : "t b b",
					"patching_rect" : [ 5.0, 515.0, 40.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolB",
					"text" : "pcontrol",
					"patching_rect" : [ 770.0, 615.0, 140.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependB",
					"text" : "prepend load",
					"patching_rect" : [ 770.0, 590.0, 140.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolB",
					"text" : "tosymbol",
					"patching_rect" : [ 770.0, 565.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 770.0, 540.0, 140.0, 18.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerB",
					"text" : "t b b",
					"patching_rect" : [ 770.0, 515.0, 40.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "textbuttonB",
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
					"patching_rect" : [ 770.0, 490.0, 151.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 255.5, 253.0, 338.0, 253.0, 338.0, 199.0, 255.5, 199.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 0.309804 ],
					"midpoints" : [ 511.5, 241.0, 594.0, 241.0, 594.0, 186.0, 511.5, 186.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 0.309804 ],
					"midpoints" : [ 652.5, 206.0, 735.0, 206.0, 735.0, 151.0, 652.5, 151.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-47", 0 ],
					"hidden" : 0,
					"midpoints" : [ 469.5, 255.5, 16.5, 255.5 ]
				}
