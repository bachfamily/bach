...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.5, 476.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.5, 528.5, 180.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 f \"Brother John\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.5, 501.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 270.0, 243.0, 33.0 ],
					"style" : "",
					"text" : "[bach.score] has algorithms to split the 5/16 duration into two tied musical symbols"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 394.0, 258.0, 33.0 ],
					"style" : "",
					"text" : "2. Writing 2/16 is exactly the same as writing 1/8, since bach has consistent rational support"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 360.0, 258.0, 33.0 ],
					"style" : "",
					"text" : "1. When you don't define any pitch, the middle C pitch is used by default"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 302.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 258.0, 262.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 258.0, 285.0, 99.0, 22.0 ],
					"style" : "",
					"text" : "t b b clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 182.0, 92.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 441.0, 340.0, 258.0, 20.0 ],
					"style" : "",
					"text" : "From this example we learn two more things:"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 175.0, 340.0, 265.0, 90.666664 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 270.0, 163.0, 141.0 ],
					"style" : "",
					"text" : "There are cases, nevertheless, in which ties are automatically assigned automatically! In fact, [bach.score] doesn't take for granted all the stuff you input, but he reanalize it and make the musical writing as clear as possible. So, if for instance you input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 108.0, 156.0, 33.0 ],
					"style" : "",
					"text" : "here we assign pitches via the note names!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 134.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 182.0, 115.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "t b b b clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 33.0, 169.0, 466.0, 91.666664 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 70911,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 542.0, 118.0, 139.0, 74.0 ],
					"style" : "",
					"text" : "here we set a tie between the last note of first measure and the first note of second measure"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 45.0, 686.0, 47.0 ],
					"style" : "",
					"text" : "You can assign ties by telling [bach.score] which note has to be tied. The syntax is not that different from the velocity parameter (that you already met), except from the fact that you don't assign a number from 0 to 127, but only a number which can be 0 or 1. A 1 means that the note has to be tied to the next one; a 0 means that the note has no tie starting from it."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 471.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 446.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 569.0, 571.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 569.0, 546.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 569.0, 521.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 569.0, 471.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 569.0, 446.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 227.5, 138.5, 415.5, 138.5 ],
					"source" : [ "obj-62", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.117647, 0.0, 1.0, 1.0 ],
					"destination" : [ "obj-57", 0 ],
					"midpoints" : [ 245.5, 136.5, 42.5, 136.5 ],
					"source" : [ "obj-62", 3 ]
				}
