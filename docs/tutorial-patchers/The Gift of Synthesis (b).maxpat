...
,
		"rect" : [ 163.0, 44.0, 653.0, 413.0 ],
		"bglocked" : 0,
		"defrect" : [ 163.0, 44.0, 653.0, 413.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The [bach.unpacknote] abstraction provides you all the information you may need about the chord which is being played. With this information, one can build his own synthesizing system!",
					"linecount" : 6,
					"patching_rect" : [ 447.0, 292.0, 201.0, 89.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 437.415558, 260.0, 102.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print Slots",
					"patching_rect" : [ 348.506165, 260.0, 64.0, 20.0 ],
					"id" : "obj-42",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 304.276764, 285.0, 101.0, 20.0 ],
					"id" : "obj-41",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print Graphic",
					"patching_rect" : [ 260.047363, 308.0, 79.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Midichannel",
					"patching_rect" : [ 319.990723, 333.0, 75.0, 20.0 ],
					"id" : "obj-22",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 392.735596, 333.0, 50.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Start tie?",
					"patching_rect" : [ 154.556122, 340.0, 59.0, 20.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Duration (ms)",
					"patching_rect" : [ 84.228638, 314.0, 83.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Velocity",
					"patching_rect" : [ 68.84449, 286.0, 52.0, 20.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 215.817963, 339.0, 20.0, 20.0 ],
					"id" : "obj-29",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "int" ]
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 171.588562, 314.0, 50.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 127.359161, 286.0, 50.0, 20.0 ],
					"id" : "obj-31",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 83.129761, 259.0, 50.0, 20.0 ],
					"id" : "obj-33",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 83.129761, 233.0, 373.0, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 9,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 79.0, 85.0, 560.0, 34.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 43.0, 91.0, 33.0, 18.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "play",
					"patching_rect" : [ 6.0, 91.0, 33.0, 18.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "wclose",
					"text" : "delay 0",
					"patching_rect" : [ 251.5, 481.0, 49.0, 20.0 ],
					"id" : "obj-44",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "clean, wclose",
					"patching_rect" : [ 251.5, 507.0, 81.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 251.5, 562.0, 228.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "thispatcher",
					"patching_rect" : [ 251.5, 534.5, 69.0, 20.0 ],
					"id" : "obj-51",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 2.0, 2.924051, 255.0, 32.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "To start to build your own playing system, the first abstraction you might want to meet is mister [bach.unpacknote] (if you look carefully, you'll realize that there's a mister [bach.unpacknote] inside doctor [bach.ezmidiplay])\nIf yo",
					"linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolA",
					"text" : "pcontrol",
					"patching_rect" : [ 5.0, 513.0, 140.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependA",
					"text" : "prepend load",
					"patching_rect" : [ 5.0, 488.0, 140.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolA",
					"text" : "tosymbol",
					"patching_rect" : [ 5.0, 463.0, 140.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 438.0, 141.0, 18.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerA",
					"text" : "t b b",
					"patching_rect" : [ 5.0, 413.0, 40.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolB",
					"text" : "pcontrol",
					"patching_rect" : [ 498.0, 513.0, 140.0, 20.0 ],
					"id" : "obj-9",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependB",
					"text" : "prepend load",
					"patching_rect" : [ 498.0, 488.0, 140.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolB",
					"text" : "tosymbol",
					"patching_rect" : [ 498.0, 463.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 438.0, 140.0, 18.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerB",
					"text" : "t b b",
					"patching_rect" : [ 498.0, 413.0, 40.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
