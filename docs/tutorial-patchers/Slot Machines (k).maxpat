...
,
		"rect" : [ 151.0, 44.0, 710.0, 456.0 ],
		"bglocked" : 0,
		"defrect" : [ 151.0, 44.0, 710.0, 456.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Tip: Upper case letters are valid as well as hotkeys for slots! (but avoid v and V, reserved for selection dump)",
					"linecount" : 3,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 67.0, 227.0, 48.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Once again, consider that units are just handy for the display, but they're neither output nor considered anywhere else! Which means: you're telling [bach.roll] that you're using decibels, [bach.roll] just writes it down, but cannot understand what \"decibel\" means!",
					"linecount" : 5,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 331.0, 301.0, 75.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "(By the way: we're using the @textdecayfactor attribute of [bach.tree] to shrink the bottom tree leaves...)",
					"linecount" : 5,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 529.0, 162.0, 150.0, 75.0 ],
					"id" : "obj-25",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 48.0, 162.0, 479.0, 97.0 ],
					...
					"whole_tree_data_0000000000" : [ "(", "slotinfo", "(", 1, "(", "name", "staticfilter", ")", "(", "key", "f", ")", "(", "width", 120, ")", "(", "range", -120, 10, ")", "(", "domain", 0, 22500, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, -1075838976, ")", "(", "domainslope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1071644672, ")", "(", "representation", "Hz", "dB", ")", ")", ")" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 121.0, 450.0, 32.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The (representation...) attribute allows to define units of measurement for the horizontal and vertical axis. If only one unit is defined, it is considered to be the unit of the vertical axis.",
					"linecount" : 4,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 261.0, 285.0, 62.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 73.0, 401.0, 32.0 ],
					"id" : "obj-58",
					"fontname" : "Arial",
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"versionnumber" : 6750,
					"bgslots" : [  ],
					"voicespacing" : [ -7.809525, 14.714285 ],
					"zoom" : 34.960938,
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 5.0, 264.0, 382.0, 136.357147 ],
					"id" : "obj-27",
					"automessage" : [  ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 472.0, 81.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 k \"Slot Machines\"",
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 524.5, 189.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 497.0, 69.0, 20.0 ],
					"id" : "obj-90",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 413.0, 231.0, 34.0 ],
					"id" : "obj-61",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "- representations and units",
					"fontsize" : 16.787033,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "We can display also units of measurement, by using a \"representation\" attribute for the slotinfo:",
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 40.0, 675.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 481.0, 140.0, 18.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 556.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 531.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 506.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 481.0, 140.0, 18.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"numinlets" : 2,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 555.0, 456.0, 40.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 555.0, 431.0, 151.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 219.5, 550.5, 201.5, 550.5, 201.5, 492.0, 219.5, 492.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 14.5, 157.5, 57.5, 157.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 0 ],
					"hidden" : 0,
					"midpoints" : [ 36.5, 157.0, 57.5, 157.0 ]
				}
