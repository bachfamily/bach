...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"bgcolor" : [ 0.530863, 0.695123, 0.866667, 1.0 ],
					"fontname" : "Arial",
					"fontsize" : 13.0,
					"id" : "obj-72",
					"maxclass" : "message",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 202.0, 198.0, 55.0 ],
					"text" : "Here we prevent the editing/usage of a lot of stuff!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 252.5, 219.0, 112.0 ],
					"text" : "Also notice that this mechanism is pretty powerful, and is much more than a \"note\" object: you can easily display a sequence of notes (e.g. a series) and allow the user only to change their pitches, but not their onsets."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 423.0, 269.0, 316.0, 90.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 43.0, 778.0, 108.0 ],
					"text" : "Editing is a complex and powerful task in bach. Not only you have easy ways to edit basic stuff (such as pitches, velocities, onsets), but you also have direct interface ways to edit most of the additional content (such as markers, slots...). On the top of that, users can do much more: they can zoom, they can dilate the content, they can move the scrollbar, they can open the inspector...\nOne might not want to allow the user to do some of this stuff. The \"preventedit\" attribute is still what you need.\nIn the previous examples, user could treat the bach.roll object to display a single note. Yet one could be still able to Alt+click to create a new marker. We don't want a marker in a simple pseudo-\"note\" object! So we simply add the \"marker\" symbol in the preventedit attribute. And so on: for any interaction, there's one symbol. See #complete+preventedit for more information about all of them!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 178.0, 709.0, 21.0 ],
					"text_width" : 84.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 160.0, 128.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 2.0, 220.0, 193.0, 115.459473 ],
					"pitcheditrange" : "null",
					"preventedit" : [ "(", "note", "create", "delete", "onset", ")", "marker", "dilationrectangle", "inspector", "popup", "slotinfo", "lyrics", "loop", "zoom" ],
					"showdurations" : 0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 401.0, 81.0, 18.0 ],
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 453.5, 247.0, 20.0 ],
					"text" : "linksections 1 1 f \"From OpenMusic to bach\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 426.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 380.0, 326.0, 21.0 ],
					"text" : "Cool. I'll try to connect the entrance of my house with a",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 7.74086, 317.0, 25.0 ],
					"text" : "- more interface"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 529.0, 140.0, 18.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 479.0, 140.0, 18.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolA"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 429.0, 40.0, 18.0 ],
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 404.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 529.0, 140.0, 18.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 504.0, 140.0, 18.0 ],
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 479.0, 140.0, 18.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 636.0, 429.0, 40.0, 18.0 ],
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 636.0, 404.0, 151.0, 20.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 208.5, 479.5, 190.5, 479.5, 190.5, 421.0, 208.5, 421.0 ],
					"source" : [ "obj-198", 0 ]
				}
