...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 119.0, 728.0, 20.0 ],
					"text" : "In this case, very well, let's see how to correctly package things in a standalone application for it to work properly."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 45.0, 516.0, 67.0 ],
					"text" : "If you are still reading this tutorial, it means that \nyou have Max < 8.1.0 and/or bach < 0.8.1\n(otherwise things would be automatically handled for you)",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 183.060973999999987, 273.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 214.060973999999987, 746.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "linksections 1 1 b \"Standalone Applications\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 7.74086, 447.0, 25.0 ],
					"text" : "- if you are still reading you have an old Max or bach "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 503.0, 140.0, 22.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 478.0, 140.0, 22.0 ],
					"text" : "prepend load",
					"varname" : "prependA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 453.0, 140.0, 22.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 428.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 403.0, 40.0, 22.0 ],
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 378.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 614.0, 428.0, 154.0, 22.0 ],
