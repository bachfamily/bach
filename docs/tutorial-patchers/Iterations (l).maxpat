{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 357.0, 44.0, 654.0, 545.0 ],
		"bglocked" : 0,
		"defrect" : [ 357.0, 44.0, 654.0, 545.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "we keep the chord in order to\nlater play it, if needed",
					"linecount" : 2,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 423.0, 334.0, 169.0, 34.0 ],
					"id" : "obj-49",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 163.0, 296.0, 54.5, 20.0 ],
					"id" : "obj-33",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "right inlet of [bach.iter] is a stopping inlet: whatever you send in it, the iteration will stop. For simplicity, we just send a bang!",
					"linecount" : 5,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 246.0, 155.0, 75.0 ],
					"id" : "obj-44",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "this bang plays the chord",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 422.0, 157.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "this bang stops the iteration",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 402.0, 157.0, 20.0 ],
					"id" : "obj-38",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.0, 398.0, 46.0, 20.0 ],
					"id" : "obj-36",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.0, 387.0, 57.0, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "when we find it, we play it!",
					"linecount" : 2,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 546.0, 375.0, 95.0, 34.0 ],
					"id" : "obj-28",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.0, 434.0, 27.0, 20.0 ],
					"id" : "obj-34",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 484.0, 116.0, 20.0 ],
					"id" : "obj-80",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 488.0, 410.0, 117.0, 20.0 ],
					"id" : "obj-27",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 488.0, 458.0, 117.0, 20.0 ],
					"id" : "obj-25",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 163.0, 471.0, 75.0, 20.0 ],
					"id" : "obj-43",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 446.0, 217.0, 20.0 ],
					"id" : "obj-42",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.0, 274.0, 105.0, 20.0 ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 374.0, 109.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 163.0, 348.0, 124.0, 20.0 ],
					"id" : "obj-26",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 323.0, 65.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 272.0, 56.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 163.0, 248.0, 199.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 142.0, 74.0, 20.0 ],
					"id" : "obj-83",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 143.0, 41.0, 18.0 ],
					"id" : "obj-84",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 164.0, 568.0, 78.166664 ],
					"id" : "obj-54",
					"bgslots" : [  ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "In our case, for example, we might only want to find the FIRST diminished 7th chord of the sequence, and then simply stop the iteration, and play the found chord! The solution lies in [bach.iter] right inlet, which is a \"stop\"-inlet: if ANY message arrives in this inlet at ANY time of the iteration, this will stop the iteration.",
					"linecount" : 3,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 93.0, 605.0, 48.0 ],
					"id" : "obj-96",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 l Iterations",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.5, 612.5, 151.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Ouch, I wish I had some [bach.find] stuff to help me...",
					"numinlets" : 1,
					"fontface" : 2,
					"fontsize" : 12.0,
					...
					"patching_rect" : [ 196.0, 519.0, 307.0, 20.0 ],
					"id" : "obj-61",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Sometimes, instead, you don't really want to go step-by-step through a list, and you just want to go as quick as possible but only until you find something *special*, some very special condition which is matched, and in that moment - only in that moment - you want the iteration to stop.",
					"linecount" : 3,
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 43.0, 606.0, 48.0 ],
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"patching_rect" : [ 156.0, 268.0, 132.0, 105.0 ],
					"id" : "obj-21",
					"background" : 1
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 645.0, 140.0, 20.0 ],
					"id" : "obj-1",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 545.0, 40.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 5.0, 520.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 645.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 620.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 595.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 570.0, 140.0, 18.0 ],
					"id" : "obj-16",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 499.0, 545.0, 40.0, 20.0 ],
					"id" : "obj-17",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 499.0, 520.0, 151.0, 20.0 ],
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 595.5, 481.5, 546.0, 481.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 186.0, 439.0, 458.0, 439.0, 458.0, 384.0, 497.5, 384.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.905882, 1.0 ],
					"midpoints" : [ 199.5, 419.0, 384.0, 419.0, 384.0, 245.0, 352.5, 245.0 ]
				}
