...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 364.0, 739.0, 60.0 ],
					"style" : "",
					"text" : "Another interesting and standard way to use slots is to associate them to some important visual or graphical content. For instance, changing note colors will be possible via associating a dedicate slot to it. The same is true for noteheads and for lyrics. In such a sense, slots are flexible enough to alter some graphical or musical parameters (via the family of attributes @link....toslot). In this tutorial we won't get through this specific slot usage, we'll just stick with the classical usage of slots. But let's introduce things little by little!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 318.0, 332.0, 47.0 ],
					"style" : "",
					"text" : "When a slot window is open, press Shift+TAB to switch to the next slot, and Shift+Alt+TAB to step back to the previous one. Use ESC (or click outside the window) to close it."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 9.0, 189.0, 338.0, 127.666664 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 139.0, 728.0, 47.0 ],
					"style" : "",
					"text" : "This is just a tiny tiny part of what one can have in mind which goes beyond the classic note representation. And if you think about this, all sums up in having some more data attached to each note. That's it. Nothing more than this: slots are additional data assigned to each note. All the rest is understanding the right type of data, and to operate accordingly."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 455.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 507.5, 191.0, 22.0 ],
					"style" : "",
					"text" : "linksections 0 1 a \"Slot Machines\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 318.0, 480.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 425.0, 187.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 7.74086, 477.0, 25.0 ],
					"style" : "",
					"text" : "- behind each notehead, a brand new world"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 566.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 541.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 516.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 612.0, 466.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 612.0, 441.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 327.5, 533.5, 309.5, 533.5, 309.5, 475.0, 327.5, 475.0 ],
					"source" : [ "obj-198", 0 ]
				}
