...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 261.0, 361.0, 47.0 ],
					"text" : "The \"slashgracebeams\" and \"slashgraceflags\" attributes determine whether the little slash will be placed on beamed grace sequences or on single grace notes:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 151.0, 311.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 18.0, 311.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 335.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 335.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.0, 302.0, 159.0, 19.0 ],
					"text" : "beamgracesequences = TRUE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 179.0, 35.0, 22.0 ],
					"text" : "[4 4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 151.0, 76.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 434.0, 126.0, 53.0, 22.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 407.0, 50.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.0, 99.0, 228.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 407.0, 201.0, 86.5, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80001
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 407.0, 75.0, 46.0, 22.0 ],
					"text" : "uzi 30"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"outputtrees" : 2,
					"patching_rect" : [ 407.0, 227.0, 221.0, 108.0 ],
					"pitcheditrange" : [ "null" ],
					"slashgracebeams" : 0,
					"slashgraceflags" : 0,
					"spacingwidth" : 1.6,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.0, 45.0, 211.0, 47.0 ],
					"text" : "This might be handy if you want to generate grace notes and have them properly beamed"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 45.0, 334.0, 47.0 ],
					"text" : "The \"beamgracesequences\" attribute forces bach to beam juxtaposed grace groups together. For instance a group like [g 1/8] [g 1/8] [g 1/8] is converted into [g 1/8 1/8 1/8]."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 7.0, 69.0, 32.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 126.0, 235.0, 22.0 ],
					"text" : "[[1/4 [g 1/8] [g 1/8] [g 1/8] 1/4 -1/2]], bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.0, 100.0, 145.0, 22.0 ],
					"text" : "beamgracesequences $1"
				}

			}
, 			{
				"box" : 				{
					"beamgracesequences" : 0,
					"bwcompatibility" : 80001,
					"defaultnoteslots" : [ "null" ],
					"fontface" : 0,
					"fontname" : "Arial",
					...
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"outputtrees" : 2,
					"patching_rect" : [ 7.0, 151.0, 221.0, 100.0 ],
					"pitcheditrange" : [ "null" ],
					"spacingwidth" : 1.6,
					"stafflines" : [ 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 456.0, 81.0, 22.0 ],
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 508.5, 200.0, 22.0 ],
					"text" : "linksections 1 0 e \"A Mazing Grace\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 481.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 449.0, 42.0, 20.0 ],
					"text" : "Ok ok",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 507.0, 140.0, 22.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 482.0, 140.0, 22.0 ],
					"text" : "prepend load",
					"varname" : "prependA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 457.0, 140.0, 22.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 432.0, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 407.0, 40.0, 22.0 ],
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 382.0, 151.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-24", 0 ],
					"midpoints" : [ 430.0, 122.0, 443.5, 122.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 27.5, 359.0, 399.0, 359.0, 399.0, 224.0, 416.5, 224.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 160.5, 359.0, 399.5, 359.0, 399.5, 224.0, 416.5, 224.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 208.5, 534.5, 190.5, 534.5, 190.5, 476.0, 208.5, 476.0 ],
					"source" : [ "obj-198", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 16.5, 95.0, 174.0, 95.0, 174.0, 123.0, 117.5, 123.0 ],
					"source" : [ "obj-45", 0 ]
				}
