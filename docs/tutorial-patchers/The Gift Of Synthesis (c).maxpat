...
,
		"rect" : [ 126.0, 44.0, 711.0, 442.0 ],
		"bglocked" : 0,
		"defrect" : [ 126.0, 44.0, 711.0, 442.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "here is\nour simple\nsynthesizer",
					"linecount" : 3,
					"patching_rect" : [ 624.0, 279.0, 71.0, 48.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "for the moment, we just need cents, velocities, durations",
					"patching_rect" : [ 371.0, 234.0, 311.0, 20.0 ],
					"id" : "obj-29",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 6.0, 194.0, 223.0, 62.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "start audio",
					"linecount" : 2,
					"patching_rect" : [ 263.0, 369.0, 38.0, 33.0 ],
					"id" : "obj-46",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess 128",
					"patching_rect" : [ 308.0, 328.0, 85.0, 20.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend note",
					"patching_rect" : [ 315.0, 258.0, 81.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pack f i f",
					"patching_rect" : [ 315.0, 234.0, 55.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 3,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 285.413788, 309.0, 25.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 205.0, 163.5, 20.0 ],
					"id" : "obj-43",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 9,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 49.0, 68.0, 33.0, 18.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "play",
					"patching_rect" : [ 6.0, 68.0, 33.0, 18.0 ],
					"id" : "obj-26",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 392.0, 408.0, 163.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolA",
					"text" : "tosymbol",
					"patching_rect" : [ 5.0, 492.0, 140.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 467.0, 141.0, 18.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerA",
					"text" : "t b b",
					"patching_rect" : [ 5.0, 442.0, 40.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolB",
					"text" : "pcontrol",
					"patching_rect" : [ 556.0, 542.0, 140.0, 20.0 ],
					"id" : "obj-10",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependB",
					"text" : "prepend load",
					"patching_rect" : [ 556.0, 517.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolB",
					"text" : "tosymbol",
					"patching_rect" : [ 556.0, 492.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 556.0, 467.0, 141.0, 18.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerB",
					"text" : "t b b",
					"patching_rect" : [ 556.0, 442.0, 40.0, 20.0 ],
					"id" : "obj-18",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
