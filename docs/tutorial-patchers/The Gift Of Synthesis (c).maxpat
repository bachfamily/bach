...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 624.0, 279.0, 71.0, 47.0 ],
					"style" : "",
					"text" : "here is\nour simple\nsynthesizer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 259.0, 277.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.0, 206.0, 129.0, 47.0 ],
					"style" : "",
					"text" : "for the time being, we just need cents, velocities, durations"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 194.0, 223.0, 60.0 ],
					"style" : "",
					"text" : "We have set (in the inspector) to show the velocities via Colorscale, so we can see how velocities are played by our synthesizer."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 363.0, 45.0, 45.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 369.0, 38.0, 32.0 ],
					"style" : "",
					"text" : "start audio",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 358.0, 100.0, 55.0 ],
					"proportion" : 0.39,
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 286.0, 107.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 281.0, 31.0, 20.0 ],
					"style" : "",
					"text" : "___"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 298.0, 287.0, 19.0, 20.0 ],
					"style" : "",
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 328.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 128"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 258.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.125, 231.0, 246.875, 22.0 ],
					"style" : "",
					"text" : "pack f i f"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 325.0, 126.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 315.0, 285.413788, 309.0, 27.0 ],
					"style" : "",
					"text" : "poly~ \"The Gift Of Synthesis (c) - poly\" 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 315.0, 203.0, 247.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.0, 68.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 68.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 95.0, 624.0, 91.666664 ],
					"pitcheditrange" : [ "null" ],
					"showvelocity" : 1,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "linksections 1 1 c \"The Gift Of Synthesis\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 392.0, 408.0, 163.0, 33.0 ],
					"style" : "",
					"text" : "Sounds awful! Can we have a little bit more control?",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 40.0, 638.0, 20.0 ],
					"style" : "",
					"text" : "Let's take an extremely easy example, and let's try to build an easy additive synthesizer to play it properly!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 542.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 517.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 492.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 556.0, 442.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.0, 417.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 544.875, 195.333328, 324.5, 195.333328 ],
					"source" : [ "obj-39", 7 ]
				}
...
, 			{
				"name" : "The Gift Of Synthesis (c) - poly.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/bach/docs/tutorial-patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
