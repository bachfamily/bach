...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 518.0, 335.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 786.0, 108.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 743.0, 107.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 743.0, 129.0, 101.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 806.0, 80.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 806.0, 56.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "r status"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 743.0, 80.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 743.0, 56.0, 59.5, 22.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 576.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 628.5, 209.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 e \"Real Time Stories\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 273.0, 601.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 41.0, 178.0, 234.0 ],
					"style" : "",
					"text" : "Did you find the \"bug\" in the previous patch?\nOur tail was updated with a qmetro approximatively each 50ms. Thus when we play two notes in a row, the tail of the first one will not necessarily coincide with the head of the second one! No real \"legato\", a little gap could appear between notes. To avoid this, we just have to add some more \"tail\" commands, in order to be sure to correctly update the note length, either when a new note arrives (1) or when the notes is stopped (2)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 507.0, 158.399994, 29.0, 23.0 ],
					"style" : "",
					"text" : "(3)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 339.0, 182.0, 33.0 ],
					"style" : "",
					"text" : "By the way, we've added a simple synthesizer (3)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 276.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "onset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 276.0, 51.0, 20.0 ],
					"style" : "",
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 276.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 334.399994, 29.0, 23.0 ],
					"style" : "",
					"text" : "(2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 302.399994, 29.0, 23.0 ],
					"style" : "",
					"text" : "(1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 324.0, 186.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 581.0, 123.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "t i b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 595.0, 145.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 595.0, 166.0, 101.0, 22.0 ],
					"style" : "",
					"text" : "s note_is_played"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 150.0, 87.0, 33.0 ],
					"style" : "",
					"text" : "synthesize\nsounds:"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 487.0, 158.0, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 206.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 128"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 487.0, 207.0, 104.0, 18.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 487.0, 238.0, 45.0, 45.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 535.0, 244.0, 38.0, 32.0 ],
					"style" : "",
					"text" : "start audio",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 233.0, 100.0, 55.0 ],
					"proportion" : 0.39,
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 348.0, 100.0, 252.0, 22.0 ],
					"style" : "",
					"text" : "stripnote"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 25.0, 230.0, 73.0, 34.0 ],
									"style" : "",
									"text" : "synthesizer on/off"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 73.0, 255.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 73.0, 325.0, 41.0, 20.0 ],
									"style" : "",
									"text" : "gate~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 73.0, 355.0, 25.0, 25.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 487.0, 185.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 348.0, 246.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "* 100."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 599.0, 79.0, 51.0, 20.0 ],
					"style" : "",
					"text" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 803.0, 275.0, 26.0, 20.0 ],
					"style" : "",
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 360.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 518.0, 313.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 291.0, 99.0, 22.0 ],
					"style" : "",
					"text" : "r note_is_played"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 390.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.0, 256.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 751.0, 228.0, 65.0, 47.0 ],
					"style" : "",
					"text" : "Durations\nrefresh \ninterval"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.0, 274.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 358.0, 151.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 660.0, 273.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 660.0, 250.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "r status"
				}
...
,
					"patching_rect" : [ 659.0, 327.0, 65.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.595187,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 705.0, 301.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 86.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "s status"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 59.0, 116.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 238.0, 77.0, 22.0 ],
					"style" : "",
					"text" : "gate"
				}
...
,
					"patching_rect" : [ 278.0, 213.0, 65.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 11.595187,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.0, 300.0, 96.0, 22.0 ],
					"style" : "",
					"text" : "pack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 335.0, 95.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 230.0, 383.0, 571.0, 137.666672 ],
					"pitcheditrange" : [ "null" ],
					"showstems" : 0,
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 348.0, 41.0, 252.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 7.74086, 567.0, 25.0 ],
					"style" : "",
					"text" : "- live transcription (here we go... but there'll be a simpler way of doing this!)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.0, 647.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.0, 622.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 703.0, 597.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 703.0, 547.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 703.0, 522.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"hidden" : 1,
					"midpoints" : [ 282.5, 654.5, 264.5, 654.5, 264.5, 596.0, 282.5, 596.0 ],
					"source" : [ "obj-198", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 318.5, 378.5, 239.5, 378.5 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 590.5, 150.0, 395.5, 150.0 ],
					"order" : 1,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.780392, 0.596078, 0.0, 1.0 ],
					"destination" : [ "obj-85", 1 ],
					"midpoints" : [ 542.5, 356.0, 628.5, 356.0, 628.5, 324.0, 714.5, 324.0 ],
					"source" : [ "obj-45", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 527.5, 379.0, 239.5, 379.0 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 245.0, 208.0, 287.5, 208.0 ],
					"order" : 0,
					"source" : [ "obj-56", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 245.0, 208.5, 213.5, 208.5 ],
					"order" : 1,
					"source" : [ "obj-56", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 229.5, 293.5, 318.5, 293.5 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 213.5, 378.5, 239.5, 378.5 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 669.5, 298.0, 714.5, 298.0 ],
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 668.5, 379.0, 239.5, 379.0 ],
					"source" : [ "obj-91", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 357.5, 132.5, 543.5, 132.5 ],
					"order" : 0,
					"source" : [ "obj-98", 0 ]
				}
