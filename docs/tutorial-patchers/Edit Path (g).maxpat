...
,
		"rect" : [ 73.0, 44.0, 741.0, 385.0 ],
		"bglocked" : 0,
		"defrect" : [ 73.0, 44.0, 741.0, 385.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< no slot editing!",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 573.0, 213.0, 122.0, 20.0 ],
					"id" : "obj-14"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "preventedit slot",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 213.0, 92.0, 18.0 ],
					"id" : "obj-11"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "preventedit selection",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.0, 201.0, 121.0, 18.0 ],
					"id" : "obj-41"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< nothing can be selected",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 304.0, 200.0, 162.0, 20.0 ],
					"id" : "obj-40"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 192.0, 221.0, 260.0, 18.0 ],
					"id" : "obj-38"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< users will never know what's at the end of the [bach.roll]!",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 374.0, 244.0, 334.0, 20.0 ],
					"id" : "obj-37"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 244.0, 167.0, 18.0 ],
					"id" : "obj-35"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "notes \nmeasures\nvoices \nbreakpoints\ntempi\nslots\nmarkers\narticulations\nselection\nzooming\ndilationrectangle\ngroups\ninspector\npopup\nslotinfo\nlyrics\ncursor\nloop\nscrollbar",
					"linecount" : 19,
					"frgb" : [ 0.043137, 0.431373, 0.0, 1.0 ],
					"textcolor" : [ 0.043137, 0.431373, 0.0, 1.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontface" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 89.0, 111.0, 269.0 ],
					"id" : "obj-33"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "           – create, delete, onset, duration, pitch, velocity, modification\n                  – create, delete, rhythmictree, modification\n            – create, delete, name, clef, key, position, modification\n                     – create, delete, onset, pitch, velocity\n           – create, delete, modification\n\n               – create, delete, onset, name, modification\n                       – create, delete",
					"linecount" : 8,
					"frgb" : [ 0.101961, 0.431373, 0.082353, 1.0 ],
					"textcolor" : [ 0.101961, 0.431373, 0.082353, 1.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontface" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 6.0, 89.0, 621.0, 117.0 ],
					"id" : "obj-32"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 406.0, 81.0, 18.0 ],
					"hidden" : 1,
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 0 g \"Edit Path\"",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 458.5, 163.0, 20.0 ],
					"hidden" : 1,
					"id" : "obj-198"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 258.0, 431.0, 69.0, 20.0 ],
					"hidden" : 1,
					"id" : "obj-90",
...
, 			{
				"box" : 				{
					...
					"fontface" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 199.0, 414.0, 291.0, 34.0 ],
					"hidden" : 1,
					"id" : "obj-61"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Here's a list containing everything you can edit. Specifications after the dashes are the ones you can put into brackets in order to limit the prevention to some specific actions. If no specification are given (e.g. \"prevent notes\") all actions will be impossible. As you see, the list contains notation items as well as interface actions.",
					"linecount" : 3,
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 5.0, 42.0, 709.0, 48.0 ],
					"id" : "obj-13"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 460.0, 140.0, 20.0 ],
					"hidden" : 1,
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 435.0, 140.0, 20.0 ],
					"hidden" : 1,
					"id" : "obj-5"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 410.0, 140.0, 18.0 ],
					"hidden" : 1,
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 385.0, 40.0, 20.0 ],
					"hidden" : 1,
					"id" : "obj-8"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 360.0, 151.0, 20.0 ],
					"id" : "obj-10"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 487.5, 241.0, 188.5, 241.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-90", 0 ],
					"hidden" : 1,
					"midpoints" : [ 267.5, 484.5, 249.5, 484.5, 249.5, 426.0, 267.5, 426.0 ]
				}
