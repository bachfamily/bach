...
,
		...
		"bglocked" : 0,
		"defrect" : [ 467.0, 104.0, 614.0, 466.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "As a result, if you pop up the 1st slot on a note where a tie ends, you see that the actual beginning of the slotwindow is the first note in the tie-sequence. Indeed, the slot content you'll be modifying IS the content of this first note, and NOT of the content of the one you selected.\nOn the contrary, if you pop up the 2nd slot on a note where a tie ends, you'll be modifying the slot of the very note you have selected (as the slot window left alignment shows).",
					"linecount" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 338.0, 589.0, 75.0 ],
					"fontname" : "Arial",
					"id" : "obj-53",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 171.0, 360.0, 48.0 ],
					"fontname" : "Arial",
					"id" : "obj-52",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 40.0, 565.0, 89.0 ],
					"fontname" : "Arial",
					"id" : "obj-20",
					"fontsize" : 12.0,
					"numinlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "clean, wclose",
					"numoutlets" : 1,
					"patching_rect" : [ 165.0, 533.0, 81.0, 18.0 ],
					"fontname" : "Arial",
					"id" : "obj-19",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"patching_rect" : [ 165.0, 585.5, 192.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-198",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "thispatcher",
					"numoutlets" : 2,
					"patching_rect" : [ 165.0, 558.0, 69.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-90",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 429.0, 169.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 566.0, 140.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-1",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "t b b",
					"numoutlets" : 2,
					"patching_rect" : [ 5.0, 466.0, 40.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"numoutlets" : 1,
					"patching_rect" : [ 459.0, 566.0, 140.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-11",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend load",
					"numoutlets" : 1,
					"patching_rect" : [ 459.0, 541.0, 140.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-12",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "tosymbol",
					"numoutlets" : 1,
					"patching_rect" : [ 459.0, 516.0, 140.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-13",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"text" : "t b b",
					"numoutlets" : 2,
					"patching_rect" : [ 459.0, 466.0, 40.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-16",
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
