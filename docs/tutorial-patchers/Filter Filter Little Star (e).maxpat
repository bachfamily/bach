...
,
		"rect" : [ 30.0, 48.0, 644.0, 401.0 ],
		"bglocked" : 0,
		"defrect" : [ 30.0, 48.0, 644.0, 401.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "You really must NOT forget to define samplerate, should you deal with filters and sample rate different from 44100 Hz!",
					"id" : "obj-28",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 4.0, 342.0, 638.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The sample rate is updated automatically as it changes (or as the DSP is turned on)",
					"linecount" : 3,
					"id" : "obj-27",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 131.0, 167.0, 160.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 185.0, 87.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 160.0, 63.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 315.0, 480.0, 81.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 e \"Filter Filter Little Star\"",
					"id" : "obj-198",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 315.0, 532.5, 225.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"hidden" : 1,
					"patching_rect" : [ 315.0, 505.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "We can't evade speaking of an important fact: biquad coefficients depend on the current sample rate! When the sample rate changes, all the coefficients must be correctly updated, in order to keep the same filter shape.\nHow is it possible that the bach objects (not being DSP objects) retrieve this information? Indeed they don't. You have to deal with it yourself: \"samplerate\" is indeed an attribute for [bach.roll] and [bach.score]. By default it is 44100 (Hz), but you need to update it if you change it in the DSP status window. (Since sample rate is only needed for filter slots, you can ignore this attribute if you don't need these kinds of slots.)\nThe best configuration to automatically update the sample rate is to use the [dspstate~] object:",
					"linecount" : 7,
					"id" : "obj-13",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 43.0, 611.0, 103.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 5.0, 451.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 5.0, 426.0, 140.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"patching_rect" : [ 5.0, 401.0, 40.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 376.0, 151.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 487.0, 501.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 487.0, 476.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 487.0, 451.0, 140.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 487.0, 426.0, 140.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang", "bang" ],
					"hidden" : 1,
					"patching_rect" : [ 487.0, 401.0, 40.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"bordercolor" : [ 0.63, 0.7, 0.75, 1.0 ],
					"patching_rect" : [ 487.0, 376.0, 151.0, 20.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 324.5, 558.5, 306.5, 558.5, 306.5, 500.0, 324.5, 500.0 ]
				}
