...
,
		"rect" : [ 101.0, 44.0, 539.0, 496.0 ],
		"bglocked" : 0,
		"defrect" : [ 101.0, 44.0, 539.0, 496.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"autofit" : 1,
					"numinlets" : 1,
					"patching_rect" : [ 106.0, 79.0, 270.886353, 185.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 31.0, 299.0, 35.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-25",
					"outlettype" : [ "" ],
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "As usual, open measured scores with [bach.score] and non-measured ones with [bach.roll].",
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 7.0, 435.0, 521.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-23",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"showdurations" : 1,
					"loop" : [ "(", 1, ")", "(", 1, ")" ],
					"patching_rect" : [ 31.0, 323.0, 442.0, 110.0 ],
					"numoutlets" : 9,
					"versionnumber" : 7000,
					"spacingwidth" : 10.0,
					"id" : "obj-22",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Save the file in .txt format, and then just open it inside bach, by using the \"read\" message:",
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 7.0, 276.0, 521.0, 20.0 ],
					"numoutlets" : 0,
					"id" : "obj-21",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "PWGL is able to export scores in bach format. Thus, to export a PWGL score to bach, connect the score editor to the \"export-bach\" box, and validate this latter (select it and press V):",
					"linecount" : 2,
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 7.0, 42.0, 521.0, 34.0 ],
					"numoutlets" : 0,
					"id" : "obj-44",
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 183.0, 517.0, 81.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-19",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 j \"The World Outside\"",
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 183.0, 569.5, 210.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-198",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 183.0, 542.0, 69.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-90",
					"outlettype" : [ "", "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 7.74086, 226.0, 26.0 ],
					"numoutlets" : 0,
					"id" : "obj-2",
					"fontsize" : 16.787033
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 571.0, 140.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-26",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 521.0, 140.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-29",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 496.0, 40.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-30",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 471.0, 151.0, 20.0 ],
					"numoutlets" : 3,
					"id" : "obj-32",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 384.0, 596.0, 140.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-33",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 384.0, 571.0, 140.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-34",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 384.0, 546.0, 140.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-35",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 384.0, 521.0, 140.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-37",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontname" : "Arial",
					"patching_rect" : [ 384.0, 496.0, 40.0, 20.0 ],
					"numoutlets" : 2,
					"id" : "obj-38",
					"outlettype" : [ "bang", "bang" ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ],
					"patching_rect" : [ 384.0, 471.0, 151.0, 20.0 ],
					"numoutlets" : 3,
					"id" : "obj-40",
					"bordercolor" : [ 0.63, 0.7, 0.75, 1.0 ],
					"fontface" : 2,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 192.5, 595.5, 174.5, 595.5, 174.5, 537.0, 192.5, 537.0 ]
				}
