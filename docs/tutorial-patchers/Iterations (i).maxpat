...
,
		"rect" : [ 101.0, 44.0, 638.0, 520.0 ],
		"bglocked" : 0,
		"defrect" : [ 101.0, 44.0, 638.0, 520.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "[bach.x2dx] takes a (plain) list and outputs the list of difference between each element and the previous one",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.0, 231.0, 312.0, 34.0 ],
					"id" : "obj-73",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "...and when it goes back to the lambda inlet, our llll is automatically re-wrapped",
					"linecount" : 2,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 383.0, 455.0, 220.0, 34.0 ],
					"id" : "obj-53",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "...we take elements 1 and 2...",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 433.0, 167.0, 20.0 ],
					"id" : "obj-52",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "each chord is automatically unwrapped...",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 409.0, 228.0, 20.0 ],
					"id" : "obj-51",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "As a further example, if we needed to isolate the low-bichord-line of a [bach.roll] we could do something like this:",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 280.0, 611.0, 20.0 ],
					"id" : "obj-49",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 157.0, 200.0, 66.0, 20.0 ],
					"id" : "obj-36",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 157.0, 246.0, 76.0, 20.0 ],
					"id" : "obj-35",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 157.0, 223.0, 65.0, 20.0 ],
					"id" : "obj-31",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 204.0, 63.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 9.0, 176.0, 167.0, 20.0 ],
					"id" : "obj-33",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 9.0, 148.0, 171.0, 18.0 ],
					"id" : "obj-34",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 547.0, 200.0, 65.0, 20.0 ],
					"id" : "obj-22",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 336.0, 204.0, 63.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 336.0, 176.0, 230.0, 20.0 ],
					"id" : "obj-28",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 336.0, 148.0, 171.0, 18.0 ],
					"id" : "obj-29",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.0, 435.0, 143.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 344.0, 433.0, 93.0, 20.0 ],
					"id" : "obj-21",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 129.0, 409.0, 234.0, 20.0 ],
					"id" : "obj-20",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 303.0, 74.0, 20.0 ],
					"id" : "obj-83",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 46.0, 304.0, 41.0, 18.0 ],
					"id" : "obj-84",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"vzoom" : 83.333328,
					"voicespacing" : [ -12.0, 11.0 ],
					"patching_rect" : [ 46.0, 325.0, 308.0, 74.166664 ],
					"id" : "obj-54",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"fontname" : "Arial",
					"versionnumber" : 6500,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 239.5, 552.0, 81.0, 18.0 ],
					"id" : "obj-89",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 i Iterations",
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 239.5, 604.5, 151.0, 20.0 ],
					"id" : "obj-198",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 239.5, 577.0, 69.0, 20.0 ],
					"id" : "obj-90",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The unwrap attribute that we already met some sections ago. It is very simple to use: imagine that the iterated elements are lllls (e.g. because you have put a @maxdepth attribute). In these case, you might want to remove the starting and ending brackets before operating with some objects. In this case, you'd need to re-wrap the list before inputting it into the lambda inlet. If you want to avoid this operation, the @unwrap attribute will save you a few objects and connections!\n\nFor instance, those two processes behave exactly in the very same way:",
					"linecount" : 7,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 43.0, 616.0, 103.0 ],
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 483.0, 620.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 483.0, 595.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 483.0, 570.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 483.0, 545.0, 140.0, 18.0 ],
					"id" : "obj-16",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 483.0, 520.0, 40.0, 20.0 ],
					"id" : "obj-17",
					"outlettype" : [ "bang", "bang" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
					"numoutlets" : 3,
					"patching_rect" : [ 483.0, 495.0, 151.0, 20.0 ],
					"id" : "obj-19",
					"outlettype" : [ "", "", "int" ],
					"fontname" : "Arial",
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ]
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 556.5, 226.0, 618.0, 226.0, 618.0, 169.0, 556.5, 169.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-90", 0 ],
					"hidden" : 1,
					"midpoints" : [ 249.0, 630.5, 231.0, 630.5, 231.0, 572.0, 249.0, 572.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"midpoints" : [ 353.5, 456.0, 604.0, 456.0, 604.0, 405.0, 353.5, 405.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.0, 0.0, 1.0 ],
					"midpoints" : [ 166.5, 272.0, 275.0, 272.0, 275.0, 169.0, 166.5, 169.0 ]
				}
