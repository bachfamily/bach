...
,
		"rect" : [ 56.0, 44.0, 655.0, 439.0 ],
		"bglocked" : 0,
		"defrect" : [ 56.0, 44.0, 655.0, 439.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< This will let all elements to be editable again",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-41",
					"fontname" : "Arial",
					"patching_rect" : [ 121.0, 248.0, 167.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 247.0, 70.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< This will force the note pitch to be fixed, while every other parameter can change (but you won't be able to create/delete notes). Also, marker names will be fixed, but marker onsets are movable",
					"linecount" : 4,
					"numoutlets" : 0,
					"id" : "obj-38",
					"fontname" : "Arial",
					"patching_rect" : [ 327.0, 217.0, 311.0, 62.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 217.0, 297.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< This will force the notes onset to remain exactly the same, and also notes cannot be deleted or created",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-37",
					"fontname" : "Arial",
					"patching_rect" : [ 242.0, 178.0, 395.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<<< This will force the notes onset to remain exactly the same. Nothing prevents, on the other hand, the durations or pitches to change. Also notes can be deleted or created!",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-36",
					"fontname" : "Arial",
					"patching_rect" : [ 151.0, 142.0, 482.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Luckily, further specifications can be made on some notation elements, by putting them into a level of brackets. For instance:",
					"linecount" : 2,
					"numoutlets" : 0,
					"id" : "obj-34",
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 103.0, 621.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 177.0, 216.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 144.0, 143.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"bgslots" : [  ],
					"popupmenuslots" : [  ],
					"patching_rect" : [ 6.0, 284.0, 526.0, 120.0 ],
					"out" : "nnnnnnn",
					"voicenames" : [ "(", ")" ],
					"numvoices" : 1,
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 464.0, 81.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 f \"Edit Path\"",
					"numoutlets" : 1,
					"id" : "obj-198",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 516.5, 160.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 258.0, 489.0, 69.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "- more magic power of preventedit",
					"numoutlets" : 0,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Yet sometimes one needs to enter more into details about what is allowed to be edited and what is not.\nFor instance: what if we wanted to have a single note, whose pitch is allowed to change, but whose onset is NOT? This would be very handy for instance when building processes where this note is a parameter, while its onset and durations are not. In this case the user would have a solid and unconfusing interface to deal with.",
					"linecount" : 4,
					"numoutlets" : 0,
					"id" : "obj-13",
					"fontname" : "Arial",
					"patching_rect" : [ 5.0, 42.0, 621.0, 62.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 539.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 464.0, 140.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 439.0, 40.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 414.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 539.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 514.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 489.0, 140.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.0, 464.0, 140.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 500.0, 439.0, 40.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"hidden" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 500.0, 414.0, 151.0, 20.0 ],
					"bordercolor" : [ 0.63, 0.7, 0.75, 1.0 ],
					"fontface" : 2,
					"fontsize" : 12.0,
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 267.5, 542.5, 249.5, 542.5, 249.5, 484.0, 267.5, 484.0 ]
				}
