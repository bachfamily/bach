{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 183.0, 44.0, 649.0, 449.0 ],
		"bglocked" : 0,
		"defrect" : [ 183.0, 44.0, 649.0, 449.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess clear",
					"patching_rect" : [ 116.0, 279.0, 91.0, 20.0 ],
					"id" : "obj-28",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 349.0, 413.0, 148.0, 34.0 ],
					"id" : "obj-61",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 428.0, 342.0, 150.0, 62.0 ],
					"id" : "obj-41",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 505.0, 255.0, 135.0, 62.0 ],
					"id" : "obj-38",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t l clear",
					"patching_rect" : [ 245.0, 301.0, 49.0, 20.0 ],
					"id" : "obj-34",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 398.0, 200.0, 228.0, 34.0 ],
					"id" : "obj-32",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 378.0, 292.0, 124.0, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.x2dx",
					"patching_rect" : [ 378.0, 267.0, 65.0, 20.0 ],
					"id" : "obj-39",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "bach.flat 1",
					"patching_rect" : [ 378.0, 243.0, 66.0, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 307.0, 173.0, 190.0, 20.0 ],
					"id" : "obj-30",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "dump",
					"patching_rect" : [ 6.0, 66.0, 41.0, 18.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "bach.roll",
					"patching_rect" : [ 6.0, 339.0, 417.0, 71.333336 ],
					"vzoom" : 66.666672,
					"id" : "obj-23",
					"numinlets" : 6,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 209.0, 232.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 4,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "wclose",
					"text" : "clean, wclose",
					"patching_rect" : [ 239.5, 510.0, 81.0, 18.0 ],
					"id" : "obj-89",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 239.5, 562.5, 153.0, 20.0 ],
					"id" : "obj-198",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "thispatcher",
					"patching_rect" : [ 239.5, 535.0, 69.0, 20.0 ],
					"id" : "obj-90",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 7.74086, 292.0, 26.0 ],
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"varname" : "messageA",
					"text" : "Iterations (q)",
					"patching_rect" : [ 5.0, 474.0, 140.0, 18.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerA",
					"text" : "t b b",
					"patching_rect" : [ 5.0, 449.0, 40.0, 20.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "pcontrolB",
					"text" : "pcontrol",
					"patching_rect" : [ 494.0, 549.0, 140.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "prependB",
					"text" : "prepend load",
					"patching_rect" : [ 494.0, 524.0, 140.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "tosymbolB",
					"text" : "tosymbol",
					"patching_rect" : [ 494.0, 499.0, 140.0, 20.0 ],
					"id" : "obj-13",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "messageB",
					"text" : "Iterations (s)",
					"patching_rect" : [ 494.0, 474.0, 140.0, 18.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "triggerB",
					"text" : "t b b",
					"patching_rect" : [ 494.0, 449.0, 40.0, 20.0 ],
					"id" : "obj-16",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 1,
