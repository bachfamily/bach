{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 169.0, 44.0, 954.0, 472.0 ],
		"bglocked" : 0,
		"defrect" : [ 169.0, 44.0, 954.0, 472.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "remember that \"clearselection\" accepts one optional argument to define the voice for which the selection has to be cleared (if you need to clear it for a single voice, like we need.",
					"linecount" : 4,
					"fontsize" : 12.0,
					"patching_rect" : [ 518.0, 140.0, 263.0, 62.0 ],
					"id" : "obj-28",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "There's nothing against having two or more independent sources for generation. For example, one might want to assign each source to a different voice: we just have to be careful to put the appropriate voice number in the \"addchord\", \"select\" and \"clearselection\" syntax:",
					"linecount" : 3,
					"fontsize" : 12.0,
					"patching_rect" : [ 127.0, 45.0, 513.0, 48.0 ],
					"id" : "obj-132",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "linksections 1 1 j \"Real Time Stories\"",
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 333.0, 628.5, 205.0, 20.0 ],
					"id" : "obj-198",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 854.0, 349.0, 85.0, 20.0 ],
					"id" : "obj-25",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 786.0, 350.0, 104.0, 18.0 ],
					"id" : "obj-24",
					"numinlets" : 2,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 786.0, 381.0, 45.0, 45.0 ],
					"id" : "obj-10",
					"numinlets" : 2,
					"local" : 1,
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 11.595187,
					"patching_rect" : [ 834.0, 387.0, 38.0, 33.0 ],
					"id" : "obj-22",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 779.0, 376.0, 100.0, 55.0 ],
					"id" : "obj-23",
					"numinlets" : 1,
					"border" : 2,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 786.0, 325.0, 88.0, 20.0 ],
					"id" : "obj-92",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"text" : "ms",
					"fontsize" : 12.0,
					"patching_rect" : [ 927.0, 155.0, 26.0, 20.0 ],
					"id" : "obj-52",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 914.0, 136.0, 79.0, 20.0 ],
					"id" : "obj-97",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 12.0,
					"patching_rect" : [ 875.0, 108.0, 65.0, 48.0 ],
					"id" : "obj-96",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"patching_rect" : [ 875.0, 154.0, 50.0, 20.0 ],
					"id" : "obj-93",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "int" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 784.0, 153.0, 50.0, 20.0 ],
					"id" : "obj-86",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 3
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 784.0, 130.0, 50.0, 20.0 ],
					"id" : "obj-55",
					"numinlets" : 0,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"fontsize" : 11.595187,
					"patching_rect" : [ 783.0, 207.0, 65.0, 20.0 ],
					"id" : "obj-85",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 829.0, 181.0, 65.0, 20.0 ],
					"id" : "obj-82",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.709804, 0.729412, 0.839216, 1.0 ],
					"fontsize" : 12.0,
					"patching_rect" : [ 4.0, 71.0, 52.0, 20.0 ],
					"id" : "obj-59",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 4.0, 44.0, 116.0, 23.0 ],
					"mode" : 1,
					"id" : "obj-58",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"legend" : 0,
					"hidevoices" : [ 0, 0 ],
					"patching_rect" : [ 8.0, 263.0, 768.0, 168.0 ],
					"keys" : [ "CM", "CM" ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Yes, but still, the two sources are in two different voices. What if I wanted to generate them separately in the same voice?",
					"linecount" : 2,
					"fontface" : 2,
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.168627, 0.67451, 1.0 ],
					"patching_rect" : [ 454.0, 436.0, 342.0, 34.0 ],
					"id" : "obj-61",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "- two sources",
					"fontsize" : 16.787033,
					"patching_rect" : [ 221.0, 7.74086, 199.0, 26.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 799.0, 572.0, 140.0, 20.0 ],
					"id" : "obj-37",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 799.0, 547.0, 140.0, 20.0 ],
					"id" : "obj-38",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 799.0, 522.0, 140.0, 20.0 ],
					"id" : "obj-39",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 799.0, 497.0, 140.0, 18.0 ],
					"id" : "obj-42",
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"hidden" : 1,
					"patching_rect" : [ 799.0, 472.0, 40.0, 20.0 ],
					"id" : "obj-45",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"bgovercolor" : [ 0.64, 0.65, 0.72, 1.0 ],
					"bgoncolor" : [ 0.51, 0.59, 0.64, 1.0 ],
					"patching_rect" : [ 799.0, 447.0, 151.0, 20.0 ],
					"id" : "obj-48",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 675.5, 259.5, 17.5, 259.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 777.5, 259.0, 17.5, 259.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 793.5, 178.0, 838.5, 178.0 ]
				}
