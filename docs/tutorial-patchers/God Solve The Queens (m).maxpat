...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 125.0, 98.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 100.0, 135.0, 18.0 ],
					"style" : "",
					"text" : "@automessage dump cents",
					"textcolor" : [ 0.592157, 0.592157, 0.592157, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 365.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.0, 312.0, 144.0, 22.0 ],
					"style" : "",
					"text" : "bach.print FoundSolution"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 288.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "<<<"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 278.0, 244.0, 47.0 ],
					"style" : "",
					"text" : "since we had a list of (duration pitch) (duration pitch)... we need to transpose it in order to separate durations from pitches"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.0, 369.0, 382.0, 20.0 ],
					"style" : "",
					"text" : "Click on the admitted durations to trigger the search."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.0, 390.0, 382.0, 100.0 ],
					"style" : "",
					"text" : "Notice that the domain is the set of all combinations of the 3 admitted durations with all pitches. All these combinations form what is known as \"cartesian product\" of the two sets, and it can be computed via [bach.cartesianprod]. If we had just 2 durations, say 1/4 and 1/8, and just 3 pitches, say 6000 6400 and 6500, all the combination would be\n(1/4 6000) (1/4 6400) (1/4 6500) (1/8 6000) (1/8 6400) (1/8 6500), which is exactly what [bach.cartesianprod] returns!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 167.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "<< Domain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 222.0, 98.0, 20.0 ],
					"style" : "",
					"text" : "<< (stop search)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 651.0, 272.0, 258.0, 20.0 ],
					"style" : "",
					"text" : "<< Have a look here: we implement the rules"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 580.0, 243.0, 145.0, 48.0 ],
									"style" : "",
									"text" : "duration can't  be 1/4 if pitch does not belong to F major chord"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 257.0, 190.0, 285.0, 20.0 ],
									"style" : "",
									"text" : "$x1, $x2, $x3 and $x4 can't be all positive durations"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 739.0, 59.0, 233.0, 48.0 ],
									"style" : "",
									"text" : "as usual we retrieve the current values of the variables. Those values are now couples of (duration pitch)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 190.0, 172.0, 34.0 ],
									"style" : "",
									"text" : "$x1 and $x2 can't be both negative durations (rests)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.0, 154.0, 81.0, 20.0 ],
									"style" : "",
									"text" : "bach.% 1200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"patching_rect" : [ 571.0, 179.0, 133.0, 20.0 ],
									"style" : "",
									"text" : "bach.belong 0 500 900"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.0, 101.0, 153.5, 20.0 ],
									"style" : "",
									"text" : "bach.flat"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.0, 207.0, 154.0, 34.0 ],
									"style" : "",
									"text" : "bach.expr !($r2 == 1/4 && $i1 != 1) @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 706.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 471.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 241.0, 155.0, 251.0, 34.0 ],
									"style" : "",
									"text" : "bach.expr !(sgn($x1) > 0 && sgn($x2) > 0 && sgn($x3) > 0 && sgn($x4) > 0) @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 394.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 318.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 241.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 241.0, 100.0, 249.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 5.0, 156.0, 173.0, 34.0 ],
									"style" : "",
									"text" : "bach.expr !(sgn($x1) < 0 && sgn($x2) < 0) @out t"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 82.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 5.0, 127.0, 71.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 5.0, 100.0, 96.0, 20.0 ],
									"style" : "",
									"text" : "bach.pick 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "bang" ],
									"patching_rect" : [ 5.0, 56.0, 728.0, 20.0 ],
									"style" : "",
									"text" : "bach.keys no2rests no4chords longFnotes"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 147.333313, 358.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 580.5, 123.5, 715.5, 123.5 ],
									"source" : [ "obj-84", 0 ]
								}
...
,
					"patching_rect" : [ 394.0, 267.03775, 240.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 667.0, 174.0, 258.0, 20.0 ],
					"style" : "",
					"text" : "<< Have a look here: we define the constraints"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 409.0, 150.0, 191.0, 20.0 ],
					"style" : "",
					"text" : "number of events in the sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 39.0, 114.0, 20.0 ],
					"style" : "",
					"text" : "Admitted pitches:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 492.0, 33.0, 444.0, 87.0 ],
					"style" : "",
					"text" : "As another example, we want to construct a line where each event has a duration and a pitch, both of which come from a limited range of possibilities (the ones at left). We want to impose the following rules:\n- No two rests shall be in a row (rule named \"no2rests\")\n- No four (non-rest) chords shall be in a row (\"no4chords\")\n- All notes having 1/4 as duration must belong to a F major chord (\"longFnotes\")"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 5.0, 81.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "t l l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 269.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "bach.flat 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.099998, 338.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "bach.wrap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 340.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "(4 4)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 364.0, 354.5, 22.0 ],
					"style" : "",
					"text" : "bach.beatbox"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 5.0, 314.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "bach.pick 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.199997, 338.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "bach.wrap"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 5.0, 390.0, 526.0, 107.333336 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 290.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "bach.trans"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 222.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "stop"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 335.0, 293.0, 66.0, 20.0 ],
									"style" : "",
									"text" : "Of course:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 502.0, 293.0, 19.0, 20.0 ],
									"style" : "",
									"text" : "="
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 416.0, 293.0, 81.0, 20.0 ],
									"style" : "",
									"text" : "bach.group 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 622.0, 295.0, 66.0, 20.0 ],
									"style" : "",
									"text" : "bach.wrap"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 526.0, 293.0, 89.0, 20.0 ],
									"style" : "",
									"text" : "bach.mapelem"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 466.0, 202.0, 179.0, 20.0 ],
									"style" : "",
									"text" : "<< unary constraint: longFnotes"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 178.75, 147.0, 169.0, 20.0 ],
									"style" : "",
									"text" : "<< binary constraint: no2rests"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 359.0, 176.0, 173.0, 20.0 ],
									"style" : "",
									"text" : "<< 4-ary constraint: no4chords"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.75, 176.0, 145.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 149.0, 145.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.5, 229.0, 148.0, 20.0 ],
									"style" : "",
									"text" : "bach.prepend longFnotes"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.5, 202.0, 81.0, 20.0 ],
									"style" : "",
									"text" : "bach.group 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 259.0, 366.5, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.75, 203.0, 143.0, 20.0 ],
									"style" : "",
									"text" : "bach.prepend no4chords"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 29.0, 177.0, 133.0, 20.0 ],
									"style" : "",
									"text" : "bach.prepend no2rests"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 363.0, 47.0, 32.5, 18.0 ],
									"style" : "",
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 363.0, 68.0, 110.0, 20.0 ],
									"style" : "",
									"text" : "bach.arithmser 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 363.0, 8.0, 25.0, 25.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 356.0, 172.75676, 310.0, 28.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"style" : "",
					"text" : "p \"Build Constraint Names And Scopes\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 375.0, 204.0, 205.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 356.0, 148.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 195.0, 327.0, 22.0 ],
					"style" : "",
					"text" : "bach.repeat 10 @inwrap 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 99.0, 143.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "bach.flat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 167.0, 113.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 39.0, 114.0, 20.0 ],
					"style" : "",
					"text" : "Admitted durations:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 141.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "bach.append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 114.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "bach.* -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 60.0, 74.0, 22.0 ],
					"style" : "",
					"text" : "1/4 1/8 1/16"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 155.0, 42.0, 333.0, 77.833336 ],
					"pitcheditrange" : "null",
					"showstems" : 0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 5.0, 243.0, 408.0, 22.0 ],
					"style" : "",
					"text" : "bach.constraints @solutions 1 @random 1 @parallel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 501.0, 203.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 244.0, 537.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 593.0, 243.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 0 m \"God Solve The Queens\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 243.5, 564.5, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 6.74086, 280.0, 25.0 ],
					"style" : "",
					"text" : "- rhythm'n'pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 582.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 557.0, 148.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 532.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 403.5, 304.03775, 643.5, 304.03775, 643.5, 233.0, 403.5, 233.0 ],
					"source" : [ "obj-104", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 14.5, 265.0, 373.5, 265.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 253.0, 618.0, 237.0, 618.0, 237.0, 559.5, 253.0, 559.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 365.5, 220.378387, 209.0, 220.378387 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 135.5, 124.0, 365.5, 124.0 ],
					"source" : [ "obj-60", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 14.5, 335.5, 148.699997, 335.5 ],
					"source" : [ "obj-69", 0 ]
				}
