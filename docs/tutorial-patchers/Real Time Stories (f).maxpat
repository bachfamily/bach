...
,
		"rect" : [ 117.0, 44.0, 793.0, 406.0 ],
		"bglocked" : 0,
		"defrect" : [ 117.0, 44.0, 793.0, 406.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.0, 163.0, 279.0, 48.0 ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 1,
					"patching_rect" : [ 348.0, 131.0, 102.0, 20.0 ],
					"id" : "obj-28",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 348.0, 108.0, 39.0, 20.0 ],
					"id" : "obj-31",
					"outlettype" : [ "int" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 209.0, 173.078812, 158.0, 21.0 ],
					"id" : "obj-77",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 242.0, 139.0, 65.0, 18.0 ],
					"id" : "obj-33",
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 242.0, 115.0, 43.0, 20.0 ],
					"id" : "obj-18",
					"outlettype" : [ "bang", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 4,
					"patching_rect" : [ 242.0, 91.0, 59.5, 20.0 ],
					"id" : "obj-35",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 273.0, 426.0, 81.0, 18.0 ],
					"id" : "obj-19",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 273.0, 478.5, 206.0, 20.0 ],
					"id" : "obj-198",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 273.0, 451.0, 69.0, 20.0 ],
					"id" : "obj-44",
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"hidden" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "We've done a bit of work, which has get us accostumed to some very useful roll messages, and to its selection system. Yet, if you don't want to do all the work each time you have to transcribe something (which is totally understandable...) you might just want to use [bach.transcribe], an abstraction which exactly encapsulate all we had done before (plus some slightly smarter checking on voice polyphony)",
					"linecount" : 13,
					"fontsize" : 12.0,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 41.0, 193.0, 186.0 ],
					"id" : "obj-102",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 223.0, 197.0, 91.0, 20.0 ],
					"id" : "obj-5",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 7.74086, 303.0, 26.0 ],
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 481.0, 140.0, 20.0 ],
					"id" : "obj-6",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 456.0, 140.0, 20.0 ],
					"id" : "obj-7",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 5.0, 431.0, 140.0, 18.0 ],
					"id" : "obj-9",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 5.0, 406.0, 40.0, 20.0 ],
					"id" : "obj-10",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 638.0, 506.0, 140.0, 20.0 ],
					"id" : "obj-13",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 638.0, 481.0, 140.0, 20.0 ],
					"id" : "obj-14",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 638.0, 456.0, 140.0, 20.0 ],
					"id" : "obj-15",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 638.0, 431.0, 140.0, 18.0 ],
					"id" : "obj-17",
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"hidden" : 1
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 638.0, 406.0, 40.0, 20.0 ],
					"id" : "obj-20",
					"outlettype" : [ "bang", "bang" ],
					"fontname" : "Arial",
					"hidden" : 1
