...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -479.0, 168.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.0, 77.0, 225.0, 127.0 ],
					"style" : "",
					"text" : "(By the way: for those of you familiar with the selection mechanism, \"select all\" is an exception to the \"select\" involutive selection, since it *always* select all notes, no matter what is selected. Don't remember that if you don't want to use involutive selection, you can use the \"sel\" and \"unsel\" commands.)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 582.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.5, 637.0, 262.0, 22.0 ],
					"style" : "",
					"text" : "linksections 1 1 c \"Through The Looking Glass\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 333.5, 609.5, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.0, 459.0, 301.0, 20.0 ],
					"style" : "",
					"text" : "Uhm... this last example reminds me of something...",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.0, 432.0, 332.0, 22.0 ],
					"style" : "",
					"text" : "select all, cents (-1 times), cents (12000 plus), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 430.0, 323.0, 20.0 ],
					"style" : "",
					"text" : "or do two o more transformations in a row:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 412.0, 239.0, 22.0 ],
					"style" : "",
					"text" : "select all, cents (200 minus), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 412.0, 323.0, 20.0 ],
					"style" : "",
					"text" : "or lessen them all of a certain amount;"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 42.0, 644.0, 33.0 ],
					"style" : "",
					"text" : "Our \"cents = cents + $1\" is a way to tell our object to increase the cents of a given amount. \nEquivalently you might be familiar withan older syntax:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 377.0, 323.0, 33.0 ],
					"style" : "",
					"text" : "Our <number> can thus become a shift or a scale factor: as a simple exercise, we can multiply all the cents by 1.05:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.0, 390.0, 239.0, 22.0 ],
					"style" : "",
					"text" : "select all, cents (1.05 times), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 306.0, 620.0, 74.0 ],
					"style" : "",
					"text" : "Remember: a \"cents <number>\" message sets all the cents to <number>. You can give a list of numbers, like \"cents <number1> ... <number_n>\", and those numbers will be applied to successive notes of a chord. But any of those numbers can be substituted by a list containing \"(<number> <modification_type>)\", where the modification types are: \"plus\", \"minus\", \"times\", \"div\", and the result will be the original pitch increased/decreased/multiplied or divided by our <number>."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 594.0, 240.0, 32.5, 22.0 ],
					"style" : "",
					"text" : "($1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 240.0, 616.0, 60.0 ],
					"style" : "",
					"text" : "This might seem a little thing, but actually the second syntax will never work, because Max won't understand          as a message involving the $1 variable, but as an entire symbol \"($1\". (Try it, if you don't believe!)\nThat's why, if you use the $1...$9 variables inside messages, you ALWAYS have to pay attention to isolate them from brackets by means of blank spaces. You CAN use them, that's fine. Just be careful to isolate them!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.0, 221.0, 59.0, 20.0 ],
					"style" : "",
					"text" : "."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 318.0, 221.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "($1 plus)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 221.0, 59.0, 20.0 ],
					"style" : "",
					"text" : "and NOT"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 221.0, 64.0, 22.0 ],
					"style" : "",
					"text" : "( $1 plus )"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 220.0, 187.0, 20.0 ],
					"style" : "",
					"text" : "First notice the fact that we wrote"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 105.0, 229.0, 22.0 ],
					"style" : "",
					"text" : "select all, cents ( $1 plus ), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 77.079315, 94.0, 21.0 ],
					"style" : "",
					"text" : "Transposition:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 77.079315, 43.0, 21.0 ],
					"style" : "",
					"text" : "cents"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 108.0, 74.600006, 62.0, 26.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 12.0, 131.0, 424.0, 86.0 ],
					"pitcheditrange" : [ "null" ],
					"stafflines" : [ 5 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -595.0, 198.0, 606.0, 62.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 7.74086, 309.0, 25.0 ],
					"style" : "",
					"text" : "- something older, something subtler"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 2.924051, 317.0, 31.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 509.0, 174.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 484.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerA"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 459.0, 151.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 584.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 559.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 534.0, 140.0, 22.0 ],
					"style" : "",
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 509.0, 174.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 553.0, 484.0, 40.0, 22.0 ],
					"style" : "",
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 553.0, 459.0, 151.0, 20.0 ],
					"style" : "",
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 342.5, 410.0, 8.0, 410.0, 8.0, 126.0, 21.5, 126.0 ],
					"source" : [ "obj-101", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 233.5, 430.0, 8.0, 430.0, 8.0, 126.0, 21.5, 126.0 ],
					"source" : [ "obj-148", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 255.5, 452.0, 8.5, 452.0, 8.5, 126.0, 21.5, 126.0 ],
					"source" : [ "obj-150", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 117.5, 101.800003, 21.5, 101.800003 ],
					"source" : [ "obj-17", 0 ]
				}
