...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 701.0, 360.0, 151.0, 69.0 ],
					"text" : "The quickest use of Playout is in connection with bach.ezmidiplay"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 715.0, 332.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 292.0, 338.0, 137.0 ],
					"text" : "These two additional outlets represents the essence of what bach is. If you are used to non-real-time environments such as OM, they might not make any sense; yet they are used in many bach applications.\nSince in this tutorial our aim is to show how OpenMusic patches can be simply translated into bach, we will not deal with those outlets here.\nIf you are curious, see the \"Real Time Stories\" or \"Lambda Scores\" tutorials to have a glimpse."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.5, 204.0, 251.0, 98.0 ],
					"text" : "This outlet simply sends a bang when the user changes the existing score. This will be crucial to handle real-time processes – imagine you want something to happen exactly when the user has changed the score!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 285.0, 345.0, 99.0 ],
					"text" : "This outlet is known as \"Playout\".\nFrom this outlet all the information about the music will be output when the notation object is sequenced (played).\nThis outlet also is able to retrieve various types of notifications and answers to the input queries. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.0, 384.0, 352.0, 21.0 ],
					"text" : "See #queries, #notification if you are curious to know more."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.0, 408.0, 128.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 47.0, 794.0, 65.0 ],
					"text" : "Differently from OpenMusic, bach has an asymmetric pattern of inlets and outlets. If you notice, both bach.score and bach.roll have two more outlets then inlets. This inelegance is the price bach has to pay to support powerful real-time capabilities. The last two outlets, are, indeed, real-time outlets, dealing with sequencing, querying, information retrieval as well as notifying when the user has changed the musical content via the interface."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 221.666656, 77.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 286.0, 234.0, 67.0, 40.0 ],
					"text" : "Velocities",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 234.0, 68.0, 40.0 ],
					"text" : "Durations",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 234.0, 55.0, 40.0 ],
					"text" : "Pitches",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 234.0, 54.0, 40.0 ],
					"text" : "Onsets",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.5, 234.0, 65.0, 40.0 ],
					"text" : "EXTRAS",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.5, 141.0, 65.0, 40.0 ],
					"text" : "EXTRAS",
					"textcolor" : [ 0.854902, 0.284727, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.5, 141.0, 117.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 280.5, 141.0, 98.0, 40.0 ],
					"text" : "Durations (ms)",
					"textcolor" : [ 0.127468, 0.216092, 0.657609, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 179.0, 141.0, 98.0, 40.0 ],
					"text" : "Pitches (mc)",
					"textcolor" : [ 0.140686, 0.717391, 0.260933, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 93.0, 141.0, 83.0, 40.0 ],
					"text" : "Onsets (ms)",
					"textcolor" : [ 0.809783, 0.0, 0.113734, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 126.0, 84.0, 55.0 ],
					"text" : "Whole information",
					"textcolor" : [ 0.755435, 0.493759, 0.113608, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.5, 182.666656, 60.0, 21.0 ],
					"text" : "bach.roll"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 18.5, 182.666656, 521.0, 98.333336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 494.0, 81.0, 18.0 ],
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 546.5, 249.0, 20.0 ],
					"text" : "linksections 1 1 d \"From OpenMusic to bach\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 519.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 499.0, 162.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 574.0, 140.0, 20.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 549.0, 140.0, 20.0 ],
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 524.0, 140.0, 20.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 499.0, 162.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 701.0, 474.0, 40.0, 20.0 ],
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 701.0, 449.0, 151.0, 20.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 208.5, 572.5, 190.5, 572.5, 190.5, 514.0, 208.5, 514.0 ],
					"source" : [ "obj-198", 0 ]
				}
