...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 421.0, 827.0, 65.0 ],
					"text" : "In Max, to perform non-real-time processes, you can simply send a bang performing the sequence of desired operations. As usual, in Max, operations are performed right-to-left. In our case, \"dump\" will output the bach.roll information through all bach.roll's outlets (except the last two), we retrieve the midicents, we add 200, and we will give them to the destination bach.roll. In order to rebuild the final bach roll from separate parameters, we need to send a final bang, which is what we do."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 71.0, 174.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 86.0, 288.399994, 332.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.828552, 212.5, 248.0, 40.0 ],
					"text" : "Use Cmd+click (mac) or Ctrl+click (win) to delete new note.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.828552, 240.5, 265.171448, 84.0 ],
					"text" : "You usually can use this very same combination to add notes, but in our case we have set a very tight \"preventedit\" attribute... Have a look at it in the inspector!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.028564, 102.0, 92.0, 25.0 ],
					"text" : "Click to go!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.828552, 361.0, 191.0, 21.0 ],
					"text_width" : 122.171448
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.828552, 340.0, 161.0, 21.0 ],
					"text" : "Notice that we have set:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 489.828552, 381.0, 153.0, 21.0 ],
					"text_width" : 121.971436
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 71.0, 174.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 290.0, 101.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 319.028564, 163.0, 19.0, 19.0 ],
					"text" : "A"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 457.828552, 319.0, 18.0, 19.0 ],
					"text" : "D"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.828552, 294.0, 18.0, 19.0 ],
					"text" : "C"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 476.828552, 268.0, 19.0, 19.0 ],
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 423.828552, 259.0, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 290.399994, 134.0, 62.0, 21.0 ],
					"text" : "t b dump"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 320.028564, 319.0, 136.0, 89.0 ],
					"pitcheditrange" : "null",
					"showdurations" : 0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.828552, 291.0, 76.0, 21.0 ],
					"text" : "bach.+ 200"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.828552, 163.0, 242.0, 54.0 ],
					"text" : "Shift+Alt+click on an existing note and drag upwards or downwards to create a new note in the same chord.",
					"textcolor" : [ 0.501961, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 333.399994, 163.0, 136.0, 89.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 47.0, 794.0, 21.0 ],
					"text" : "Let's put us to work, and see how we can translate OpenMusic patches into bach. Let's take a very simple one, for the time being:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 539.0, 81.0, 18.0 ],
					"text" : "clean, wclose",
					"varname" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.0, 591.5, 250.0, 20.0 ],
					"text" : "linksections 1 1 g \"From OpenMusic to bach\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 199.0, 564.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 542.0, 158.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 617.0, 140.0, 20.0 ],
					"text" : "pcontrol",
					"varname" : "pcontrolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 592.0, 140.0, 20.0 ],
					"text" : "prepend load",
					"varname" : "prependB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 567.0, 140.0, 20.0 ],
					"text" : "tosymbol",
					"varname" : "tosymbolB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 701.0, 542.0, 162.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 701.0, 517.0, 40.0, 20.0 ],
					"text" : "t b b",
					"varname" : "triggerB"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 701.0, 492.0, 151.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 208.5, 617.5, 190.5, 617.5, 190.5, 559.0, 208.5, 559.0 ],
					"source" : [ "obj-198", 0 ]
				}
