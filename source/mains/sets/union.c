...
void C74_EXPORT ext_main(void *moduleRef)
{
    ...
    CLASS_NEW_CHECK_SIZE(c, "bach.union", (method)union_new, (method)union_free, (long) sizeof(t_union), 0L, A_GIMME, 0);
	...
	switch (inlet) {
		case 0:
            ...
            if (x->n_ob.c_main) {
                ...
                llll_union(inll1, inll2, (sets_fn) union_code, &lambdaData);
            } else {
                x->n_haslambda = 0;
