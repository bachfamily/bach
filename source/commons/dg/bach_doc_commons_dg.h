...
#define BACH_DOC_TIMEPOINT_SYNTAX_SCORE
    ...
    //  <br />
    //  If the measure number is replaced by an empty list <b>()</b>, then the following rational is interpreted as a global symbolic onset inside the score.
    //  For instance, <b>(() 27/4)</b> represents the point at 27/4 after the beginning of the score, referred to the measureinfo of voice 1;
    //  <b>(3 () 27/4)</b> does the same for voice 3.
    //  <br /> <br />
