...
public class parsetestParser extends Parser {
	...
	public final SequenceContext sequence() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 655590L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ItemSublistContext extends ItemContext {
		public TerminalNode PUSH() { return getToken(parsetestParser.PUSH, 0); }
		public SequenceContext sequence() {
			return getRuleContext(SequenceContext.class,0);
		}
		public TerminalNode POP() { return getToken(parsetestParser.POP, 0); }
