...
public class bellParser extends Parser {
	...
	public static final int
		...
		RULE_simpleFuncall = 7, RULE_dataFlowItem = 8, RULE_funcall = 9, RULE_funarg = 10, 
		RULE_funargList = 11, RULE_liftedargList = 12, RULE_fundef = 13, RULE_item = 14, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"argsByPositionList", "simpleFuncall", "dataFlowItem", "funcall", "funarg", 
			"funargList", "liftedargList", "fundef", "item", "var", "lvalueSpecs", 
	...
	private SimpleFuncallContext simpleFuncall(int _p) throws RecognitionException {
		...
		int _startState = 14;
		enterRecursionRule(_localctx, 14, RULE_simpleFuncall, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final DataFlowItemContext dataFlowItem() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_dataFlowItem);
		try {
			setState(170);
			_errHandler.sync(this);
	...
	public final FunargListContext funargList() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_funargList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LiftedargListContext liftedargList() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_liftedargList);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public static final String _serializedATN =
		...
		"\u0000##%%\u0002\u000088;;\u0001\u0000>?\u0004\u0000..002244\u0002\u0000"+
		"6699\u0002\u0000TTVV\u0001\u0000<=\u0001\u0000@C\u0001\u0000JK\u0002\u0000"+
		"PPRR\u0013\u0000&&))--//11335577::EEGGIILMOOQQSSUUWW[\\\u0012\u0000))"+
		"--//11335577::EEGGIILMOOQQSSUUWW[\\\u01ba\u00000\u0001\u0000\u0000\u0000"+
		"\u0002:\u0001\u0000\u0000\u0000\u0004E\u0001\u0000\u0000\u0000\u0006G"+
		"\u0001\u0000\u0000\u0000\bM\u0001\u0000\u0000\u0000\nR\u0001\u0000\u0000"+
		"\u0000\f^\u0001\u0000\u0000\u0000\u000e\u008a\u0001\u0000\u0000\u0000"+
		"\u0010\u00aa\u0001\u0000\u0000\u0000\u0012\u00b4\u0001\u0000\u0000\u0000"+
