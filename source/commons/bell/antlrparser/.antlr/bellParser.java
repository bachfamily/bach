...
public class bellParser extends Parser {
	...
	public static final int
		...
		RULE_dataFlowItem = 15, RULE_funcall = 16, RULE_item = 17, RULE_var = 18, 
		RULE_lvalueSpecs = 19, RULE_lvalue = 20, RULE_fakeLvalue = 21, RULE_listEnd = 22, 
		RULE_expr = 23, RULE_assignment = 24, RULE_conditional = 25, RULE_list = 26;
	private static String[] makeRuleNames() {
		return new String[] {
			"everything", "program", "funarg", "funargList", "liftedargList", "fundef", 
			"sequence", "nullified", "whileloop", "forarg", "forargList", "forloop", 
			"argsByNameList", "argsByPositionList", "simpleFuncall", "dataFlowItem", 
			"funcall", "item", "var", "lvalueSpecs", "lvalue", "fakeLvalue", "listEnd", 
			"expr", "assignment", "conditional", "list"
		};
	}
	...
	public final DataFlowItemContext dataFlowItem() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_dataFlowItem);
		try {
			setState(253);
			_errHandler.sync(this);
	...
	public final LvalueSpecsContext lvalueSpecs() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_lvalueSpecs);
		int _la;
		try {
			int _alt;
			setState(318);
	...
	public final FakeLvalueContext fakeLvalue() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_fakeLvalue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(324);
	...
	public static final String _serializedATN =
		...
		"\u0000**,,\u0002\u0000??BB\u0001\u0000EF\u0004\u0000557799;;\u0002\u0000"+
		"==@@\u0002\u0000[[]]\u0001\u0000CD\u0001\u0000GJ\u0001\u0000QR\u0002\u0000"+
		"WWYY\u0013\u0000--00446688::<<>>AALLNNPPSTVVXXZZ\\\\^^bc\u0012\u00000"+
		"0446688::<<>>AALLNNPPSTVVXXZZ\\\\^^bc\u01fc\u00006\u0001\u0000\u0000\u0000"+
		"\u0002@\u0001\u0000\u0000\u0000\u0004H\u0001\u0000\u0000\u0000\u0006J"+
		"\u0001\u0000\u0000\u0000\bR\u0001\u0000\u0000\u0000\n\\\u0001\u0000\u0000"+
		"\u0000\fl\u0001\u0000\u0000\u0000\u000en\u0001\u0000\u0000\u0000\u0010"+
		"t\u0001\u0000\u0000\u0000\u0012y\u0001\u0000\u0000\u0000\u0014\u0080\u0001"+
