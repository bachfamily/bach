...
public class bellParser extends Parser {
	...
	public static final int
		...
		DIROUTLET=30, BIF=31, OF=32, KEEP=33, UNKEEP=34, INIT=35, GLOBALVAR=36, 
		PATCHERVAR=37, LOCALVAR=38, NAMEDPARAM=39, ARGCOUNT=40, PUSH=41, POP=42, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, "'keep'", "'unkeep'", "'init'", null, null, 
			null, null, "'$argcount'", "'['", "']'", "')'", "':'", "'::'", "'.'", 
			"':='", "'::='", "';'", "'='", null, null, "'**'", "'**='", "'*'", "'*='", 
			"'//'", "'//='", "'/'", "'/='", "'%'", "'%='", null, "'+='", "'+'", null, 
			"'-='", "'-'", "'=='", "'!='", "'!'", "'~'", "'<'", "'>'", "'<='", "'>='", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DIROUTLET", "BIF", "OF", "KEEP", "UNKEEP", "INIT", "GLOBALVAR", "PATCHERVAR", 
	...
	public final SequenceContext sequence() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3848282521592L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 2336462209225L) != 0)) {
					{
					setState(111);
					list();
					}
