...
public class bellParser extends Parser {
	...
	public final SequenceContext sequence() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3298526707704L) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & 5085241278665L) != 0)) {
					{
					setState(111);
					list();
					}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(354);
						((ExprBinaryContext)_localctx).op = match(PICK);
						setState(355);
						expr(18);
						}
						break;
					...
					case 3:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3062447746611937280L) != 0)) ) {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ItemMaxFunctionContext extends ItemContext {
		public TerminalNode MAXFUNCTION() { return getToken(bellParser.MAXFUNCTION, 0); }
		public ItemMaxFunctionContext(ItemContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ItemPiContext extends ItemContext {
		public TerminalNode K_PI() { return getToken(bellParser.K_PI, 0); }
		public ItemPiContext(ItemContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ItemEmptySymbolContext extends ItemContext {
		public TerminalNode EMPTYSYMBOL() { return getToken(bellParser.EMPTYSYMBOL, 0); }
		public ItemEmptySymbolContext(ItemContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final ItemContext item() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				break;
			case 4:
				_localctx = new ItemPiContext(_localctx);
				enterOuterAlt(_localctx, 4);
				{
				setState(406);
				match(K_PI);
			...
			case 6:
				...
				break;
			case 7:
				_localctx = new ItemEmptySymbolContext(_localctx);
			...
			case 9:
				...
				break;
			case 10:
				_localctx = new ItemMaxFunctionContext(_localctx);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class FakeAApplyContext extends AssignmentContext {
		public FakeLvalueContext fakeLvalue() {
			return getRuleContext(FakeLvalueContext.class,0);
		}
		public TerminalNode AAPPLY() { return getToken(bellParser.AAPPLY, 0); }
		public FuncallContext funcall() {
			return getRuleContext(FuncallContext.class,0);
		}
		public FakeAApplyContext(AssignmentContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class TrueAApplyContext extends AssignmentContext {
		public LvalueContext lvalue() {
			return getRuleContext(LvalueContext.class,0);
		}
		public TerminalNode AAPPLY() { return getToken(bellParser.AAPPLY, 0); }
		...
		public TrueAApplyContext(AssignmentContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final AssignmentContext assignment() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 47)) & ~0x3f) == 0 && ((1L << (_la - 47)) & 27772334426466953L) != 0)) ) {
			...
			case 3:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 50)) & ~0x3f) == 0 && ((1L << (_la - 50)) & 3471541803308369L) != 0)) ) {
				...
				break;
			case 4:
				_localctx = new TrueAApplyContext(_localctx);
				enterOuterAlt(_localctx, 4);
				{
				setState(448);
				lvalue();
				...
				break;
			case 5:
				_localctx = new FakeAApplyContext(_localctx);
				enterOuterAlt(_localctx, 5);
				{
				setState(452);
				fakeLvalue();
	...
	public static final String _serializedATN =
		...
		"99;;==\u0002\u0000??BB\u0002\u0000]]__\u0001\u0000EF\u0001\u0000IL\u0001"+
		"\u0000ST\u0002\u0000YY[[\u0001\u0000\b\t\u0001\u0000\u0017\u001b\u0013"+
		"\u0000//226688::<<>>@@CCNNPPRRUVXXZZ\\\\^^``de\u0012\u0000226688::<<>"+
		">@@CCNNPPRRUVXXZZ\\\\^^``de\u022c\u0000<\u0001\u0000\u0000\u0000\u0002"+
		"F\u0001\u0000\u0000\u0000\u0004N\u0001\u0000\u0000\u0000\u0006P\u0001"+
		"\u0000\u0000\u0000\bX\u0001\u0000\u0000\u0000\nb\u0001\u0000\u0000\u0000"+
		"\fr\u0001\u0000\u0000\u0000\u000et\u0001\u0000\u0000\u0000\u0010z\u0001"+
