...
#define YYSTYPE         SYMPARSER_STYPE
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined SYMPARSER_STYPE_IS_TRIVIAL && SYMPARSER_STYPE_IS_TRIVIAL)))
...
{
       0,    90,    90,    91,    94,    97,   100,   103,   107,   110,
     112,   115,   122
};
#endif
...
#define yyclearin       (yychar = SYMPARSER_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use SYMPARSER_error or SYMPARSER_UNDEF. */
#define YYERRCODE SYMPARSER_UNDEF
...
int yydebug;
#else /* !SYMPARSER_DEBUG */
# define YYDPRINTF(Args) ((void) 0)
# define YY_SYMBOL_PRINT(Title, Kind, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !SYMPARSER_DEBUG */
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = SYMPARSER_EMPTY; /* Cause a token to be read.  */
...
yybackup:
  ...
  if (yychar <= SYMPARSER_EOF)
    {
      yychar = SYMPARSER_EOF;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == SYMPARSER_error)
    {
      /* The scanner already issued an error message, process directly
         to error recovery.  But do not keep the error token as
         lookahead, it is too special and may lead us to an endless
         loop in error recovery. */
      yychar = SYMPARSER_UNDEF;
...
yyerrlab:
  ...
  yytoken = yychar == SYMPARSER_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
