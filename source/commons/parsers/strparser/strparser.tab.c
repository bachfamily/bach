...
#line 1 "strparser.y" /* yacc.c:339  */
     ...
     *
     */
#line 34 "strparser.y" /* yacc.c:339  */
...
#line 104 "strparser.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 46 "strparser.y" /* yacc.c:355  */
...
#line 164 "strparser.tab.c" /* yacc.c:355  */
};
...
#line 55 "strparser.y" /* yacc.c:358  */
...
#line 190 "strparser.tab.c" /* yacc.c:358  */
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, scanner, ll, stack, depth); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, void *scanner, t_llll **ll, t_llll_stack *stack, long *depth)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (scanner);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, void *scanner, t_llll **ll, t_llll_stack *stack, long *depth)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, scanner, ll, stack, depth);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, void *scanner, t_llll **ll, t_llll_stack *stack, long *depth)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, void *scanner, t_llll **ll, t_llll_stack *stack, long *depth)
{
  YYUSE (yyvaluep);
  YYUSE (scanner);
  YYUSE (ll);
...
#line 1282 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 5:
#line 83 "strparser.y" /* yacc.c:1663  */
    {
	llll_appenddouble(*ll, (yyvsp[0].d));
	parserpost("parse: BACH_DOUBLE %lf", (yyvsp[0].d));
}
#line 1291 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 6:
#line 86 "strparser.y" /* yacc.c:1663  */
    {
	llll_appendrat(*ll, (yyvsp[0].r));
	parserpost("parse: BACH_RAT %ld/%ld", (yyvsp[0].r).num(), (yyvsp[0].r).den());
}
#line 1300 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 7:
#line 89 "strparser.y" /* yacc.c:1663  */
    {
...
#line 1310 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 8:
#line 93 "strparser.y" /* yacc.c:1663  */
    {
	llll_appendsym(*ll, (yyvsp[0].sym));
	parserpost("parse: BACH_SYMBOL %s", (yyvsp[0].sym)->s_name);
}
#line 1319 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 9:
#line 96 "strparser.y" /* yacc.c:1663  */
    {
    parserpost("parse: NULL");
}
#line 1327 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 10:
#line 98 "strparser.y" /* yacc.c:1663  */
    {
	llll_appendllll(*ll, llll_get());
    parserpost("parse: NIL");
}
#line 1336 "strparser.tab.c" /* yacc.c:1663  */
    break;

  case 11:
#line 101 "strparser.y" /* yacc.c:1663  */
    {
	(*depth)++;
...
#line 1349 "strparser.tab.c" /* yacc.c:1663  */
  ...
  case 12:
#line 108 "strparser.y" /* yacc.c:1663  */
    {
	(*depth)--;
	if (*depth > 0) {
...
#line 1365 "strparser.tab.c" /* yacc.c:1663  */
    break;


#line 1369 "strparser.tab.c" /* yacc.c:1663  */
      default: break;
    }
...
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (scanner, ll, stack, depth, yymsgp);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, scanner, ll, stack, depth);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, scanner, ll, stack, depth);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
...
#line 120 "strparser.y" /* yacc.c:1907  */
