...
#  define SdiffGetPosNoCond(f,p) (*(p) = Sdiffftell(f))
...
#else
#  define SdiffGetPosNoCond(f,p) (*(p) = ftello(f))
...
#  define SdiffGetPos(f,p)     (SdiffGetPosNoCond(f,p) == -1  ?  -1  :  0)
...
SDIF_API SdifComponentT* SdifCreateComponent (SdifSignature MtrxS, const char *Name, SdifUInt4 Num);
...
SDIF_API SdifFrameTypeT* SdifFrameTypePutComponent       (SdifFrameTypeT *FrameType, SdifSignature MtrxS, const char *NameC);
...
SDIF_API int SdifSkipASCIIUntil  (FILE* fr, size_t *NbCharRead, const char *CharsEnd);
SDIF_API int SdifSkipASCIIUntilfromSdifString  (SdifStringT *SdifString, size_t *NbCharRead, const char *CharsEnd);
...
SDIF_API int SdifTestCharEnd              (SdifFileT *SdifF, int CharEnd, const char MustBe,
                                           const char *StringRead, int ErrCondition, const char *Mess);
