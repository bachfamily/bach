...
/**
	...
	@discussion
	The abstraction is equivalent to a division performed
...
// in the second inlet will set the right llll for the division,
...
// @out 0 @type llll @digest The division of the two operands
